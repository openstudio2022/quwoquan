...
func Register(mux *http.ServeMux, handlers Handlers) {
	...
	mux.HandleFunc("GET /internal/tag/shared-tags", handlers.SharedTags)
	mux.HandleFunc("GET /internal/tag/inverted", handlers.Inverted)
	...
	mux.HandleFunc("GET /internal/tag/related", handlers.Related)
	mux.HandleFunc("POST /internal/tag/search-by-tags", handlers.SearchByTags)
	mux.HandleFunc("GET /internal/tag/graph/cooccurrence", handlers.Cooccurrence)
	mux.HandleFunc("GET /internal/tag/related-objects", handlers.RelatedObjects)
}
