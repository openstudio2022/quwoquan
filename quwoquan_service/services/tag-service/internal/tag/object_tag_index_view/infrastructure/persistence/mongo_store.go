...
import (
	...
	"quwoquan_service/services/tag-service/internal/tag/object_tag_index_view/domain/lifecycle"
	...
	_, err := s.coll.UpdateOne(
		...
		bson.M{
			"$set": bson.M{
				...
				"lifecycleStatus":  lifecycle.StatusActive,
...
var (
	_ ports.Reader                  = (*MongoObjectTagIndexStore)(nil)
	_ ports.Projector               = (*MongoObjectTagIndexStore)(nil)
	_ ports.UserProfileTagProjector = (*MongoObjectTagIndexStore)(nil)
)
