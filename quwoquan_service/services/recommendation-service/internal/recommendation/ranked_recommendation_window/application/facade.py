...
class Facade:
    ...
    @staticmethod
    def _request_digest(*, content_fence, subject_id: str, scenario: str, limit: int, context_digest: str) -> str:
        return hashlib.sha256(json.dumps({
    ...
    def _bind_ranking_context(ranking: RankingResult, context_digest: str) -> RankingResult:
        ...
        return RankingResult(
            ...
            candidates=ranking.candidates, object_cards=ranking.object_cards,
            profile_revision=ranking.profile_revision,
        )
