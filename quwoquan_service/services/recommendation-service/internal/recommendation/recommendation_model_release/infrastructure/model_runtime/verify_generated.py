#!/usr/bin/env python3
"""Verify generated models: run from services/recommendation-service/internal/recommendation/recommendation_model_release/infrastructure/model_runtime with pydantic installed (e.g. in venv)."""
import sys
