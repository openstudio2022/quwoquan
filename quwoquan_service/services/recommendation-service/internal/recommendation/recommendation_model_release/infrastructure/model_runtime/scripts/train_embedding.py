...
Usage:
    python services/recommendation-service/internal/recommendation/recommendation_model_release/infrastructure/model_runtime/scripts/train_embedding.py --scenario content_feed [--epochs 10]
"""
import argparse
import json
import os
...
def main():
    ...
    version = utc_now().strftime("emb_v%Y%m%d_%H%M%S")
