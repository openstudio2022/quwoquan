# Source: circle/circle_management/gathering/events.yaml; event_ref: circle.gathering.GatheringAdmissionControlChanged
...
class GatheringAdmissionControlStatus(_ContractEnum):
    VALUE_OPEN = "open"
    VALUE_PAUSED = "paused"
...
class GatheringEventPayload(BaseModel):
    ...
    admissionControlStatus: GatheringAdmissionControlStatus
    occurredAt: datetime
