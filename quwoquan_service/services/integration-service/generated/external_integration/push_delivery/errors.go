...
func AppErrorFromPushDeliveryInvalidRequest(debugMessage string) *rerrors.AppError {
	...
	return rerrors.NewAppError(code, "推送请求参数不完整", debugMessage).WithMetadata("invalid_argument", 0).WithRecoveryDirective("surface", "inlineCard", 0)
}
...
func AppErrorFromPushEndpointResolutionFailed(debugMessage string) *rerrors.AppError {
	...
	return rerrors.NewAppError(code, "推送端点暂时无法解析", debugMessage).WithMetadata("dependency_unavailable", 0).WithRecoveryDirective("retry", "snackbar", 5)
}
...
func AppErrorFromPushProviderTimeout(debugMessage string) *rerrors.AppError {
	...
	return rerrors.NewAppError(code, "推送供应商响应超时，请稍后重试", debugMessage).WithMetadata("timeout", 0).WithRecoveryDirective("retry", "snackbar", 5)
}
...
func AppErrorFromPushProviderRateLimited(debugMessage string) *rerrors.AppError {
	...
	return rerrors.NewAppError(code, "推送供应商请求繁忙，请稍后重试", debugMessage).WithMetadata("rate_limited", 0).WithRecoveryDirective("retry", "snackbar", 5)
}
...
func AppErrorFromPushProviderRejected(debugMessage string) *rerrors.AppError {
	...
	return rerrors.NewAppError(code, "推送供应商暂时不可用，请稍后重试", debugMessage).WithMetadata("upstream_rejected", 0).WithRecoveryDirective("retry", "snackbar", 5)
}
...
func AppErrorFromPushEndpointPermanentlyInvalid(debugMessage string) *rerrors.AppError {
	...
	return rerrors.NewAppError(code, "推送端点已失效", debugMessage).WithMetadata("resource_gone", 0).WithRecoveryDirective("absorb", "silent", 0)
}
...
func AppErrorFromPushProviderCredentialsInvalid(debugMessage string) *rerrors.AppError {
	...
	return rerrors.NewAppError(code, "推送供应商凭据无效", debugMessage).WithMetadata("credentials_invalid", 0).WithRecoveryDirective("escalate", "inlineCard", 0)
}
...
func AppErrorFromPushEndpointInvalidationFailed(debugMessage string) *rerrors.AppError {
	...
	return rerrors.NewAppError(code, "推送端点失效状态暂时无法同步", debugMessage).WithMetadata("dependency_unavailable", 0).WithRecoveryDirective("retry", "snackbar", 5)
}
