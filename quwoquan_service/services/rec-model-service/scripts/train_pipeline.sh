...
#
# Usage:
#   bash services/rec-model-service/scripts/train_pipeline.sh --scenario content_feed
#   bash services/rec-model-service/scripts/train_pipeline.sh --scenario content_feed --dry-run
#   bash services/rec-model-service/scripts/train_pipeline.sh --scenario content_feed --production
set -euo pipefail
