...
Usage:
    python services/rec-model-service/scripts/evaluate.py --scenario content_feed
    python services/rec-model-service/scripts/evaluate.py --scenario content_feed --model-path /tmp/model.txt
"""
import argparse
import json
import os
