...
Usage:
    python services/rec-model-service/scripts/generate_seed_data.py --mongodb-uri mongodb://localhost:27017
    python services/rec-model-service/scripts/generate_seed_data.py --clean  # wipe + regenerate
"""
import argparse
import hashlib
import os
