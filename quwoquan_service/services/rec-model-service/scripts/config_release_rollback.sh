...
#
# Usage:
#   bash services/rec-model-service/scripts/config_release_rollback.sh --env prod
#   bash services/rec-model-service/scripts/config_release_rollback.sh --env gamma
set -euo pipefail
