...
REC_MODEL_ROOT = Path(__file__).resolve().parents[3]
if str(REC_MODEL_ROOT) not in sys.path:
    sys.path.insert(0, str(REC_MODEL_ROOT))

from generated.models.request_response import CandidateInput
