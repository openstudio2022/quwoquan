...
_TESTS_ROOT = next(
    parent for parent in Path(__file__).resolve().parents if parent.name == "tests"
)
_SERVICE_ROOT = _TESTS_ROOT.parent
_SCRIPTS_DIR = _SERVICE_ROOT / "scripts"
...
_SOURCES = {
    ...
    "serving": _SERVICE_ROOT / "models" / "content_feed.py",
}
