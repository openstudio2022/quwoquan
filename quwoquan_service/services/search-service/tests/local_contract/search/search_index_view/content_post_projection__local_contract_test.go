...
func TestContentPostGeneratedDeletionWire(t *testing.T) {
	p := map[string]any{"postId": "post", "authorId": "author", "contentType": "article", "status": "published", "deletedAt": "2026-09-13T00:00:00Z", "environment": nil, "sourceOwner": nil, "releaseId": nil, "manifestDigest": nil, "releaseDigest": nil, "sourceVersion": 2, "safetyRevision": 1}
