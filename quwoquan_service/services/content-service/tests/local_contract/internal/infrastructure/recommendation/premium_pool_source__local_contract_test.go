...
func TestPremiumPoolSourceLocalContractTest(t *testing.T) {
	...
	cmd := exec.Command(
		...
		"-run",
		"^(TestGatePremiumStreamSourceBlocksGenericSource|TestPremiumPoolProjectionFailsClosedOnRejectedAdmission|TestPremiumPoolProjectionFieldsFailClosed|TestPremiumPoolSourceGatesToPremiumStream)$",
		"-count=1",
	)
