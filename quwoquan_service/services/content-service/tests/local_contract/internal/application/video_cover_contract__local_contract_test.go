...
import (
	...
	application "quwoquan_service/services/content-service/internal/application"
...
func TestVideoCoverContractLocalContract(t *testing.T) {
	...
	feedService := application.NewFeedService(engine, videoCoverFeedReader{store: store})

	resp, err := feedService.ListFeed(ctx, application.ListFeedRequest{
