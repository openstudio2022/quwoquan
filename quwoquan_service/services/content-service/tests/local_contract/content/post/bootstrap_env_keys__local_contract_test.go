...
func TestDeclaredEnvKeysCoverRetiredHandwrittenHooks(t *testing.T) {
	...
	expected := []string{
		...
		"CONTENT_REACTION_MUTATION_BASIS_ACTIVE_KEY_ID",
		"CONTENT_REACTION_MUTATION_BASIS_KEYRING_SECRET_REF",
		"CREATOR_SEARCH_BINDING_DIGEST",
		"CREATOR_SEARCH_PHYSICAL_NAMESPACE",
		"CONTENT_MONGO_URI",
		...
		"CONTENT_REDIS_GENERAL_USERNAME",
		...
		"CONTENT_REDIS_REALTIME_USERNAME",
