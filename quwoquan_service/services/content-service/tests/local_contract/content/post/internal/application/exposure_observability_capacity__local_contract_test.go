// spec_ref: specs/feature-tree/discovery-content/exposure-governance/exposure-observability-capacity/spec.md#gwt-001
...
func resolveRepoRoot(t *testing.T) string {
	...
	current := cwd
	for {
		if _, err := os.Stat(filepath.Join(current, "specs", "feature-tree", "README.md")); err == nil {
			return current
		}
