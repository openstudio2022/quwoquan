...
func newFilterCatalogAPI(
	...
	store := filtercatalogpersistence.NewMongoStore(requireMongoDB(t))
	...
	base := contenthttp.NewContentHandler(
		nil,
		nil,
		nil,
		nil,
		...
		nil,
		nil,
		contenthttp.WithFilterCatalogReleaseService(filtercatalogapp.BindFacades(service)),
	).Routes()
