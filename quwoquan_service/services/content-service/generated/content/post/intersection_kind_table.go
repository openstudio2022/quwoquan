...
var IntersectionIconKeyByKind = map[string]string{
	...
	"coExperiencedGathering": "experience",
...
var IntersectionMomentByKind = map[string]string{
	...
	"coExperiencedGathering": "retrospective",
...
var IntersectionActionDispatch = []string{"assistant", "navigate", "message", "gathering"}
...
var IntersectionKindLabelByKind = map[string]IntersectionText{
	...
	"coExperiencedGathering": {Text: "共同经历", L10nKey: "intersection.kind_label.co_experienced_gathering"},
...
var IntersectionPointTemplateByKind = map[string]IntersectionText{
	...
	"coExperiencedGathering": {Text: "你和{object}一起参加过{sample}", L10nKey: "intersection.point.co_experienced_gathering"},
