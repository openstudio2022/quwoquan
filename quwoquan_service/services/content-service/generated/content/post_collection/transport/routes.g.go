...
var generatedRouteTable = []generatedRouteDef{
	{method: "DELETE", pathTemplate: "/content/collections/{collectionId}", operation: "DeletePostCollection"},
	{method: "PUT", pathTemplate: "/content/collections/{collectionId}", operation: "SavePostCollection"},
}
