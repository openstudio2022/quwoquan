...
func fixturePublish(t *testing.T) string {
	...
	writeFile(t, filepath.Join(root, "posts/article/体验/甲居藏寨体验/1/manifest.json"),
		`{"contentType":"article","entityRefs":["地点/景区/甲居藏寨"],"tagRefs":["Topic/旅行"],"template":"journal","generatorModel":"agent/x","articleMarkdownDigest":"d1","publishTitle":"甲居藏寨体验","publishAngle":"体验","publishSeq":1}`)
	...
	writeFile(t, filepath.Join(root, "entities/地点/景区/甲居藏寨/_entity.json"),
		`{"label":"甲居藏寨","domain":"地点","type":"景区","tagRefs":["Entity/地点/景区"]}`)
