...
func isUndecodableMediaSource(err error) bool {
	...
	return strings.Contains(diagnostic, "invalid data found when processing input") ||
		...
		strings.Contains(diagnostic, "invalid nal unit size") ||
		strings.Contains(diagnostic, "error splitting the input into nal units") ||
		strings.Contains(diagnostic, "missing picture in access unit")
}
