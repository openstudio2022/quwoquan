...
func NewPersonaRelationshipProjection(db *mongo.Database) *PersonaRelationshipProjection {
	return NewPersonaRelationshipProjectionWithWriter(mongoPersonaRelationshipProjectionWriter{
		relationships: db.Collection("persona_follow_projection"),
		inbox:         db.Collection("persona_relationship_projection_inbox"),
	})
}

func NewPersonaRelationshipProjectionWithWriter(writer personaRelationshipProjectionWriter) *PersonaRelationshipProjection {
