...
func DefaultSeedPosts() []postmodel.Post {
	...
	return []postmodel.Post{
		{ID: "post_micro_001", AuthorId: "user_1001", ContentType: "micro", Title: "Today in Hangzhou", Body: "City walk and coffee notes", TagRefs: []string{"city", "life"}, MediaUrls: []string{"https://picsum.photos/seed/micro1/800/600"}, LikeCount: 23, CommentCount: 4, ShareCount: 2, CreatedAt: now.Add(-2 * time.Hour), PublishedAt: now.Add(-2 * time.Hour), Status: "published", Visibility: "public", ModerationStatus: "approved"},
		{ID: "post_photo_001", AuthorId: "user_1002", ContentType: "image", Title: "Winter light", Body: "Street photography set", TagRefs: []string{"photo", "street"}, MediaUrls: []string{"https://picsum.photos/seed/photo1/800/900"}, CoverUrl: "https://picsum.photos/seed/photo1/800/900", LikeCount: 103, CommentCount: 12, ShareCount: 9, CreatedAt: now.Add(-4 * time.Hour), PublishedAt: now.Add(-4 * time.Hour), Status: "published", Visibility: "public", ModerationStatus: "approved"},
		{ID: "post_video_001", AuthorId: "user_1003", ContentType: "video", Title: "Night run vlog", Body: "Training route and pacing", TagRefs: []string{"video", "fitness"}, VideoUrl: "https://example.com/videos/night-run.mp4", CoverUrl: "https://picsum.photos/seed/video1/800/1200", LikeCount: 88, CommentCount: 20, ShareCount: 13, CreatedAt: now.Add(-1 * time.Hour), PublishedAt: now.Add(-1 * time.Hour), Status: "published", Visibility: "public", ModerationStatus: "approved"},
		{ID: "post_article_001", AuthorId: "user_1004", ContentType: "article", Title: "How to structure deep work", Body: "A practical checklist for focused sessions", TagRefs: []string{"article", "productivity"}, CoverUrl: "https://picsum.photos/seed/article1/1200/700", LikeCount: 66, CommentCount: 15, ShareCount: 11, CreatedAt: now.Add(-6 * time.Hour), PublishedAt: now.Add(-6 * time.Hour), Status: "published", Visibility: "public", ModerationStatus: "approved"},
	}
}
