...
func DefaultSeedPosts() []postmodel.Post {
	...
	return []postmodel.Post{
		{ID: "post_image_001", AuthorId: "user_1001", ContentType: "image", Title: "Today in Hangzhou", Body: "City walk and coffee notes", TagRefs: []string{"city", "life"}, MediaUrls: []string{"https://picsum.photos/seed/image1/800/600"}, LikeCount: 23, CommentCount: 4, ShareCount: 2, CreatedAt: now.Add(-2 * time.Hour), PublishedAt: now.Add(-2 * time.Hour), Status: "published", Visibility: "public", ModerationStatus: "approved"},
