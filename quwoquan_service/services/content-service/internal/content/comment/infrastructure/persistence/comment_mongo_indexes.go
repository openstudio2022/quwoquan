...
// Comment indexes are declared and enforced by the Comment object.
...
// services/content-service/contracts/content/comment/storage.yaml.
...
func CommentMongoIndexes() []mongo.IndexModel {
	return []mongo.IndexModel{
		...
		},
		{
			...
			Options: options.Index().SetName("idx_comments_attachment_media_status"),
		},
		{
			Keys: bson.D{
				{Key: "postId", Value: 1},
