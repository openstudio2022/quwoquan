...
func mapDomainError(err error) error {
	...
	case errors.Is(err, commentmodel.ErrPinForbidden):
		return commenterrors.AppErrorFromCommentPinForbidden(err.Error())
	case errors.Is(err, commentmodel.ErrPinInvalidTarget):
		return commenterrors.AppErrorFromCommentPinInvalidTarget(err.Error())
	case errors.Is(err, commentmodel.ErrCommentDeleted):
		return commenterrors.AppErrorFromCommentNotFound(err.Error())
...
func commentNotFound(commentID string) error {
	return commenterrors.AppErrorFromCommentNotFound(
...
func validateAttachmentMediaIDCount(attachmentMediaIDs []string) error {
	...
	return commenterrors.AppErrorFromCommentAttachmentLimitExceeded(
		fmt.Sprintf(
