...
func BuildAuthorImpactEvidencePage(
	raws []persistence.AuthorImpactEvidenceRaw,
...
func evidenceContentVisual(raw persistence.AuthorImpactEvidenceRaw, post *postmodel.Post, resolveImageURL func(string) string) *IntersectionVisualView {
