...
var (
	ErrDeletionInProgress   = referencefence.ErrDeletionInProgress
	ErrReferenceUnavailable = referencefence.ErrReferenceUnavailable
)

type Reference = referencefence.Reference
...
var _ referencefence.Fence = (*Manager)(nil)
