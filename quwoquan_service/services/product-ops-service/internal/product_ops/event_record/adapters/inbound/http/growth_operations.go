...
func (s *OperationsHandler) handleGetPageExperience(w http.ResponseWriter, r *http.Request) {
	...
	items, err := s.telemetry.GetPageExperience(r.Context(), eventapp.PageExperienceQuery{From: from, To: to})
	if err != nil {
		writeEventAppError(w, r, productopsgenerated.AppErrorFromQueryWindowInvalid(err.Error()))
		return
	}
...
func (s *OperationsHandler) handleGetGrowthOverview(w http.ResponseWriter, r *http.Request) {
	if s.growth == nil {
