...
func eventToDrilldown(event application.EventRecord, revealSession bool) application.EventDrilldownItem {
	...
	return application.EventDrilldownItem{
		...
		CallType: event.CallType, ParticipantCount: event.ParticipantCount,
		ConnectTimeMS: event.ConnectTimeMS, MediaConnected: event.MediaConnected,
		ReconnectCount: event.ReconnectCount, DisconnectReason: event.DisconnectReason,
