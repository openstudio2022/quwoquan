...
func decodeEventDrilldownFields(
	...
	return application.EventDrilldownItem{
		...
		CallType:               parseString("callType"),
		ParticipantCount:       parseInt("participantCount"),
		ConnectTimeMS:          parseInt("connectTimeMs"),
		MediaConnected:         parseBool("mediaConnected"),
		ReconnectCount:         parseInt("reconnectCount"),
		DisconnectReason:       parseString("disconnectReason"),
		NetworkQuality:         parseString("networkQuality"),
