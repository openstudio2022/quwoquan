...
DEFAULT_REPORT = REPO_ROOT / ".qwq_output" / "runs" / "beta" / "chat-avatar-device-matrix" / "report.json"
...
def run_probe(
    ...
    *,
    ...
    command = [
        sys.executable,
        str(REPO_ROOT / "quwoquan_service/services/chat-service/tests/ops/smoke/run_chat_avatar_e2e_probe.py"),
        "--env",
        env_name,
        "--base-url",
        base_url,
