...
用法:
  python3 quwoquan_service/services/chat-service/tests/ops/gate/verify_chat_avatar_commercial_matrix_evidence.py --manifest PATH

Manifest 为 YAML（推荐）或 JSON：见 .qwq_output/runs/<env>/commercial-matrix-chat-avatar/manifest.sample.yaml
