...
func TestPlatformCatalogAndTopologyEndpoints(t *testing.T) {
	...
	if len(environmentPayload.Items) == 0 {
		t.Fatalf("expected environment topology items from quwoquan_ops/environments/process_domain_mapping.yaml")
	}
}
...
func TestPlatformAlertIngestAckLoopEmitsAudit(t *testing.T) {
	...
	firingPayload := `{"version":"4","groupKey":"{}:{alertname=\"HTTPErrorRateHigh\"}","status":"firing","alerts":[{"status":"firing","labels":{"alertname":"HTTPErrorRateHigh","severity":"critical","service":"seed-box"},"annotations":{"summary":"5xx too high"},"startsAt":"2026-07-19T08:00:00Z","fingerprint":"fp-http-error-1"}]}`
	...
	resolvedPayload := `{"version":"4","groupKey":"{}:{alertname=\"HTTPErrorRateHigh\"}","status":"resolved","alerts":[{"status":"resolved","labels":{"alertname":"HTTPErrorRateHigh","severity":"critical","service":"seed-box"},"annotations":{"summary":"5xx recovered"},"startsAt":"2026-07-19T08:00:00Z","endsAt":"2026-07-19T08:30:00Z","fingerprint":"fp-http-error-1"}]}`
