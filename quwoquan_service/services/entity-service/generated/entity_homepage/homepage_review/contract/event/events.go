...
// Event type constants for HomepageReview.
const (
	HomepageReviewPublished = "HomepageReviewPublished"
	HomepageReviewUpdated   = "HomepageReviewUpdated"
	HomepageReviewRemoved   = "HomepageReviewRemoved"
)
