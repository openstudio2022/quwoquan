...
import (
	...
	reviewgenerated "quwoquan_service/services/entity-service/generated/entity_homepage/homepage_review"
...
func reviewNotFound(reviewID string) error {
	return reviewgenerated.AppErrorFromReviewNotFound(
...
func mapDomainError(err error) error {
	...
	case errors.Is(err, reviewmodel.ErrReviewDeleted):
		return reviewgenerated.AppErrorFromReviewNotFound(err.Error())
	default:
		return unavailable(err)
	}
}
