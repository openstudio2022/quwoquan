...
func NewExternalWebSearchHandler(
	publicSearch ports.PublicSearchProvider,
	weather ports.WeatherProvider,
	finance ports.FinanceProvider,
) toolpkg.Handler {
...
func externalSearchInputFromTool(
...
func shouldLookupFinance(request ports.ExternalSearchRequest) bool {
