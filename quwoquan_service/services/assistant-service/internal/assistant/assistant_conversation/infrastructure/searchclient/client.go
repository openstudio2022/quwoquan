...
const searchQueryOperationID = "search.search_query.SearchQuery"

// Client 把助手 app_search 工具绑定到 search-service 的 canonical SearchQuery operation。
...
// Retrieve 调用 canonical SearchQuery，并返回未经助手二次排序的 typed 结果。
