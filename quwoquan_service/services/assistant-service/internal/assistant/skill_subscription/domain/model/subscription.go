...
const (
	SkillSubscriptionDestinationUser             SkillSubscriptionDestinationType = "user"
	SkillSubscriptionDestinationChatConversation SkillSubscriptionDestinationType = "chat_conversation"
)

type SkillSubscriptionDestination struct {
	DestinationType  SkillSubscriptionDestinationType `bson:"destinationType" json:"destinationType"`
