...
ALTER TABLE skill_surface_placement_outbox
...
CREATE INDEX IF NOT EXISTS idx_skill_surface_placement_outbox_delivery_head
  ON skill_surface_placement_outbox(dispatched_at, next_attempt_at, occurred_at, event_id);
`)
	if err != nil {
