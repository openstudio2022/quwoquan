...
type ContextPersistenceScope string

const (
	ContextPersistencePrivateLongTerm ContextPersistenceScope = "private_long_term"
	ContextPersistenceChannelOnly     ContextPersistenceScope = "channel_only"
)
...
type AssistantChannel interface {
	...
	ContextPersistence() ContextPersistenceScope
}
...
func (d definition) ContextPersistence() ContextPersistenceScope {
	return d.contextPersistence
}
...
func Personal() AssistantChannel {
	return definition{
		...
		contextPersistence: ContextPersistencePrivateLongTerm,
	}
}
...
func GroupMention() AssistantChannel {
	return definition{
		...
		contextPersistence: ContextPersistenceChannelOnly,
	}
}
