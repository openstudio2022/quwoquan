...
type recordingIntersectionEvidenceReader struct {
	personaID string
...
func (r *recordingIntersectionEvidenceReader) ResolveAuthorizedIntersectionEvidence(
	_ context.Context,
	personaID string,
	refs []assistant.AssistantIntersectionEvidenceRef,
...
func TestCreateTurnAuthorizesIntersectionEvidenceBeforePersistence(t *testing.T) {
	reader := &recordingIntersectionEvidenceReader{
		result: []assistant.AuthorizedIntersectionEvidence{{
