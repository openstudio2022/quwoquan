...
def main() -> int:
    ...
    command = [
        ...
        env_name,
        "--report",
        f".qwq_output/runs/{env_name}/device-matrix/assistant-{args.platform}.json",
    ]
    report_path = REPO_ROOT / ".qwq_output" / "runs" / env_name / "device-matrix" / f"assistant-{args.platform}.json"
