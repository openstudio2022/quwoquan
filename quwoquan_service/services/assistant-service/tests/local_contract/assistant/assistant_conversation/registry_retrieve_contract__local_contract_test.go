...
func TestRetrieveToolsDoNotRequireCompatQuery(t *testing.T) {
	registry := migratedRegistryRetrieveContractRetrievalContractTestRegistry()
...
func migratedRegistryRetrieveContractToTestStringSlice(value any) []string {
	raw, _ := value.([]any)
...
func migratedRegistryRetrieveContractContainsString(values []string, target string) bool {
