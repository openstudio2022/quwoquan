...
// F4/F5: JSON shape for ops summary stays aligned with services/assistant-service/contracts/assistant/assistant_run/fields.yaml (AssistantLearningOpsSummaryView).
...
func TestAssistantLearningOpsSummaryView_DecodeSharedFixture(t *testing.T) {
	// Runtime examples belong to the service test-support boundary, not contracts (F5).
	rel := filepath.Join(
