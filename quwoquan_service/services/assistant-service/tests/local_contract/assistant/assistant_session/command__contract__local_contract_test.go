...
// TestAssistantSessionCommandContract exercises the real application composition through public ports.
func TestCommandContractApplicationComposition(t *testing.T) {
