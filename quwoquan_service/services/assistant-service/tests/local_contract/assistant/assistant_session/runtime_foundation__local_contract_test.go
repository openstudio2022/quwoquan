...
func TestRuntimeFoundationSmoke(t *testing.T) {
	...
	transport.Publish(turnID, assistantSessionRuntimeFoundationRoundTripEnvelope(t, envelope))
...
func assistantSessionRuntimeFoundationRoundTripEnvelope(t *testing.T, envelope streaming.Envelope) streaming.Envelope {
	t.Helper()
