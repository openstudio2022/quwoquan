...
// assistantSessionNotificationCommandWriterRecordingNotificationCommandWriter is a local-contract spy, not a runtime
...
type assistantSessionNotificationCommandWriterRecordingNotificationCommandWriter struct {
	mu       sync.Mutex
...
func TestRecordingNotificationCommandWriterKeepsTypedUserBoundary(t *testing.T) {
	...
	writer := assistantSessionNotificationCommandWriterNewRecordingNotificationCommandWriter()
...
func assistantSessionNotificationCommandWriterNewRecordingNotificationCommandWriter() *assistantSessionNotificationCommandWriterRecordingNotificationCommandWriter {
	return &assistantSessionNotificationCommandWriterRecordingNotificationCommandWriter{}
}

func (w *assistantSessionNotificationCommandWriterRecordingNotificationCommandWriter) CreateAppMessage(
	_ context.Context,
...
func (w *assistantSessionNotificationCommandWriterRecordingNotificationCommandWriter) CommandsForUser(
	userID string,
