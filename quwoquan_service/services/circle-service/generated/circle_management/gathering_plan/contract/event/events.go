...
// Event type constants for GatheringPlan.
const (
	GatheringPlanCreated           = "GatheringPlanCreated"
	GatheringPlanProposalRecorded  = "GatheringPlanProposalRecorded"
	GatheringPlanRevisionCommitted = "GatheringPlanRevisionCommitted"
)
