...
var ErrVersionConflict = errors.New("Gathering version conflict")
...
type ConversationPort interface {
	...
	AddMember(ctx context.Context, conversationID, personaID, operationKey string) error
	RemoveMember(ctx context.Context, conversationID, personaID, operationKey string) error
}
