...
func NewCircleMembershipStreamPublisher(transport runtimemessaging.DurableRecordAppender) *CircleMembershipStreamPublisher {
...
func (publisher *CircleMembershipStreamPublisher) Publish(ctx context.Context, event membershipports.OutboxEvent) error {
	...
	if err := runtimemessaging.AppendDurableRecord(ctx, publisher.transport, CircleMembershipStream, map[string]string{
