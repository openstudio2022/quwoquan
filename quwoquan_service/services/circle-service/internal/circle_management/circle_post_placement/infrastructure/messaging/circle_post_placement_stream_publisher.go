...
func NewCirclePostPlacementStreamPublisher(transport runtimemessaging.DurableRecordAppender) *CirclePostPlacementStreamPublisher {
...
func (publisher *CirclePostPlacementStreamPublisher) Publish(ctx context.Context, event placementports.OutboxEvent) error {
	...
	if err := runtimemessaging.AppendDurableRecord(ctx, publisher.transport, CirclePostPlacementStream, map[string]string{
