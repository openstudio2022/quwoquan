...
func NewMongoPostCountProjector(database *mongo.Database, redis rtredis.Client) *MongoPostCountProjector {
	if database == nil || redis == nil {
		panic("CirclePostPlacement post-count projector requires MongoDB and Redis")
	}
...
func (projector *MongoPostCountProjector) Publish(ctx context.Context, event placementports.OutboxEvent) error {
...
var _ placementports.OutboxPublisher = (*MongoPostCountProjector)(nil)
