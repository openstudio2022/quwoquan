...
func (s *sweeperCallStore) FindActiveCallsForUsers(
	context.Context,
	[]string,
	int,
) ([]*model.CallSession, error) {
	panic("FindActiveCallsForUsers must not be used by the ring-timeout sweeper")
}
...
func (noopCallStateCache) DeleteCallState(context.Context, string) error {
	return nil
}
