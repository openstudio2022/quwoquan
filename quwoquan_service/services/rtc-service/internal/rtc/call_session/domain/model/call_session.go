// CallSession 聚合根模型。字段与 services/rtc-service/contracts/rtc/call_session/fields.yaml
...
const (
	...
	// Account terminal states end the whole CallSession rather than attempting
	// to retain an old room or re-admit any participant after restoration.
	EndReasonAccountClosed    = "account_closed"
	EndReasonAccountSuspended = "account_suspended"
