...
// TestMigratedMessageTransport verifies the command boundary through its public application port.
func TestMigratedMessageTransportApplicationPort(t *testing.T) {
