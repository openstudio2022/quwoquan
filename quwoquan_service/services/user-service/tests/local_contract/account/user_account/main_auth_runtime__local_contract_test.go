...
// TestMigratedMainAuthRuntime verifies the command boundary through its public application port.
func TestMigratedMainAuthRuntimeApplicationPort(t *testing.T) {
