...
// TestMigratedCounterProjectorUsesCanonicalPair verifies the public relationship aggregate identity contract.
func TestMigratedCounterProjectorUsesCanonicalPair(t *testing.T) {
