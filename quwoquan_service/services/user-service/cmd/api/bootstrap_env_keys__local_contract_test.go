...
func TestDeclaredEnvKeysCoverRetiredHandwrittenHooks(t *testing.T) {
	...
	expected := []string{
		...
		"USER_COLLECTION_QUERY_AUTHORITY_ACTIVE_KEY_ID",
		"USER_COLLECTION_QUERY_AUTHORITY_KEYRING_SECRET_REF",
		"USER_PROFILE_CACHE_TTL_SECONDS",
		"USER_RELATIONSHIP_POLICY_REVISION",
		"USER_RELATIONSHIP_POLICY_MAX_FOLLOWING_PER_PERSONA",
		"USER_RELATIONSHIP_POLICY_CONFIG_DIGEST",
		"USER_RELATIONSHIP_MUTATION_BASIS_ACTIVE_KEY_ID",
		"USER_RELATIONSHIP_MUTATION_BASIS_KEYRING_SECRET_REF",
		"USER_MONGO_URI",
		"USER_MONGO_DATABASE",
		"USER_REDIS_GENERAL_MODE",
		"USER_REDIS_GENERAL_ADDR",
		"USER_REDIS_GENERAL_ADDRS",
		"USER_REDIS_GENERAL_USERNAME",
