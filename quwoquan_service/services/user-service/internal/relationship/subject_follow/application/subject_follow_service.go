...
import (
	...
	subjectgenerated "quwoquan_service/services/user-service/generated/relationship/subject_follow"
...
func (s *SubjectFollowService) execute(
	...
	if err != nil {
		if errors.Is(err, sfmodel.ErrInvalidSubjectType) {
			return sfmodel.MutationResult{}, subjectgenerated.AppErrorFromSubjectFollowInvalidSubjectType(
