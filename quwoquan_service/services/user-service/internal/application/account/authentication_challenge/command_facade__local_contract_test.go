...
func (store *memoryChallengeStore) Create(
	_ context.Context,
...
func (store *memoryChallengeStore) LoadByID(
	_ context.Context,
	id string,
...
func (store *memoryChallengeStore) LoadLatest(
	_ context.Context,
...
func (store *memoryChallengeStore) Commit(
	_ context.Context,
