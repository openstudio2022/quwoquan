...
用法：
  python3 scripts/tools/product_ops/rec_policy_advisor.py --metrics-file cohorts.json
  python3 scripts/tools/product_ops/rec_policy_advisor.py --metrics-file cohorts.json --output report.json
