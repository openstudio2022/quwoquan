...
DEFAULT_OUT = ROOT / ".qwq_output/local/gamma-local/search_r_s06_s1_local_gamma_report.json"
...
def main() -> int:
    ...
    load_dir = ROOT / ".qwq_output/runs/search-load/local-gamma"
    ...
    rollback_json = ROOT / ".qwq_output/local/gamma-local/search_rollback_rehearsal_report.json"
    rollback_md = ROOT / ".qwq_output/runs/gamma/search_rollback_rehearsal.md"
