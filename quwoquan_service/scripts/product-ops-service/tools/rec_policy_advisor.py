...
用法：
  python3 scripts/product-ops-service/tools/rec_policy_advisor.py --metrics-file cohorts.json
  python3 scripts/product-ops-service/tools/rec_policy_advisor.py --metrics-file cohorts.json --output report.json
