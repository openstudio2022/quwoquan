...
用法：
  python3 scripts/product-ops-service/tools/eval_content_flywheel_loop.py
  python3 scripts/product-ops-service/tools/eval_content_flywheel_loop.py --output flywheel.json
  python3 scripts/product-ops-service/tools/eval_content_flywheel_loop.py --require-closed-loop          # 闭环未闭合 exit 1
  python3 scripts/product-ops-service/tools/eval_content_flywheel_loop.py --min-segment-consistency 0.99 # 跨投影一致性门禁
"""
