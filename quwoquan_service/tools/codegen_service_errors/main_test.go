...
func TestRenderErrorsUsesMetadataMessageAndRecovery(t *testing.T) {
	...
	for _, expected := range []string{
		"Code generated by tools/codegen_service_errors from assistant/assistant/assistant_preference_fact/errors.yaml. DO NOT EDIT.",
...
func TestRenderErrorsRejectsMissingMetadataMessage(t *testing.T) {
	_, err := renderErrors("assistant/assistant/assistant_preference_fact/errors.yaml", []errorEntry{
		{
