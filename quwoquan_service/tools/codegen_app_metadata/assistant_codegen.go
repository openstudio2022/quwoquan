...
func generateAssistantRuntimeArtifacts(metadataDir, appDir string) error {
	...
	writeFile(
		filepath.Join(appDir, "lib", "personal_assistant", "runtime", "generated", "enums", "assistant_runtime_enums.g.dart"),
...
func renderQueryTaskDart(schema *assistantQueryTaskSchema) string {
	...
	b.WriteString("import 'package:quwoquan_app/personal_assistant/runtime/generated/enums/assistant_runtime_enums.g.dart';\n\n")
