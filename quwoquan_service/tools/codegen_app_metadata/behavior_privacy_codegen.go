...
func renderContentBehaviorsDart(bf *behaviorsFile) string {
	...
	b.WriteString("// Code generated by tools/codegen_app_metadata from content/content/post/behaviors.yaml. DO NOT EDIT.\n\n")
	...
	for _, ev := range trackedEvents {
		...
		for _, pf := range ev.PayloadFields {
			...
			case "duration":
				positional = append(positional, "int duration")
			case "authorId":
			...
			case "catalogVersion":
				positional = append(positional, "String catalogVersion")
			case "taxonomyReleaseId":
				positional = append(positional, "String taxonomyReleaseId")
			case "consumedRatio":
			...
			case "state":
				positional = append(positional, "String state")
			case "subjectId":
...
func renderContentPrivacyDart(pf *privacyFile) string {
	var b strings.Builder
	b.WriteString("// Code generated by tools/codegen_app_metadata from content/content/post/privacy.yaml. DO NOT EDIT.\n\n")
	b.WriteString("// ignore: avoid_classes_with_only_static_members\n")
