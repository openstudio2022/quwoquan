...
func generatePostPublicationPolicy(
	...
	if err := source.Decode("content/post/publication_policy.yaml", &policy); err != nil {
		return err
	}
	if policy.Schema != "content_post_publication_policy" ||
		...
		return fmt.Errorf("content/post/publication_policy.yaml is incomplete or not fail-closed")
	}
	var buf bytes.Buffer
	buf.WriteString("// Code generated by tools/codegen_content_service from content/post/publication_policy.yaml. DO NOT EDIT.\n\n")
