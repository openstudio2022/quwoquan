...
func resultFromReceipt(
	...
	return readiness.ReadinessCaseResult{
		...
		TargetUATBindingDigest: binding.TargetUATBindingDigest,
		EntrySurface:           binding.EntrySurface,
		Carrier:                binding.Carrier,
		DeviceIdentity:         binding.DeviceIdentity,
		UATProfile:             binding.UATProfile,
		...
		ObservedOutcome:        binding.ObservedOutcome,
		ObservedReleaseID:      binding.ObservedReleaseID,
		PreviousReleaseID:      binding.PreviousReleaseID,
		Environment:            binding.Environment, Platform: binding.Platform,
		DeviceClass: binding.DeviceClass, DeviceRegistered: binding.DeviceRegistered,
