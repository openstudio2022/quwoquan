...
func init() {
	registerCatalogFieldPrivacyPolicies([]CatalogFieldPrivacyPolicy{
		...
		{ObjectID: "content.post", Field: "semanticDocument", Classification: "PUBLIC", Action: "drop", MaskStrategy: "", TruncateChars: 0, Explicit: false, Visibility: nil},
		...
		{ObjectID: "user.authentication_challenge", Field: "accountId", Classification: "", Action: "drop", MaskStrategy: "", TruncateChars: 0, Explicit: false, Visibility: nil},
		{ObjectID: "user.authentication_challenge", Field: "attemptCount", Classification: "", Action: "drop", MaskStrategy: "", TruncateChars: 0, Explicit: false, Visibility: nil},
		{ObjectID: "user.authentication_challenge", Field: "channel", Classification: "", Action: "drop", MaskStrategy: "", TruncateChars: 0, Explicit: false, Visibility: nil},
		{ObjectID: "user.authentication_challenge", Field: "completedAt", Classification: "", Action: "drop", MaskStrategy: "", TruncateChars: 0, Explicit: false, Visibility: nil},
		{ObjectID: "user.authentication_challenge", Field: "createdAt", Classification: "", Action: "drop", MaskStrategy: "", TruncateChars: 0, Explicit: false, Visibility: nil},
		{ObjectID: "user.authentication_challenge", Field: "deliveryRequestId", Classification: "", Action: "drop", MaskStrategy: "", TruncateChars: 0, Explicit: false, Visibility: nil},
		{ObjectID: "user.authentication_challenge", Field: "deliveryStatus", Classification: "", Action: "drop", MaskStrategy: "", TruncateChars: 0, Explicit: false, Visibility: nil},
		{ObjectID: "user.authentication_challenge", Field: "deliveryUpdatedAt", Classification: "", Action: "drop", MaskStrategy: "", TruncateChars: 0, Explicit: false, Visibility: nil},
		{ObjectID: "user.authentication_challenge", Field: "destinationHash", Classification: "SENSITIVE", Action: "drop", MaskStrategy: "", TruncateChars: 0, Explicit: true, Visibility: nil},
		{ObjectID: "user.authentication_challenge", Field: "expiresAt", Classification: "", Action: "drop", MaskStrategy: "", TruncateChars: 0, Explicit: false, Visibility: nil},
		{ObjectID: "user.authentication_challenge", Field: "id", Classification: "", Action: "drop", MaskStrategy: "", TruncateChars: 0, Explicit: false, Visibility: nil},
		{ObjectID: "user.authentication_challenge", Field: "lastDeliveryEventId", Classification: "", Action: "drop", MaskStrategy: "", TruncateChars: 0, Explicit: false, Visibility: nil},
		{ObjectID: "user.authentication_challenge", Field: "purpose", Classification: "", Action: "drop", MaskStrategy: "", TruncateChars: 0, Explicit: false, Visibility: nil},
		{ObjectID: "user.authentication_challenge", Field: "secretRef", Classification: "SECRET", Action: "drop", MaskStrategy: "", TruncateChars: 0, Explicit: true, Visibility: nil},
		{ObjectID: "user.authentication_challenge", Field: "status", Classification: "", Action: "drop", MaskStrategy: "", TruncateChars: 0, Explicit: false, Visibility: nil},
