...
type UploadSession struct {
	...
	TemporaryOSSKey string       `json:"temporaryOssKey,omitempty" bson:"temporaryOssKey,omitempty"`
...
// ObjectInfo is the runtime-side source of truth for uploaded object metadata.
