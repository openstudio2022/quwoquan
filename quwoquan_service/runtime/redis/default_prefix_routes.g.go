// Code generated by quwoquan_service/scripts/codegen/gen_redis_router_config.py — DO NOT EDIT.
...
func GeneratedPrefixRoutes() []PrefixRoute {
	return []PrefixRoute{
		...
		{Prefix: "content:publication-rate:", Scene: "general"},
