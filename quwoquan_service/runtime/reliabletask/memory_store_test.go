...
func TestCatalogLoaderValidatesChatAvatarTask(t *testing.T) {
	catalog, err := LoadCatalog("resources/module_catalog.yaml")
	if err != nil {
...
func TestPolicyCatalogLoaderAndShardLease(t *testing.T) {
	policies, err := LoadPolicyCatalog("resources/retention_policy.yaml")
	if err != nil {
	...
	catalog, err := LoadCatalogWithPolicies(
		"resources/module_catalog.yaml",
		"resources/retention_policy.yaml",
	)
	if err != nil {
