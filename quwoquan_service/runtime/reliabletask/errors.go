...
var (
	...
	ErrRecoveryIdempotencyKey      = errors.New("reliabletask: recovery idempotency key is required")
	ErrRecoveryIdempotencyConflict = errors.New("reliabletask: recovery idempotency key is bound to another task")
