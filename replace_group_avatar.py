...
with open('quwoquan_app/lib/components/avatar/group_avatar_grid.dart', 'r') as f:
    content = f.read()

new_class = '''class GroupAvatarGrid extends StatelessWidget {
...
pattern = re.compile(r'class GroupAvatarGrid extends StatelessWidget \{.*?\n\}\n', re.DOTALL)
new_content = pattern.sub(new_class + '\n', content)

with open('quwoquan_app/lib/components/avatar/group_avatar_grid.dart', 'w') as f:
    f.write(new_content)
