...
- Workflow Skill 五段、Cursor command 薄壳、frontmatter 与引用有效性；Skill body 不复述 contract 已拥有的 binding、candidate 前置、零 Reviewer 形态与六类 handoff 触发。HOTL 运行矩阵的 Skill 行与 `.agents/skills` 发现闭集一一对应。
