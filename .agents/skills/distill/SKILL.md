...
2. 每个候选声明触发场景、MUST/MUST NOT、关联 context 层与既有或新增 deterministic gate/check/evidence 绑定；落点只允许根/子树不变量、Workflow Skill、Feature spec/design/contracts 或 Review checklist。
