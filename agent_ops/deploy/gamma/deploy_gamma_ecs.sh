...
# 版本：GAMMA_DEPLOY_IMAGE_VERSION / GAMMA_DEPLOY_CONFIG_VERSION →
# 远端 LOCAL_GAMMA_IMAGE_VERSION / LOCAL_GAMMA_CONFIG_VERSION。
set -euo pipefail
...
# 公网矩阵入口必须是 gamma-proxy（Caddy）端口；远程 start 默认 LOCAL_GAMMA_HTTP_PORT=19000
LOCAL_GAMMA_HTTP_PORT="${LOCAL_GAMMA_HTTP_PORT:-19000}"
LOCAL_GAMMA_PRODUCT_OPS_PORT="${LOCAL_GAMMA_PRODUCT_OPS_PORT:-19010}"
LOCAL_GAMMA_MEDIA_EDGE_PORT="${LOCAL_GAMMA_MEDIA_EDGE_PORT:-19100}"
BASE_URL="${GAMMA_BASE_URL:-http://${ECS_HOST}:${LOCAL_GAMMA_HTTP_PORT}}"
PRODUCT_OPS_BASE_URL="${GAMMA_PRODUCT_OPS_BASE_URL:-http://${ECS_HOST}:${LOCAL_GAMMA_PRODUCT_OPS_PORT}}"
MEDIA_BASE_URL="${MEDIA_AVATAR_CDN_BASE_URL:-http://${ECS_HOST}:${LOCAL_GAMMA_MEDIA_EDGE_PORT}}"
...
# ECS 系统 python3 可能过旧，无法执行 print_local_port_profile.py。
# 这里先注入完整 gamma-local canonical 端口，避免启动脚本退回旧 compose 端口。
export LOCAL_GAMMA_HTTP_PORT="${LOCAL_GAMMA_HTTP_PORT:-19000}"
export LOCAL_GAMMA_PRODUCT_OPS_PORT="${LOCAL_GAMMA_PRODUCT_OPS_PORT:-19010}"
export LOCAL_GAMMA_PLATFORM_OPS_PORT="${LOCAL_GAMMA_PLATFORM_OPS_PORT:-19020}"
export LOCAL_GAMMA_MEDIA_EDGE_PORT="${LOCAL_GAMMA_MEDIA_EDGE_PORT:-19100}"
export LOCAL_GAMMA_MEDIA_ORIGIN_PORT="${LOCAL_GAMMA_MEDIA_ORIGIN_PORT:-19110}"
export LOCAL_GAMMA_MEDIA_PROCESSOR_PORT="${LOCAL_GAMMA_MEDIA_PROCESSOR_PORT:-19120}"
export LOCAL_GAMMA_CONTENT_PORT="${LOCAL_GAMMA_CONTENT_PORT:-19220}"
export LOCAL_GAMMA_CHAT_PORT="${LOCAL_GAMMA_CHAT_PORT:-19200}"
export LOCAL_GAMMA_USER_PORT="${LOCAL_GAMMA_USER_PORT:-19210}"
export LOCAL_GAMMA_ASSISTANT_PORT="${LOCAL_GAMMA_ASSISTANT_PORT:-19230}"
export LOCAL_GAMMA_REC_MODEL_PORT="${LOCAL_GAMMA_REC_MODEL_PORT:-19240}"
export LOCAL_GAMMA_PRODUCT_OPS_SERVICE_PORT="${LOCAL_GAMMA_PRODUCT_OPS_SERVICE_PORT:-19250}"
export LOCAL_GAMMA_PLATFORM_OPS_SERVICE_PORT="${LOCAL_GAMMA_PLATFORM_OPS_SERVICE_PORT:-19260}"
export LOCAL_GAMMA_TAG_PORT="${LOCAL_GAMMA_TAG_PORT:-19270}"
export LOCAL_GAMMA_POSTGRES_PORT="${LOCAL_GAMMA_POSTGRES_PORT:-19400}"
export LOCAL_GAMMA_MONGO_PORT="${LOCAL_GAMMA_MONGO_PORT:-19410}"
export LOCAL_GAMMA_REDIS_PORT="${LOCAL_GAMMA_REDIS_PORT:-19420}"
