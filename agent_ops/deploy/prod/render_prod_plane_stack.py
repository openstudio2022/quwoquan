...
STATE_GAMMA_CONFIG_ROOT = ROOT / "state" / "local" / "gamma" / "config-root"
DEFAULT_OUTPUT_ROOT = ROOT / "state" / "local" / "prod-plane-stack"
...
def _write_config_tree(
    *,
    ...
    for service in config_services:
        ...
        package_dir = ROOT / "artifacts" / "service-env-packages" / package_service / "prod"
