...
from agent_ops.deploy.lib.common import load_json_yaml, relpath, utc_now, write_json
...
DEFAULT_MANIFEST = ROOT / "deploy" / "legal" / "manifest.yaml"
DEFAULT_OUTPUT_ROOT = ROOT / "artifacts" / "legal-static-packages"
REQUIRED_DOCUMENTS = {
    "user-agreement",
    "privacy-policy",
    "permissions",
