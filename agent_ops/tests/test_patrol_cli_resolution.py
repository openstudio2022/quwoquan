...
from agent_ops.deploy.gamma import run_gamma_patrol_matrix_ci as gamma_patrol
from agent_ops.deploy.lib.patrol_cli import resolve_patrol_cli
from agent_ops.deploy.smoke import run_environment_patrol_smoke as env_patrol
