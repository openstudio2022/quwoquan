...
python3 quwoquan_service/scripts/gamma/verify_gamma_public_gateway_routing.py --base-url "$LG_BASE"
...
python3 agent_ops/deploy/gamma/run_local_gamma_avatar_e2e.py \
  --base-url "$LG_BASE" \
...
echo "  COMMERCIAL_MATRIX_MANIFEST=artifacts/commercial-matrix/chat-avatar/manifest.yaml bash agent_ops/avatar/run_chat_avatar_commercial_matrix_orchestrator.sh"
