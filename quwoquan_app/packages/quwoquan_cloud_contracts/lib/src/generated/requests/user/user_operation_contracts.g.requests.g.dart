...
final class ActivatePersonaCommand {
  ...
  factory ActivatePersonaCommand.fromWire(Map<String, Object?> map, [String path = "ActivatePersonaCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"personaId"}, path);
...
final class ApplyPersonaProfileSyncCommand {
  ...
  factory ApplyPersonaProfileSyncCommand.fromWire(Map<String, Object?> map, [String path = "ApplyPersonaProfileSyncCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"personaId", "applyScope", "syncTargetIds", "fieldsMask"}, path);
    return ApplyPersonaProfileSyncCommand(
      personaId: _generatedRequestString(map["personaId"], '$path.personaId'),
      applyScope: _generatedRequestString(map["applyScope"], '$path.applyScope'),
      syncTargetIds: map["syncTargetIds"] == null ? null : List<String>.unmodifiable(_generatedRequestList(map["syncTargetIds"], '$path.syncTargetIds').asMap().entries.map((entry) => _generatedRequestString(entry.value, '$path.syncTargetIds' + '[${entry.key}]'))),
      fieldsMask: map["fieldsMask"] == null ? null : List<String>.unmodifiable(_generatedRequestList(map["fieldsMask"], '$path.fieldsMask').asMap().entries.map((entry) => _generatedRequestString(entry.value, '$path.fieldsMask' + '[${entry.key}]'))),
    );
  }
...
final class ApplyProfileUpdateProposalCommand {
  ...
  factory ApplyProfileUpdateProposalCommand.fromWire(Map<String, Object?> map, [String path = "ApplyProfileUpdateProposalCommand"]) {
...
final class BindCarrierPhoneCredentialCommand {
  ...
  factory BindCarrierPhoneCredentialCommand.fromWire(Map<String, Object?> map, [String path = "BindCarrierPhoneCredentialCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"vendor", "carrierToken", "deviceId", "platform", "displayLabel"}, path);
    return BindCarrierPhoneCredentialCommand(
      vendor: _generatedRequestString(map["vendor"], '$path.vendor'),
      carrierToken: _generatedRequestString(map["carrierToken"], '$path.carrierToken'),
      deviceId: _generatedRequestString(map["deviceId"], '$path.deviceId'),
      platform: _generatedRequestString(map["platform"], '$path.platform'),
      displayLabel: map["displayLabel"] == null ? null : _generatedRequestString(map["displayLabel"], '$path.displayLabel'),
    );
  }
...
final class BindPhoneCredentialCommand {
  ...
  factory BindPhoneCredentialCommand.fromWire(Map<String, Object?> map, [String path = "BindPhoneCredentialCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"phone", "otpCode", "displayLabel"}, path);
...
final class BlockUserCommand {
  ...
  factory BlockUserCommand.fromWire(Map<String, Object?> map, [String path = "BlockUserCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"targetPersonaId"}, path);
    return BlockUserCommand(
      targetPersonaId: _generatedRequestString(map["targetPersonaId"], '$path.targetPersonaId'),
    );
  }
...
final class CancelGreetingCommand {
  ...
  factory CancelGreetingCommand.fromWire(Map<String, Object?> map, [String path = "CancelGreetingCommand"]) {
...
final class CloseAccountCommand {
  ...
  factory CloseAccountCommand.fromWire(Map<String, Object?> map, [String path = "CloseAccountCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"clientRequestId"}, path);
    return CloseAccountCommand(
      clientRequestId: map["clientRequestId"] == null ? null : _generatedRequestString(map["clientRequestId"], '$path.clientRequestId'),
    );
  }
...
final class CompleteFederatedPhoneBindingCommand {
  ...
  factory CompleteFederatedPhoneBindingCommand.fromWire(Map<String, Object?> map, [String path = "CompleteFederatedPhoneBindingCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"bindingTicket", "phone", "otpCode", "challengeId", "deviceId", "platform", "appVersion", "agreementVersion", "privacyVersion"}, path);
    return CompleteFederatedPhoneBindingCommand(
      bindingTicket: _generatedRequestString(map["bindingTicket"], '$path.bindingTicket'),
      phone: _generatedRequestString(map["phone"], '$path.phone'),
      otpCode: _generatedRequestString(map["otpCode"], '$path.otpCode'),
      challengeId: _generatedRequestString(map["challengeId"], '$path.challengeId'),
      deviceId: _generatedRequestString(map["deviceId"], '$path.deviceId'),
      platform: _generatedRequestString(map["platform"], '$path.platform'),
      appVersion: _generatedRequestString(map["appVersion"], '$path.appVersion'),
      agreementVersion: _generatedRequestString(map["agreementVersion"], '$path.agreementVersion'),
      privacyVersion: _generatedRequestString(map["privacyVersion"], '$path.privacyVersion'),
    );
  }
...
final class ConfirmProfileUpdateProposalCommand {
  ...
  factory ConfirmProfileUpdateProposalCommand.fromWire(Map<String, Object?> map, [String path = "ConfirmProfileUpdateProposalCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"id"}, path);
...
final class CreateAlipayAuthorizationRequestCommand {
  ...
  factory CreateAlipayAuthorizationRequestCommand.fromWire(Map<String, Object?> map, [String path = "CreateAlipayAuthorizationRequestCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"platform", "appVersion"}, path);
...
final class CreatePersonaCommand {
  ...
  factory CreatePersonaCommand.fromWire(Map<String, Object?> map, [String path = "CreatePersonaCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"displayName", "avatarUrl", "isolationLevel", "purposeHint"}, path);
    return CreatePersonaCommand(
      displayName: _generatedRequestString(map["displayName"], '$path.displayName'),
      avatarUrl: map["avatarUrl"] == null ? null : _generatedRequestString(map["avatarUrl"], '$path.avatarUrl'),
      isolationLevel: map["isolationLevel"] == null ? null : _generatedRequestString(map["isolationLevel"], '$path.isolationLevel'),
      purposeHint: map["purposeHint"] == null ? null : _generatedRequestString(map["purposeHint"], '$path.purposeHint'),
    );
  }
...
final class CreateProfileUpdateProposalCommand {
  CreateProfileUpdateProposalCommand({
    ...
    if (this.displayName != null && this.displayName!.length > 64) {
      throw ArgumentError.value(this.displayName, "displayName", "length exceeds 64");
    }
    ...
    if (this.purposeHint != null && this.purposeHint!.length > 120) {
      throw ArgumentError.value(this.purposeHint, "purposeHint", "length exceeds 120");
    }
  ...
  factory CreateProfileUpdateProposalCommand.fromWire(Map<String, Object?> map, [String path = "CreateProfileUpdateProposalCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"personaId", "proposalId", "source", "displayName", "bio", "avatarMediaAssetId", "backgroundMediaAssetId", "isPrivate", "isolationLevel", "purposeHint", "reason", "evidenceRefs", "impactScope"}, path);
    return CreateProfileUpdateProposalCommand(
      personaId: _generatedRequestString(map["personaId"], '$path.personaId'),
      proposalId: _generatedRequestString(map["proposalId"], '$path.proposalId'),
      source: switch (map["source"]) { "persona" => ProposalSource.persona, "assistant" => ProposalSource.assistant, "external" => ProposalSource.external, _ => throw FormatException('$path.source' + ' has an invalid enum value'), },
      displayName: map["displayName"] == null ? null : _generatedRequestString(map["displayName"], '$path.displayName'),
      bio: map["bio"] == null ? null : _generatedRequestString(map["bio"], '$path.bio'),
      avatarMediaAssetId: map["avatarMediaAssetId"] == null ? null : _generatedRequestString(map["avatarMediaAssetId"], '$path.avatarMediaAssetId'),
      backgroundMediaAssetId: map["backgroundMediaAssetId"] == null ? null : _generatedRequestString(map["backgroundMediaAssetId"], '$path.backgroundMediaAssetId'),
      isPrivate: map["isPrivate"] == null ? null : _generatedRequestBool(map["isPrivate"], '$path.isPrivate'),
      isolationLevel: map["isolationLevel"] == null ? null : _generatedRequestString(map["isolationLevel"], '$path.isolationLevel'),
      purposeHint: map["purposeHint"] == null ? null : _generatedRequestString(map["purposeHint"], '$path.purposeHint'),
      reason: _generatedRequestString(map["reason"], '$path.reason'),
      evidenceRefs: List<String>.unmodifiable(_generatedRequestList(map["evidenceRefs"], '$path.evidenceRefs').asMap().entries.map((entry) => _generatedRequestString(entry.value, '$path.evidenceRefs' + '[${entry.key}]'))),
      impactScope: List<String>.unmodifiable(_generatedRequestList(map["impactScope"], '$path.impactScope').asMap().entries.map((entry) => _generatedRequestString(entry.value, '$path.impactScope' + '[${entry.key}]'))),
    );
  }
  ...
  Map<String, Object?> toWire() => <String, Object?>{
    ...
    if (this.avatarMediaAssetId != null) "avatarMediaAssetId": this.avatarMediaAssetId!,
    if (this.backgroundMediaAssetId != null) "backgroundMediaAssetId": this.backgroundMediaAssetId!,
...
final class DevicePushEndpointRemoveCommand {
  ...
  factory DevicePushEndpointRemoveCommand.fromWire(Map<String, Object?> map, [String path = "DevicePushEndpointRemoveCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"deviceId", "endpointKind"}, path);
    return DevicePushEndpointRemoveCommand(
      deviceId: _generatedRequestString(map["deviceId"], '$path.deviceId'),
      endpointKind: switch (map["endpointKind"]) { "apns_voip" => DevicePushEndpointKind.apnsVoip, "fcm" => DevicePushEndpointKind.fcm, _ => throw FormatException('$path.endpointKind' + ' has an invalid enum value'), },
    );
  }
...
final class DevicePushEndpointUpsertCommand {
  ...
  factory DevicePushEndpointUpsertCommand.fromWire(Map<String, Object?> map, [String path = "DevicePushEndpointUpsertCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"deviceId", "endpointKind", "token", "appVersion"}, path);
...
final class DismissContactDiscoveryCommand {
  ...
  factory DismissContactDiscoveryCommand.fromWire(Map<String, Object?> map, [String path = "DismissContactDiscoveryCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"id"}, path);
...
final class FollowUserCommand {
  ...
  factory FollowUserCommand.fromWire(Map<String, Object?> map, [String path = "FollowUserCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"targetPersonaId", "source", "clientRequestId"}, path);
...
final class GetPersonaLifecycleGuardQuery {
  ...
  factory GetPersonaLifecycleGuardQuery.fromWire(Map<String, Object?> map, [String path = "GetPersonaLifecycleGuardQuery"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"personaId"}, path);
...
final class GetPersonaProfileQuery {
  ...
  factory GetPersonaProfileQuery.fromWire(Map<String, Object?> map, [String path = "GetPersonaProfileQuery"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"personaId"}, path);
...
final class GetRelationshipCapabilityQuery {
  ...
  factory GetRelationshipCapabilityQuery.fromWire(Map<String, Object?> map, [String path = "GetRelationshipCapabilityQuery"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"personaId"}, path);
    return GetRelationshipCapabilityQuery(
      targetPersonaId: _generatedRequestString(map["personaId"], '$path.personaId'),
    );
  }
...
final class GetUserHomepageBundleQuery {
  ...
  factory GetUserHomepageBundleQuery.fromWire(Map<String, Object?> map, [String path = "GetUserHomepageBundleQuery"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"personaId"}, path);
...
final class IgnoreGreetingCommand {
  ...
  factory IgnoreGreetingCommand.fromWire(Map<String, Object?> map, [String path = "IgnoreGreetingCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"requestId"}, path);
...
final class InitiateContactDiscoveryCommand {
  ...
  factory InitiateContactDiscoveryCommand.fromWire(Map<String, Object?> map, [String path = "InitiateContactDiscoveryCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"hashedPhones"}, path);
    return InitiateContactDiscoveryCommand(
      hashedPhones: List<String>.unmodifiable(_generatedRequestList(map["hashedPhones"], '$path.hashedPhones').asMap().entries.map((entry) => _generatedRequestString(entry.value, '$path.hashedPhones' + '[${entry.key}]'))),
    );
  }
...
final class ListBlockedUsersQuery {
  ...
  factory ListBlockedUsersQuery.fromWire(Map<String, Object?> map, [String path = "ListBlockedUsersQuery"]) {
...
final class ListFollowingSubjectsQuery {
  ...
  factory ListFollowingSubjectsQuery.fromWire(Map<String, Object?> map, [String path = "ListFollowingSubjectsQuery"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"cursor", "limit", "subjectType"}, path);
    return ListFollowingSubjectsQuery(
      cursor: map["cursor"] == null ? null : _generatedRequestString(map["cursor"], '$path.cursor'),
      limit: map.containsKey("limit") ? _generatedRequestInt(map["limit"], '$path.limit') : 20,
      subjectType: map["subjectType"] == null ? null : switch (map["subjectType"]) { "persona" => FollowSubjectKind.persona, "homepage" => FollowSubjectKind.homepage, "circle" => FollowSubjectKind.circle, "location" => FollowSubjectKind.location, _ => throw FormatException('$path.subjectType' + ' has an invalid enum value'), },
    );
  }
...
final class ListGreetingRequestsQuery {
  ...
  factory ListGreetingRequestsQuery.fromWire(Map<String, Object?> map, [String path = "ListGreetingRequestsQuery"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"status", "cursor", "limit"}, path);
    return ListGreetingRequestsQuery(
      status: map.containsKey("status") ? _generatedRequestString(map["status"], '$path.status') : 'pending',
      cursor: map["cursor"] == null ? null : _generatedRequestString(map["cursor"], '$path.cursor'),
      limit: map.containsKey("limit") ? _generatedRequestInt(map["limit"], '$path.limit') : 20,
    );
  }
...
final class LoginAnonymousCommand {
  ...
  factory LoginAnonymousCommand.fromWire(Map<String, Object?> map, [String path = "LoginAnonymousCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"installId", "deviceFingerprintHash", "platform", "appVersion"}, path);
    return LoginAnonymousCommand(
      installId: _generatedRequestString(map["installId"], '$path.installId'),
      deviceFingerprintHash: _generatedRequestString(map["deviceFingerprintHash"], '$path.deviceFingerprintHash'),
      platform: _generatedRequestString(map["platform"], '$path.platform'),
      appVersion: _generatedRequestString(map["appVersion"], '$path.appVersion'),
    );
  }
...
final class LoginOneTapCommand {
  ...
  factory LoginOneTapCommand.fromWire(Map<String, Object?> map, [String path = "LoginOneTapCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"vendor", "carrierToken", "deviceId", "platform", "appVersion", "agreementVersion", "privacyVersion"}, path);
...
final class LoginWithAlipayCommand {
  ...
  factory LoginWithAlipayCommand.fromWire(Map<String, Object?> map, [String path = "LoginWithAlipayCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"alipayAuthCode", "deviceId", "platform", "appVersion", "agreementVersion", "privacyVersion"}, path);
    return LoginWithAlipayCommand(
      alipayAuthCode: _generatedRequestString(map["alipayAuthCode"], '$path.alipayAuthCode'),
      deviceId: _generatedRequestString(map["deviceId"], '$path.deviceId'),
      platform: _generatedRequestString(map["platform"], '$path.platform'),
      appVersion: map["appVersion"] == null ? null : _generatedRequestString(map["appVersion"], '$path.appVersion'),
      agreementVersion: _generatedRequestString(map["agreementVersion"], '$path.agreementVersion'),
...
final class LoginWithPhoneCommand {
  ...
  factory LoginWithPhoneCommand.fromWire(Map<String, Object?> map, [String path = "LoginWithPhoneCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"phone", "otpCode", "deviceId", "platform", "appVersion", "agreementVersion", "privacyVersion"}, path);
...
final class LoginWithQqCommand {
  ...
  factory LoginWithQqCommand.fromWire(Map<String, Object?> map, [String path = "LoginWithQqCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"qqAuthCode", "deviceId", "platform", "appVersion", "agreementVersion", "privacyVersion"}, path);
    return LoginWithQqCommand(
      qqAuthCode: _generatedRequestString(map["qqAuthCode"], '$path.qqAuthCode'),
      deviceId: _generatedRequestString(map["deviceId"], '$path.deviceId'),
      platform: _generatedRequestString(map["platform"], '$path.platform'),
      appVersion: map["appVersion"] == null ? null : _generatedRequestString(map["appVersion"], '$path.appVersion'),
      agreementVersion: _generatedRequestString(map["agreementVersion"], '$path.agreementVersion'),
...
final class LoginWithWechatCommand {
  ...
  factory LoginWithWechatCommand.fromWire(Map<String, Object?> map, [String path = "LoginWithWechatCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"wechatCode", "deviceId", "platform", "appVersion", "agreementVersion", "privacyVersion"}, path);
    return LoginWithWechatCommand(
      wechatCode: _generatedRequestString(map["wechatCode"], '$path.wechatCode'),
      deviceId: _generatedRequestString(map["deviceId"], '$path.deviceId'),
      platform: _generatedRequestString(map["platform"], '$path.platform'),
      appVersion: map["appVersion"] == null ? null : _generatedRequestString(map["appVersion"], '$path.appVersion'),
      agreementVersion: _generatedRequestString(map["agreementVersion"], '$path.agreementVersion'),
...
final class LogoutCommand {
  ...
  factory LogoutCommand.fromWire(Map<String, Object?> map, [String path = "LogoutCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"refreshToken", "deviceId"}, path);
    return LogoutCommand(
      refreshToken: map["refreshToken"] == null ? null : _generatedRequestString(map["refreshToken"], '$path.refreshToken'),
...
final class MarkFollowedSubjectVisitedCommand {
  ...
  factory MarkFollowedSubjectVisitedCommand.fromWire(Map<String, Object?> map, [String path = "MarkFollowedSubjectVisitedCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"subjectId", "subjectType", "visitedAt", "clientRequestId"}, path);
    return MarkFollowedSubjectVisitedCommand(
      ...
      visitedAt: _generatedRequestTimestamp(map["visitedAt"], '$path.visitedAt'),
      clientRequestId: map["clientRequestId"] == null ? null : _generatedRequestString(map["clientRequestId"], '$path.clientRequestId'),
    );
  }
...
final class PersonaRelationshipListQuery {
  ...
  factory PersonaRelationshipListQuery.fromWire(Map<String, Object?> map, [String path = "PersonaRelationshipListQuery"]) {
...
final class ProfileUpdateProposalListQuery {
  ...
  factory ProfileUpdateProposalListQuery.fromWire(Map<String, Object?> map, [String path = "ProfileUpdateProposalListQuery"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"personaId", "cursor", "limit"}, path);
...
final class ProfileUpdateProposalQuery {
  ...
  factory ProfileUpdateProposalQuery.fromWire(Map<String, Object?> map, [String path = "ProfileUpdateProposalQuery"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"id"}, path);
...
final class RefreshTokenCommand {
  ...
  factory RefreshTokenCommand.fromWire(Map<String, Object?> map, [String path = "RefreshTokenCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"refreshToken"}, path);
    return RefreshTokenCommand(
      refreshToken: _generatedRequestString(map["refreshToken"], '$path.refreshToken'),
    );
  }
...
final class RejectProfileUpdateProposalCommand {
  ...
  factory RejectProfileUpdateProposalCommand.fromWire(Map<String, Object?> map, [String path = "RejectProfileUpdateProposalCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"id"}, path);
...
final class ReplyGreetingCommand {
  ...
  factory ReplyGreetingCommand.fromWire(Map<String, Object?> map, [String path = "ReplyGreetingCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"requestId"}, path);
...
final class ResolveOneTapLoginHintCommand {
  ...
  factory ResolveOneTapLoginHintCommand.fromWire(Map<String, Object?> map, [String path = "ResolveOneTapLoginHintCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"vendor", "carrierToken", "deviceId", "platform", "appVersion"}, path);
...
final class ResolveProfileQrTokenQuery {
  ...
  factory ResolveProfileQrTokenQuery.fromWire(Map<String, Object?> map, [String path = "ResolveProfileQrTokenQuery"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"qr", "handle"}, path);
    return ResolveProfileQrTokenQuery(
      qr: _generatedRequestString(map["qr"], '$path.qr'),
      handle: map["handle"] == null ? null : _generatedRequestString(map["handle"], '$path.handle'),
    );
  }
...
final class RetirePersonaCommand {
  ...
  factory RetirePersonaCommand.fromWire(Map<String, Object?> map, [String path = "RetirePersonaCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"personaId"}, path);
...
final class RollbackProfileUpdateProposalCommand {
  ...
  factory RollbackProfileUpdateProposalCommand.fromWire(Map<String, Object?> map, [String path = "RollbackProfileUpdateProposalCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"id"}, path);
...
final class SearchSocialRelationsQuery {
  ...
  factory SearchSocialRelationsQuery.fromWire(Map<String, Object?> map, [String path = "SearchSocialRelationsQuery"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"query", "cursor", "limit"}, path);
...
final class SendGreetingCommand {
  ...
  factory SendGreetingCommand.fromWire(Map<String, Object?> map, [String path = "SendGreetingCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"targetPersonaId", "requestMessage", "source", "intersectionRef"}, path);
    return SendGreetingCommand(
      targetPersonaId: _generatedRequestString(map["targetPersonaId"], '$path.targetPersonaId'),
      requestMessage: map["requestMessage"] == null ? null : _generatedRequestString(map["requestMessage"], '$path.requestMessage'),
      source: map.containsKey("source") ? _generatedRequestString(map["source"], '$path.source') : 'profile',
      intersectionRef: map["intersectionRef"] == null ? null : GreetingIntersectionRef.fromWire(_generatedRequestObject(map["intersectionRef"], '$path.intersectionRef'), '$path.intersectionRef'),
    );
  }
  ...
  Map<String, Object?> toWire() => <String, Object?>{
    ...
    "source": this.source,
    if (this.intersectionRef != null) "intersectionRef": this.intersectionRef!.toWire(),
  };
}
...
final class SendOtpCommand {
  ...
  factory SendOtpCommand.fromWire(Map<String, Object?> map, [String path = "SendOtpCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"phone", "deviceId", "platform", "appVersion", "sourceOperation", "bindingTicket"}, path);
...
final class UnbindCredentialCommand {
  ...
  factory UnbindCredentialCommand.fromWire(Map<String, Object?> map, [String path = "UnbindCredentialCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"credentialType"}, path);
    return UnbindCredentialCommand(
      credentialType: _generatedRequestString(map["credentialType"], '$path.credentialType'),
    );
  }
...
final class UnblockUserCommand {
  ...
  factory UnblockUserCommand.fromWire(Map<String, Object?> map, [String path = "UnblockUserCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"targetPersonaId"}, path);
...
final class UnfollowUserCommand {
  ...
  factory UnfollowUserCommand.fromWire(Map<String, Object?> map, [String path = "UnfollowUserCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"targetPersonaId", "clientRequestId"}, path);
...
final class UpdateAppearanceSettingsCommand {
  ...
  factory UpdateAppearanceSettingsCommand.fromWire(Map<String, Object?> map, [String path = "UpdateAppearanceSettingsCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"themeMode", "fontSizePreset", "applyScope"}, path);
    return UpdateAppearanceSettingsCommand(
      themeMode: switch (map["themeMode"]) { "system" => ThemeModeSetting.system, "light" => ThemeModeSetting.light, "dark" => ThemeModeSetting.dark, _ => throw FormatException('$path.themeMode' + ' has an invalid enum value'), },
      fontSizePreset: switch (map["fontSizePreset"]) { "xs" => FontSizePreset.xs, "sm" => FontSizePreset.sm, "md" => FontSizePreset.md, "lg" => FontSizePreset.lg, "xl" => FontSizePreset.xl, _ => throw FormatException('$path.fontSizePreset' + ' has an invalid enum value'), },
      applyScope: switch (map["applyScope"]) { "all_accounts" => AppearanceApplyScope.allAccounts, "current_persona" => AppearanceApplyScope.currentPersona, "inherit_owner_default" => AppearanceApplyScope.inheritOwnerDefault, _ => throw FormatException('$path.applyScope' + ' has an invalid enum value'), },
    );
  }
...
final class UpdateCallSettingsCommand {
  ...
  factory UpdateCallSettingsCommand.fromWire(Map<String, Object?> map, [String path = "UpdateCallSettingsCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"defaultIncomingCallRingtoneId", "allowCallerRingtoneOverride", "enableCallVibration", "enableGroupCallRing"}, path);
    return UpdateCallSettingsCommand(
      defaultIncomingCallRingtoneId: map["defaultIncomingCallRingtoneId"] == null ? null : _generatedRequestString(map["defaultIncomingCallRingtoneId"], '$path.defaultIncomingCallRingtoneId'),
      allowCallerRingtoneOverride: map["allowCallerRingtoneOverride"] == null ? null : _generatedRequestBool(map["allowCallerRingtoneOverride"], '$path.allowCallerRingtoneOverride'),
      enableCallVibration: map["enableCallVibration"] == null ? null : _generatedRequestBool(map["enableCallVibration"], '$path.enableCallVibration'),
      enableGroupCallRing: map["enableGroupCallRing"] == null ? null : _generatedRequestBool(map["enableGroupCallRing"], '$path.enableGroupCallRing'),
    );
  }

  Map<String, Object?> toWire() => <String, Object?>{
    if (this.defaultIncomingCallRingtoneId != null) "defaultIncomingCallRingtoneId": this.defaultIncomingCallRingtoneId!,
...
final class UpdateNotificationSettingsCommand {
  ...
  factory UpdateNotificationSettingsCommand.fromWire(Map<String, Object?> map, [String path = "UpdateNotificationSettingsCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"enablePush", "enableMarketing", "quietHoursStart", "quietHoursEnd"}, path);
    return UpdateNotificationSettingsCommand(
      enablePush: map["enablePush"] == null ? null : _generatedRequestBool(map["enablePush"], '$path.enablePush'),
      enableMarketing: map["enableMarketing"] == null ? null : _generatedRequestBool(map["enableMarketing"], '$path.enableMarketing'),
      quietHoursStart: map["quietHoursStart"] == null ? null : _generatedRequestString(map["quietHoursStart"], '$path.quietHoursStart'),
      quietHoursEnd: map["quietHoursEnd"] == null ? null : _generatedRequestString(map["quietHoursEnd"], '$path.quietHoursEnd'),
    );
  }
...
final class UpdatePersonaCommand {
  ...
  factory UpdatePersonaCommand.fromWire(Map<String, Object?> map, [String path = "UpdatePersonaCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"personaId", "displayName", "avatarUrl", "backgroundUrl", "isolationLevel", "purposeHint", "applyScope", "syncTargetIds", "fieldsMask"}, path);
    return UpdatePersonaCommand(
      personaId: _generatedRequestString(map["personaId"], '$path.personaId'),
      displayName: map["displayName"] == null ? null : _generatedRequestString(map["displayName"], '$path.displayName'),
      avatarUrl: map["avatarUrl"] == null ? null : _generatedRequestString(map["avatarUrl"], '$path.avatarUrl'),
      backgroundUrl: map["backgroundUrl"] == null ? null : _generatedRequestString(map["backgroundUrl"], '$path.backgroundUrl'),
      isolationLevel: map["isolationLevel"] == null ? null : _generatedRequestString(map["isolationLevel"], '$path.isolationLevel'),
      purposeHint: map["purposeHint"] == null ? null : _generatedRequestString(map["purposeHint"], '$path.purposeHint'),
      applyScope: map["applyScope"] == null ? null : _generatedRequestString(map["applyScope"], '$path.applyScope'),
      syncTargetIds: map["syncTargetIds"] == null ? null : List<String>.unmodifiable(_generatedRequestList(map["syncTargetIds"], '$path.syncTargetIds').asMap().entries.map((entry) => _generatedRequestString(entry.value, '$path.syncTargetIds' + '[${entry.key}]'))),
      fieldsMask: map["fieldsMask"] == null ? null : List<String>.unmodifiable(_generatedRequestList(map["fieldsMask"], '$path.fieldsMask').asMap().entries.map((entry) => _generatedRequestString(entry.value, '$path.fieldsMask' + '[${entry.key}]'))),
    );
  }
...
final class UpdatePrivacySettingsCommand {
  ...
  factory UpdatePrivacySettingsCommand.fromWire(Map<String, Object?> map, [String path = "UpdatePrivacySettingsCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"allowStrangerMsg", "profileVisibility", "blockedKeywords", "assistantEnabled"}, path);
    return UpdatePrivacySettingsCommand(
      allowStrangerMsg: map["allowStrangerMsg"] == null ? null : _generatedRequestBool(map["allowStrangerMsg"], '$path.allowStrangerMsg'),
      profileVisibility: map["profileVisibility"] == null ? null : switch (map["profileVisibility"]) { "public" => ProfileVisibility.public, "friends" => ProfileVisibility.friends, "private" => ProfileVisibility.privateProfile, _ => throw FormatException('$path.profileVisibility' + ' has an invalid enum value'), },
      blockedKeywords: map["blockedKeywords"] == null ? null : List<String>.unmodifiable(_generatedRequestList(map["blockedKeywords"], '$path.blockedKeywords').asMap().entries.map((entry) => _generatedRequestString(entry.value, '$path.blockedKeywords' + '[${entry.key}]'))),
      assistantEnabled: map["assistantEnabled"] == null ? null : _generatedRequestBool(map["assistantEnabled"], '$path.assistantEnabled'),
    );
  }

  Map<String, Object?> toWire() => <String, Object?>{
    if (this.allowStrangerMsg != null) "allowStrangerMsg": this.allowStrangerMsg!,
    if (this.profileVisibility != null) "profileVisibility": this.profileVisibility!.wireName,
...
final class UpdateUserProfileCommand {
  ...
  factory UpdateUserProfileCommand.fromWire(Map<String, Object?> map, [String path = "UpdateUserProfileCommand"]) {
    _generatedRequestRejectUnknownFields(map, const <String>{"nickname", "displayName", "avatarAssetId", "avatarUrl", "backgroundAssetId", "backgroundUrl", "bio", "gender", "birthDate", "regionTagRef", "occupationTagRef", "interestTagRefs", "expectedTaxonomyReleaseId", "identityTags", "profileVisibility", "applyScope", "syncTargetIds", "fieldsMask"}, path);
    return UpdateUserProfileCommand(
      nickname: map["nickname"] == null ? null : _generatedRequestString(map["nickname"], '$path.nickname'),
      displayName: map["displayName"] == null ? null : _generatedRequestString(map["displayName"], '$path.displayName'),
      avatarAssetId: map["avatarAssetId"] == null ? null : _generatedRequestString(map["avatarAssetId"], '$path.avatarAssetId'),
      avatarUrl: map["avatarUrl"] == null ? null : _generatedRequestString(map["avatarUrl"], '$path.avatarUrl'),
      backgroundAssetId: map["backgroundAssetId"] == null ? null : _generatedRequestString(map["backgroundAssetId"], '$path.backgroundAssetId'),
      backgroundUrl: map["backgroundUrl"] == null ? null : _generatedRequestString(map["backgroundUrl"], '$path.backgroundUrl'),
      bio: map["bio"] == null ? null : _generatedRequestString(map["bio"], '$path.bio'),
      gender: map["gender"] == null ? null : _generatedRequestString(map["gender"], '$path.gender'),
      birthDate: map["birthDate"] == null ? null : _generatedRequestString(map["birthDate"], '$path.birthDate'),
      regionTagRef: map["regionTagRef"] == null ? null : _generatedRequestString(map["regionTagRef"], '$path.regionTagRef'),
      occupationTagRef: map["occupationTagRef"] == null ? null : _generatedRequestString(map["occupationTagRef"], '$path.occupationTagRef'),
      interestTagRefs: map["interestTagRefs"] == null ? null : List<String>.unmodifiable(_generatedRequestList(map["interestTagRefs"], '$path.interestTagRefs').asMap().entries.map((entry) => _generatedRequestString(entry.value, '$path.interestTagRefs' + '[${entry.key}]'))),
      expectedTaxonomyReleaseId: map["expectedTaxonomyReleaseId"] == null ? null : _generatedRequestString(map["expectedTaxonomyReleaseId"], '$path.expectedTaxonomyReleaseId'),
      identityTags: map["identityTags"] == null ? null : List<String>.unmodifiable(_generatedRequestList(map["identityTags"], '$path.identityTags').asMap().entries.map((entry) => _generatedRequestString(entry.value, '$path.identityTags' + '[${entry.key}]'))),
      profileVisibility: map["profileVisibility"] == null ? null : _generatedRequestString(map["profileVisibility"], '$path.profileVisibility'),
      applyScope: map["applyScope"] == null ? null : _generatedRequestString(map["applyScope"], '$path.applyScope'),
      syncTargetIds: map["syncTargetIds"] == null ? null : List<String>.unmodifiable(_generatedRequestList(map["syncTargetIds"], '$path.syncTargetIds').asMap().entries.map((entry) => _generatedRequestString(entry.value, '$path.syncTargetIds' + '[${entry.key}]'))),
      fieldsMask: map["fieldsMask"] == null ? null : List<String>.unmodifiable(_generatedRequestList(map["fieldsMask"], '$path.fieldsMask').asMap().entries.map((entry) => _generatedRequestString(entry.value, '$path.fieldsMask' + '[${entry.key}]'))),
    );
...
CloudOperationRequestPayload encodeUserFollowingSubjectListFollowingSubjectsGeneratedRequest(ListFollowingSubjectsQuery request) {
  return CloudOperationRequestPayload(
    queryParameters: <String, String>{
      ...
      if (request.subjectType != null) "subjectType": (request.subjectType!.wireName).toString(),
    },
  );
}
...
CloudOperationRequestPayload encodeUserGreetingRequestSendGreetingRequestGeneratedRequest(SendGreetingCommand request) {
  return CloudOperationRequestPayload(
    body: <String, Object?>{
      ...
      if (request.intersectionRef != null) "intersectionRef": request.intersectionRef!.toWire(),
    },
  );
}
...
CloudOperationRequestPayload encodeUserProfileUpdateProposalCreateProfileUpdateProposalGeneratedRequest(CreateProfileUpdateProposalCommand request) {
  return CloudOperationRequestPayload(
    ...
    body: <String, Object?>{
      ...
      if (request.displayName != null) "displayName": request.displayName!,
      if (request.bio != null) "bio": request.bio!,
      if (request.avatarMediaAssetId != null) "avatarMediaAssetId": request.avatarMediaAssetId!,
      if (request.backgroundMediaAssetId != null) "backgroundMediaAssetId": request.backgroundMediaAssetId!,
...
CloudOperationRequestPayload encodeUserUserAccountGetProfileEditSnapshotGeneratedRequest(GetProfileEditSnapshotQuery request) {
  return CloudOperationRequestPayload(
  );
}
...
CloudOperationRequestPayload encodeUserUserSettingsUpdateCallSettingsGeneratedRequest(UpdateCallSettingsCommand request) {
  return CloudOperationRequestPayload(
    body: <String, Object?>{
      if (request.defaultIncomingCallRingtoneId != null) "defaultIncomingCallRingtoneId": request.defaultIncomingCallRingtoneId!,
...
CloudOperationRequestPayload encodeUserUserSettingsUpdateNotificationSettingsGeneratedRequest(UpdateNotificationSettingsCommand request) {
  return CloudOperationRequestPayload(
    body: <String, Object?>{
      ...
      if (request.quietHoursStart != null) "quietHoursStart": request.quietHoursStart!,
      if (request.quietHoursEnd != null) "quietHoursEnd": request.quietHoursEnd!,
    },
  );
}
...
CloudOperationRequestPayload encodeUserUserSettingsUpdatePrivacySettingsGeneratedRequest(UpdatePrivacySettingsCommand request) {
  return CloudOperationRequestPayload(
    body: <String, Object?>{
      ...
      if (request.profileVisibility != null) "profileVisibility": request.profileVisibility!.wireName,
