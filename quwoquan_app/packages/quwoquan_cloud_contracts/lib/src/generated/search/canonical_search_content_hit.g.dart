...
import '../content_contract_enums.g.dart';
...
class CanonicalSearchContentHit {
  ...
  factory CanonicalSearchContentHit.fromMap(Map<String, dynamic> m) {
    ...
    return CanonicalSearchContentHit(
      ...
      contentType: ContentType.fromWire(m['contentType']),
      contentIdentity: m['contentIdentity'] == null ? null : ContentIdentity.fromWire(m['contentIdentity']),
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      'contentIdentity': contentIdentity?.wireValue,
      'title': title,
      'summary': summary,
      'coverUrl': coverUrl,
      'authorId': authorId,
