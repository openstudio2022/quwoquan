...
final class AlphaFollowingSubjectFacet
  ...
  AlphaFollowingSubjectFacet({AlphaFixtureSeedReader? fixtures})
    : _items = _load(fixtures ?? alphaFixtureSeedReader);

  final List<FollowingSubjectResult> _items;

  static List<FollowingSubjectResult> _load(
