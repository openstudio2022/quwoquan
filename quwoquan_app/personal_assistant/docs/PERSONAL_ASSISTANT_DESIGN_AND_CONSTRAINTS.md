...
- 提示词正文必须在 `assets/personal_assistant/prompts/` 中管理
...
| 设计与开发约束 | 本文 |
| Prompt 模板 | `quwoquan_app/assets/personal_assistant/prompts/` |
| Tool 元数据 | `quwoquan_app/assets/personal_assistant/tools/catalog/tool_catalog.meta.json` |
