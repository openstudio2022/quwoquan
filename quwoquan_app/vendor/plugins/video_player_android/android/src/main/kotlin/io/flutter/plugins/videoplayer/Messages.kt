 ...
 * Generated class from Pigeon that represents data sent in messages.
 */
data class RenderedFirstFrameEvent (
  /** Native elapsed time from prepare to the rendered frame. */
  val ttffMs: Long
) : PlatformVideoEvent()
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): RenderedFirstFrameEvent {
      val ttffMs = pigeonVar_list[0] as Long
      return RenderedFirstFrameEvent(ttffMs)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    val other = other as RenderedFirstFrameEvent
    return MessagesPigeonUtils.deepEquals(this.ttffMs, other.ttffMs)
  }

  override fun hashCode(): Int {
    var result = javaClass.hashCode()
    result = 31 * result + MessagesPigeonUtils.deepHash(this.ttffMs)
    return result
  }
}
...
data class SeekSettledEvent (
 ...
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): SeekSettledEvent {
      val targetPositionMs = pigeonVar_list[0] as Long
      val settledPositionMs = pigeonVar_list[1] as Long
      val settleMs = pigeonVar_list[2] as Long
      return SeekSettledEvent(targetPositionMs, settledPositionMs, settleMs)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    val other = other as SeekSettledEvent
    return MessagesPigeonUtils.deepEquals(this.targetPositionMs, other.targetPositionMs) && MessagesPigeonUtils.deepEquals(this.settledPositionMs, other.settledPositionMs) && MessagesPigeonUtils.deepEquals(this.settleMs, other.settleMs)
  }

  override fun hashCode(): Int {
    var result = javaClass.hashCode()
    result = 31 * result + MessagesPigeonUtils.deepHash(this.targetPositionMs)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.settledPositionMs)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.settleMs)
    return result
  }
}
 ...
 * Generated class from Pigeon that represents data sent in messages.
 */
data class DroppedVideoFramesEvent (
  val droppedFrames: Long,
  val elapsedMs: Long
) : PlatformVideoEvent()
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): DroppedVideoFramesEvent {
      val droppedFrames = pigeonVar_list[0] as Long
      val elapsedMs = pigeonVar_list[1] as Long
      return DroppedVideoFramesEvent(droppedFrames, elapsedMs)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    val other = other as DroppedVideoFramesEvent
    return MessagesPigeonUtils.deepEquals(this.droppedFrames, other.droppedFrames) && MessagesPigeonUtils.deepEquals(this.elapsedMs, other.elapsedMs)
  }
...
data class AudioUnderrunEvent (
 ...
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): AudioUnderrunEvent {
      val bufferSize = pigeonVar_list[0] as Long
      val bufferSizeMs = pigeonVar_list[1] as Long
      val elapsedSinceLastFeedMs = pigeonVar_list[2] as Long
      return AudioUnderrunEvent(bufferSize, bufferSizeMs, elapsedSinceLastFeedMs)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    val other = other as AudioUnderrunEvent
    return MessagesPigeonUtils.deepEquals(this.bufferSize, other.bufferSize) && MessagesPigeonUtils.deepEquals(this.bufferSizeMs, other.bufferSizeMs) && MessagesPigeonUtils.deepEquals(this.elapsedSinceLastFeedMs, other.elapsedSinceLastFeedMs)
  }

  override fun hashCode(): Int {
    var result = javaClass.hashCode()
    result = 31 * result + MessagesPigeonUtils.deepHash(this.bufferSize)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.bufferSizeMs)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.elapsedSinceLastFeedMs)
    return result
  }
}
 ...
 * Generated class from Pigeon that represents data sent in messages.
 */
data class VideoFrameProcessingEvent (
  val processedFrames: Long
) : PlatformVideoEvent()
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): VideoFrameProcessingEvent {
      val processedFrames = pigeonVar_list[0] as Long
      return VideoFrameProcessingEvent(processedFrames)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    val other = other as VideoFrameProcessingEvent
    return MessagesPigeonUtils.deepEquals(this.processedFrames, other.processedFrames)
  }

  override fun hashCode(): Int {
    var result = javaClass.hashCode()
    result = 31 * result + MessagesPigeonUtils.deepHash(this.processedFrames)
    return result
  }
}
 ...
 * Generated class from Pigeon that represents data sent in messages.
 */
data class PlaybackDiagnosticsEvent (
  val rendererMode: String,
  val decoderQueueMode: String,
  val decoderFallbackEnabled: Boolean
) : PlatformVideoEvent()
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): PlaybackDiagnosticsEvent {
      val rendererMode = pigeonVar_list[0] as String
      val decoderQueueMode = pigeonVar_list[1] as String
      val decoderFallbackEnabled = pigeonVar_list[2] as Boolean
      return PlaybackDiagnosticsEvent(rendererMode, decoderQueueMode, decoderFallbackEnabled)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
  ...
  override fun equals(other: Any?): Boolean {
    ...
    val other = other as PlaybackDiagnosticsEvent
    return MessagesPigeonUtils.deepEquals(this.rendererMode, other.rendererMode) && MessagesPigeonUtils.deepEquals(this.decoderQueueMode, other.decoderQueueMode) && MessagesPigeonUtils.deepEquals(this.decoderFallbackEnabled, other.decoderFallbackEnabled)
  }

  override fun hashCode(): Int {
    var result = javaClass.hashCode()
    result = 31 * result + MessagesPigeonUtils.deepHash(this.rendererMode)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.decoderQueueMode)
    result = 31 * result + MessagesPigeonUtils.deepHash(this.decoderFallbackEnabled)
    return result
  }
}
...
private open class MessagesPigeonCodec : StandardMessageCodec() {
  override fun readValueOfType(type: Byte, buffer: ByteBuffer): Any? {
    return when (type) {
      ...
      135.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
          RenderedFirstFrameEvent.fromList(it)
        }
      }
      136.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
          SeekSettledEvent.fromList(it)
        }
      }
      137.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
          DroppedVideoFramesEvent.fromList(it)
        }
      }
      138.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
          AudioUnderrunEvent.fromList(it)
        }
      }
      139.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
          VideoFrameProcessingEvent.fromList(it)
        }
      }
      140.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
          PlaybackDiagnosticsEvent.fromList(it)
        }
      }
      141.toByte() -> {
        return (readValue(buffer) as? List<Any?>)?.let {
  ...
  override fun writeValue(stream: ByteArrayOutputStream, value: Any?)   {
    when (value) {
      ...
      is DroppedVideoFramesEvent -> {
        stream.write(137)
        writeValue(stream, value.toList())
      }
      is AudioUnderrunEvent -> {
        stream.write(138)
        writeValue(stream, value.toList())
      }
      is VideoFrameProcessingEvent -> {
        stream.write(139)
        writeValue(stream, value.toList())
      }
      is PlaybackDiagnosticsEvent -> {
        stream.write(140)
        writeValue(stream, value.toList())
      }
