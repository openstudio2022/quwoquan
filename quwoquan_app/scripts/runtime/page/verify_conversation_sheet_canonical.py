...
CANONICAL_MODAL_FILES = {
    "quwoquan_app/lib/design_system/surfaces/app_modal_presenter.dart",
    "quwoquan_app/lib/design_system/surfaces/app_top_anchored_dropdown.dart",
}
...
MODAL_SCRIM_ALLOWLIST = {
    "quwoquan_app/lib/design_system/surfaces/app_modal_presenter.dart",
    "quwoquan_app/lib/design_system/colors/app_colors.dart",
}
