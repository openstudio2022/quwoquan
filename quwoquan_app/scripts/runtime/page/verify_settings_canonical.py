...
Reads runtime/page/settings_canonical_manifest.yaml and:
...
ROOT = str(REPO_ROOT)
MANIFEST = os.path.join(os.path.dirname(os.path.abspath(__file__)), "settings_canonical_manifest.yaml")
...
DISCOVER_GLOBS = [
    "quwoquan_app/lib/service/user_service/account/user_settings/presentation/**/*_page.dart",
]

DISCOVER_FILES = [
    "quwoquan_app/lib/service/chat_service/chat/conversation/presentation/chat_settings_page.dart",
    "quwoquan_app/lib/service/chat_service/chat/conversation/presentation/chat_announcement_page.dart",
    "quwoquan_app/lib/service/chat_service/chat/conversation/presentation/start_group_chat_page.dart",
    "quwoquan_app/lib/service/chat_service/chat/conversation_membership/presentation/group_manage_page.dart",
    "quwoquan_app/lib/service/chat_service/chat/conversation_membership/presentation/transfer_ownership_page.dart",
    "quwoquan_app/lib/service/chat_service/chat/conversation_membership/presentation/group_admins_page.dart",
    "quwoquan_app/lib/service/chat_service/chat/conversation_membership/presentation/group_member_search_page.dart",
    "quwoquan_app/lib/service/user_service/account/user_account/presentation/settings_account_security_page.dart",
    "quwoquan_app/lib/service/user_service/relationship/persona_relationship/presentation/blocked_users_page.dart",
    "quwoquan_app/lib/service/user_service/persona_management/persona/presentation/persona_management_form_page.dart",
    "quwoquan_app/lib/service/content_service/trust_safety/report/presentation/my_reports_page.dart",
    "quwoquan_app/lib/service/assistant_service/assistant/assistant_preference/presentation/assistant_management_page.dart",
    "quwoquan_app/lib/service/assistant_service/assistant/assistant_run/presentation/assistant_reference_webview_page.dart",
    "quwoquan_app/lib/service/assistant_service/assistant/skill_catalog/presentation/assistant_skill_center_page.dart",
    "quwoquan_app/lib/service/circle_service/circle_management/circle/presentation/circle_edit_settings_page.dart",
]
