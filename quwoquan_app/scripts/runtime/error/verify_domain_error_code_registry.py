...
GENERATED_ENUMS = {
    "content": (
        "CONTENT",
        "quwoquan_app/lib/runtime/errors/generated/content/content_errors.g.dart",
    ),
    "user": (
        "USER",
        "quwoquan_app/lib/runtime/errors/generated/user/user_errors.g.dart",
    ),
    "chat": (
        "CHAT",
        "quwoquan_app/lib/runtime/errors/generated/chat/chat_errors.g.dart",
    ),
    "rtc": (
        "RTC",
        "quwoquan_app/lib/runtime/errors/generated/rtc/rtc_errors.g.dart",
    ),
    "integration_location": (
        "INTEGRATION",
        "quwoquan_app/lib/runtime/errors/generated/integration/"
        "integration_location_errors.g.dart",
    ),
    "assistant": (
        "ASSISTANT",
        "quwoquan_app/lib/runtime/errors/generated/assistant/assistant_errors.g.dart",
    ),
    "circle": (
        "CIRCLE",
        "quwoquan_app/lib/runtime/errors/generated/circle/circle_errors.g.dart",
    ),
    "circle_membership": (
        "CIRCLE",
    ...
    "entity": (
        "ENTITY",
        "quwoquan_app/lib/runtime/errors/generated/entity/entity_errors.g.dart",
    ),
}

REGISTRY_PATH = "quwoquan_app/lib/runtime/errors/domain_error_code.dart"
