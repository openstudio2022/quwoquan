...
_USER_ZSH_ACTIVATION = _load_sibling_module(
    "user_zsh_activation.py", "qwq_user_zsh_activation_canonical"
)
...
def _user_zsh_context():
    return _USER_ZSH_ACTIVATION.UserZshActivationContext(
        config_relative_path=USER_ZSH_CONFIG_RELATIVE_PATH,
        config_marker=USER_ZSH_CONFIG_MARKER,
        source_begin=USER_ZSH_SOURCE_BEGIN,
        source_end=USER_ZSH_SOURCE_END,
        prefix_newline_marker=USER_ZSH_PREFIX_NEWLINE_MARKER,
        carrier_path=USER_ZSH_CARRIER_PATH,
        entrypoint_digest_keys=WORKSPACE_ENTRYPOINT_DIGEST_KEYS,
...
_literal_existing_home = _USER_ZSH_ACTIVATION.literal_existing_home
...
def _user_zsh_paths(
    *,
    ...
    return _USER_ZSH_ACTIVATION.user_zsh_paths(
        home_path=home_path,
        config_relative_path=USER_ZSH_CONFIG_RELATIVE_PATH,
...
def activate_user_zsh(
    *,
    ...
    return _USER_ZSH_ACTIVATION.activate_user_zsh(
        context=_user_zsh_context(),
        home_path=home_path,
        environ=environ,
        config_path=config_path,
        zshrc_path=zshrc_path,
...
def deactivate_user_zsh(
    *,
    ...
    return _USER_ZSH_ACTIVATION.deactivate_user_zsh(
        context=_user_zsh_context(),
        home_path=home_path,
        config_path=config_path,
        zshrc_path=zshrc_path,
...
def user_zsh_status(
    *,
    ...
    return _USER_ZSH_ACTIVATION.user_zsh_status(
        context=_user_zsh_context(),
        home_path=home_path,
        environ=environ,
        config_path=config_path,
