...
if [[ -z "$LAUNCH_MODE" \
  ...
  DIRECT_PYTHON="$(bash "$STACKCTL_PYTHON_RESOLVER")" || {
    echo "[ios-dart-defines] GATE_BLOCK: direct Debug requires a compatible Python for runtime handoff and Simulator system trust." >&2
    exit 2
  }
