...
BENCHMARK = ROOT / "test/personal_assistant/domain_quality_benchmark_cases.json"
ENV_FILE = ROOT / "personal_assistant/.env"
CONFIG_FILE = ROOT / "personal_assistant/config.json"
DOMAIN_BLUEPRINT_FILE = ROOT / "assets/personal_assistant/prompts/domain_dialogue/domain_dialogue_blueprints.json"
...
def load_runtime() -> RuntimeConfig:
    ...
    if not api_key:
        raise RuntimeError("MIMO_API_KEY is empty in personal_assistant/.env")
