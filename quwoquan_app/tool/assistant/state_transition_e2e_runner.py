...
CONTRACT_FILE = ROOT / "assets/assistant/skills/divination_fortune/dialogue/state_transition_contract.json"
TEST_CASES_FILE = ROOT / "assets/assistant/skills/divination_fortune/dialogue/state_transition_test_cases.json"
JUDGE_PROMPT_FILE = ROOT / "assets/assistant/skills/divination_fortune/dialogue/dialogue_judge_prompt.md"
STATE_PROMPTS_FILE = ROOT / "assets/assistant/skills/divination_fortune/dialogue/state_prompts.md"
DOMAIN_ROUTING_FILE = ROOT / "assets/assistant/prompts/domain_routing/domain_routing_catalog.json"
EVENT_DETECTION_FILE = ROOT / "assets/assistant/prompts/domain_routing/event_detection_catalog.json"
...
def _resolve_domain_asset_paths(domain_id: str) -> Dict[str, Path]:
    base = ROOT / "assets/assistant/skills" / domain_id / "dialogue"
    return {
