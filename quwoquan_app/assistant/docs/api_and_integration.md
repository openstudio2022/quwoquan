...
> **合并自**：OpenClaw/飞书接入说明 · 过往版本 v1 API 合同 · 过往版本商业化规格 · Adapter SPI 说明
...
可用脚本：
- `assistant/scripts/list_skills.sh`
- `assistant/scripts/run_chat_turn.sh`
- `assistant/scripts/feishu_openclaw_voice_demo.sh`
