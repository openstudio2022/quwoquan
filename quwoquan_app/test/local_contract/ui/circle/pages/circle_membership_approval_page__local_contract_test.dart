...
void main() {
  ...
  Widget host(_ApprovalFixture fixture) => ProviderScope(
    overrides: [
      circleDetailPendingMembershipQueryProvider.overrideWithValue(fixture),
      circleDetailMembershipModerationWriterProvider.overrideWithValue(fixture),
    ],
    child: const CupertinoApp(
      localizationsDelegates: AppLocalizations.localizationsDelegates,
      home: CircleMembershipApprovalPage(circleId: circleId),
    ),
  );
...
final class _ApprovalFixture
    implements PendingCircleMembershipQuery, CircleMembershipModerationWriter {
  _ApprovalFixture(
