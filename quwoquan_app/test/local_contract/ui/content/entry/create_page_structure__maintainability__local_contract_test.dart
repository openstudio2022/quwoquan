...
void main() {
  const createPageFiles = <String>[
    ...
    'lib/ui/content/entry/pages/create_page_state.dart',
    'lib/ui/content/entry/pages/create_page_state_helpers.dart',
    'lib/ui/content/entry/pages/create_page_state_media_helpers.dart',
    'lib/ui/content/entry/pages/create_page_state_chrome_helpers.dart',
    'lib/ui/content/entry/pages/create_page_state_draft_helpers.dart',
    'lib/ui/content/entry/pages/create_page_state_surface_helpers.dart',
  ];
