...
void main() {
  group('CommentRemoteConfig.fromAppConfigRoot', () {
    test('解析 comment.attachment.max_images 的 canonical 蛇形键', () {
      final config = CommentRemoteConfig.fromAppConfigRoot(<String, Object?>{
    ...
    test('attachment_max_count 旧字段不再生效', () {
      final config = CommentRemoteConfig.fromAppConfigRoot(<String, Object?>{
        'content': <String, Object?>{
          'comment': <String, Object?>{'attachment_max_count': 9},
        },
    ...
    test('字符串化数值和布尔值不形成第二种 wire 形态', () {
        ...
        <String, Object?>{
          'content': <String, Object?>{
            'comment': <String, Object?>{
              'max_length': '320',
              'enabled': 'false',
              'attachment': <String, Object?>{'max_images': 3.0},
            },
          },
        },
      ...
      expect(config.maxImageAttachments, 1);
