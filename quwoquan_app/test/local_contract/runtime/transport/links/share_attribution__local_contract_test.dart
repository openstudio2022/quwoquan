...
void main() {
  group('ShareAttribution', () {
    ...
    test('applyTo 仅省略可选空字段', () {
      ...
      expect(
        uri.queryParameters.containsKey(ShareAttribution.keyUtmCampaign),
        isFalse,
      );
      expect(
        uri.queryParameters.containsKey(ShareAttribution.keyReferral),
        isFalse,
      );
    });
    ...
    test('applyTo 不修改 scheme 深链与空串', () {
      ...
      expect(
        a.applyTo('quwoquan://content/content/post/p1'),
