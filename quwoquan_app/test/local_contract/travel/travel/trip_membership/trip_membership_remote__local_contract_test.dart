...
import 'package:quwoquan_app/travel/travel/trip_membership/adapters/trip_membership_remote.dart';
import 'package:quwoquan_cloud_contracts/quwoquan_cloud_contracts.dart';

void main() {
  test('membership mutation uses typed travel path and retry key', () async {
    final executor = _MembershipExecutor();
    final facet = RemoteTripMembershipFacet(
...
final class _MembershipExecutor implements CloudOperationExecutor {
