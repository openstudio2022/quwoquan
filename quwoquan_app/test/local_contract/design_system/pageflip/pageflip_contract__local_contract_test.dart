...
// spec_ref: specs/feature-tree/discovery-content/dual-rail-discovery-redesign/works-immersive-viewer/spec.md#gwt-010.t1
// spec_ref: specs/feature-tree/discovery-content/dual-rail-discovery-redesign/works-immersive-viewer/spec.md#gwt-010.t2
...
import 'package:quwoquan_app/service/content_service/content/post/presentation/article_reader/pageflip/layers/backward_leaf_verso_uv_mesh.dart';
...
import 'package:quwoquan_app/design_system/pageflip/backward_render_frame_builder.dart';
...
import 'package:quwoquan_app/design_system/pageflip/curl_mesh_builder.dart';
  ...
  group('Pageflip', () {
    test('article reader product host keeps single-page pipeline contracts', () {
      ...
      final forwardPipelineSource = _readAppSource(
        'lib/service/content_service/content/post/presentation/article_reader/pageflip/pipelines/forward_article_flip_pipeline.dart',
      );
      final backwardPipelineSource = _readAppSource(
        'lib/service/content_service/content/post/presentation/article_reader/pageflip/pipelines/backward_article_flip_pipeline.dart',
      );
      final controllerSource = _readAppSource(
        'lib/design_system/pageflip/controller.dart',
      );
      final backwardBuilderSource = _readAppSource(
        'lib/design_system/pageflip/backward_render_frame_builder.dart',
      );
      final diagnosticSignaturesSource = _readAppSource(
        'lib/service/content_service/content/post/presentation/article_reader/pageflip/diagnostics/article_reader_diagnostic_signatures.dart',
      );
      final debugMapperSource = _readAppSource(
        'lib/service/content_service/content/post/presentation/article_reader/pageflip/diagnostics/article_reader_debug_mapper.dart',
      );
      final currentBarrelSource = _readAppSource(
        'lib/service/content_service/content/post/presentation/article_paged_canvas.dart',
      );

      expect(
        File(
          'lib/design_system/pageflip/backward_leaf_renderer.dart',
        ).existsSync(),
        isFalse,
        reason:
      ...
      expect(
        currentBarrelSource,
        contains(
          "export 'package:quwoquan_app/service/content_service/content/post/presentation/article_reader/pageflip/host/article_read_only_book_deck.dart'",
        ),
      );
    });
    ...
    test(
      ...
      () {
        ...
        final backwardDynamicSource = _readAppSource(
          'lib/service/content_service/content/post/presentation/article_reader/pageflip/host/article_read_only_book_deck_dynamic_layers.dart',
        );
        final backwardSoftLayerSource = _readAppSource(
          'lib/service/content_service/content/post/presentation/article_reader/pageflip/host/article_read_only_book_deck_soft_layers.dart',
        );
        final pageSurfacesSource = _readAppSource(
          'lib/service/content_service/content/post/presentation/article_reader/pageflip/host/article_read_only_book_deck_page_surfaces.dart',
        );
        ...
        final versoProbeSource = _readAppSource(
          'lib/service/content_service/content/post/presentation/article_reader/pageflip/layers/backward_leaf_verso_pixel_probe.dart',
        );
        expect(
          versoProbeSource,
        ...
        final uvMeshSource = _readAppSource(
          'lib/service/content_service/content/post/presentation/article_reader/pageflip/layers/backward_leaf_verso_uv_mesh.dart',
        );
        expect(
          uvMeshSource,
        ...
        final diagnosticsSource = _readAppSource(
          'test/support/runtime/pageflip/src/debug/pageflip_diagnostics.dart',
        );
        expect(
          diagnosticsSource,
          contains("label: 'tex'"),
        ...
        expect(
          _readAppSource(
            'lib/service/content_service/content/post/presentation/article_reader/pageflip/layers/article_reader_soft_page_geometry.dart',
          ),
