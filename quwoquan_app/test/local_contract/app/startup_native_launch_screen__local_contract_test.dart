...
void main() {
  group('startup native/Flutter handoff contract', () {
    ...
    test('三端从平台最早时钟计算 6 秒预算，只传时间不传动画状态', () {
      ...
      expect(android, contains('FLUTTER_FIRST_FRAME_DEADLINE_MS = 6000L'));
      expect(android, contains('FlutterUiDisplayListener'));
      expect(android, contains('addIsDisplayingFlutterUiListener'));
      expect(
        android,
        contains('NATIVE_TERMINAL_RECONCILIATION_WINDOW_MS = 120L'),
      );
      ...
      expect(
        android,
        contains('dismissNativeStartupRecoveryForSafeTerminalRace'),
      );
    ...
    test('Android 重插件由构建期注册表补丁剥离，原生商业 SDK 按需初始化', () {
      ...
      expect(policyVerifier, contains('Android Javac'));
