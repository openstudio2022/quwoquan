...
void main() {
  ...
  testWidgets('重启后按语义删除回执清理 Remote canonical entryId', (tester) async {
    ...
    expect(
      await recentSearches.listRecentSearches(ListRecentSearchesQuery()),
      isEmpty,
...
final class _DelayedRecentSearchFacet
  ...
  final Completer<RecentSearchEntryView> _upsertResult =
      Completer<RecentSearchEntryView>();
  final List<String> deletedEntryIds = <String>[];
  RecentSearchEntryView? _entry;

  void completeUpsert(RecentSearchEntryView entry) {
