...
class _FakeXiaoquSearchFacet implements AssistantSearchRunFacade {
  @override
...
class _ThrowingXiaoquSearchFacet implements AssistantSearchRunFacade {
  @override
  Future<AssistantRunTerminalSnapshotView> executeAssistantSearch({
    required String query,
    required String sessionClientRequestId,
...
void main() {
  ...
  testWidgets('失效内容留在搜索页并上报 typed degrade 反馈', (tester) async {
    final feedbackWriter = SearchFeedbackTypedDouble();
    await pumpSearchResultsPage(
      tester,
      _buildAppWithSearchRepository(
        launchContext: const SearchLaunchContext(
