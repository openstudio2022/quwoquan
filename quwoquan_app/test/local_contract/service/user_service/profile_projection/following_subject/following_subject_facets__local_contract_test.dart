  ...
  group('FollowingSubject object ports', () {
    ...
    test(
      ...
      () async {
        ...
        final query = UserProductionComposition.followingSubjectReader(
    ...
    test(
      ...
      () async {
        ...
        final visitWriter = UserProductionComposition.followedSubjectVisitStateWriter(
          client: GeneratedCloudOperationClient(executor),
          invocationContext: _invocationContext,
        );
        ...
        final first = await visitWriter.markFollowedSubjectVisited(
          command,
        );
        final replay = await visitWriter.markFollowedSubjectVisited(
          command,
        );
