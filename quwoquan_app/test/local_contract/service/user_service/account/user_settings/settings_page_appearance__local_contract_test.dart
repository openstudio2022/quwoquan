...
Widget _buildSettingsApp({
  ...
  AccountSessionLifecycleWriter? authRepository,
          ...
          GoRoute(
            ...
            routes: [
              GoRoute(
                ...
                builder: (context, state) => SettingsPermissionsPage(),
              ),
              GoRoute(
                path: AppRoutePaths.settingsDarkModeSegment,
                builder: (context, state) => SettingsDarkModePage(),
              ),
              GoRoute(
                path: AppRoutePaths.settingsNotificationsSegment,
                builder: (context, state) => SettingsNotificationsPage(),
              ),
              GoRoute(
                path: AppRoutePaths.settingsCallsSegment,
                builder: (context, state) => SettingsCallsPage(),
              ),
              GoRoute(
...
final class _SpyBehaviorRepository extends RecordingContentBehaviorRepository {
