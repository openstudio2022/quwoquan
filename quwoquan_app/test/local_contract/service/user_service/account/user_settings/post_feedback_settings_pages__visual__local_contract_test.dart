...
import '../../../../../support/service/content_service/trust_safety/report/report_query_typed_double.dart';
...
void main() {
  ...
  testWidgets('我的举报浅色 iOS 页面视觉基线', (tester) async {
    ...
    final query = InMemoryContentReportQueryAdapter(<MyReportItemSlice>[
      MyReportItemSlice(
        id: 'report-1',
  ...
  testWidgets('屏蔽关键词深色 iOS 页面视觉基线', (tester) async {
    await _setPhoneSurface(tester);
    final settings = InMemoryUserSettingsFacet(userId: 'visual-owner');
