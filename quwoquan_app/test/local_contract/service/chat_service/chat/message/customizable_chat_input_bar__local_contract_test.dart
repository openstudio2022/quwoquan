...
void main() {
  const inputBarFiles = <String>[
    'lib/runtime/di/presentation/customizable_chat_input_bar.dart',
    'lib/runtime/di/presentation/customizable_chat_input_bar_attachments.part.dart',
    'lib/runtime/di/presentation/customizable_chat_input_bar_composer.part.dart',
    'lib/runtime/di/presentation/customizable_chat_input_bar_layout.part.dart',
    'lib/runtime/di/presentation/customizable_chat_input_bar_voice.part.dart',
  ];
