...
import 'package:quwoquan_app/service/content_service/media/filter_catalog_release/presentation/image_editor_curve_panel.dart';
...
void main() {
  ...
  test('一级与专业工具只消费当前规范的有序定义', () {
    ...
    expect(
      ImageEditorCropStepPayload(ratio: 'original').label,
