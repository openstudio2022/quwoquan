...
class _Port implements PostCollectionPort {
  ...
  ) async => const wire.AuthorPostPageSlice(
    items: [
      wire.ContentListItemProjection(
        envelope: wire.ListItemPresentationEnvelope(
          objectKind: wire.ListObjectKind.post,
          contentType: wire.ContentType.image,
          openSurface: wire.ContentUiSurface.profileWorks,
          post: wire.ListItemPostRef(postId: 'new'),
        ),
        post: wire.ContentPostProjection(
          postId: 'new',
          contentType: wire.ContentType.image,
          title: '我的照片',
          mediaAssetId: 'asset',
