...
void main() {
  const componentFiles = <String, List<String>>{
    'article_editor': <String>[
      'lib/service/content_service/content/post/presentation/article_editor.dart',
      'lib/service/content_service/content/post/presentation/article_editor_content_builders.dart',
    ],
    'article_editor_accessories': <String>[
      'lib/service/content_service/content/post/presentation/article_editor_accessory_panels.dart',
      ...
      'lib/service/content_service/content/post/presentation/article_editor_accessory_controls.dart',
    ],
    'comment_input_overlay': <String>[
      'lib/service/content_service/content/comment/presentation/comment_input_overlay.dart',
      'lib/service/content_service/content/comment/presentation/comment_input_overlay_components.dart',
    ],
    'content_share_sheet': <String>[
      'lib/service/content_service/content/post/presentation/content_share_sheet.dart',
      'lib/service/content_service/content/post/presentation/content_share_sheet_components.dart',
    ],
  };
