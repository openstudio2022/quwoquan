...
void main() {
  ...
  test('ArticleDocumentData 不再从旧投影反向构造 nodes', () {
    final source = _readAppFile(
      'lib/service/content_service/content/post/application/public/article_document_models.dart',
    );
...
Map<String, String> _providerSources() {
  final directory = _appDirectory('lib/service/content_service/content/post/application');
  final files =
      directory
          .listSync()
          .whereType<File>()
