    ...
    final page = DiscoveryFeedResidentPage.fromEnvelope(
      ...
      page: DiscoveryFeedPage(
        ...
        objectCards: <ContentFeedObjectCard>[
          buildContentFeedObjectCard(homepageId: 'object_after_duplicate', title: 'Object after duplicate', anchorIndex: 3),
        ],
        nextCursor: 'cursor_2',
      ),
      ...
      var window = DiscoveryFeedResidentPageWindow.initial(
        DiscoveryFeedResidentPage.fromEnvelope(
          ...
          page: DiscoveryFeedPage(
            items: items,
            objectCards: <ContentFeedObjectCard>[
              buildContentFeedObjectCard(homepageId: 'object_before_last', title: 'Object before last', anchorIndex: 3),
              buildContentFeedObjectCard(homepageId: 'object_after_page', title: 'Object after page', anchorIndex: 4),
            ],
            nextCursor: 'cursor_1',
          ),
        ),
      ...
      var window = DiscoveryFeedResidentPageWindow.initial(
        DiscoveryFeedResidentPage.fromEnvelope(
          ...
          page: DiscoveryFeedPage(
            items: items,
            objectCards: <ContentFeedObjectCard>[
              buildContentFeedObjectCard(homepageId: 'object_before_removed', title: 'Object before removed', anchorIndex: 1),
              buildContentFeedObjectCard(homepageId: 'object_after_removed', title: 'Object after removed', anchorIndex: 3),
              buildContentFeedObjectCard(homepageId: 'object_after_page', title: 'Object after page', anchorIndex: 4),
            ],
            nextCursor: 'cursor_1',
          ),
...
DiscoveryFeedResidentPage _page(int pageIndex) {
  return DiscoveryFeedResidentPage.fromEnvelope(
    ...
    page: DiscoveryFeedPage(
      ...
      objectCards: <ContentFeedObjectCard>[
        buildContentFeedObjectCard(homepageId: 'object_$pageIndex', title: 'Object $pageIndex', anchorIndex: 1),
      ],
