...
// readiness_case: assistant_preference_set_assistant_preference_app_local
// readiness_case: assistant_preference_list_assistant_preferences_app_local
// readiness_case: assistant_preference_revoke_assistant_preference_app_local
// readiness_case: assistant_preference_restore_assistant_preference_app_local
import 'dart:convert';
import 'dart:io';
...
void main() {
  ...
  test('Remote 偏好 Facet 使用 metadata 路径并完成设置、列表、遗忘与恢复', () async {
    ...
    final repository = AssistantProductionComposition.preferenceFacet(
