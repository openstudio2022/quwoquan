...
/// Golden：`test/support/service/rtc_service/rtc/call_session/fixtures/list_calls_min_response.json` 与 rtc ListCalls 分页形状一致。
void main() {
  test('ListCalls golden JSON → CallSession', () {
    final path =
        '${Directory.current.path}/test/support/service/rtc_service/rtc/call_session/fixtures/list_calls_min_response.json';
    final raw =
