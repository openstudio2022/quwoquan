...
void main() {
  test('web pipeline templates and thresholds are wired', () {
    ...
    expect(
      metaPaths.contains(
        'assets/personal_assistant/prompts/web/domain.web_query_plan.meta.json',
      ),
      isTrue,
    );
    expect(
      metaPaths.contains(
        'assets/personal_assistant/prompts/web/domain.web_result_judge.meta.json',
      ),
      isTrue,
    );
    expect(
      metaPaths.contains(
        'assets/personal_assistant/prompts/web/domain.web_key_fact_extract.meta.json',
      ),
      isTrue,
    );
    expect(
      metaPaths.contains(
        'assets/personal_assistant/prompts/web/domain.web_evidence_pack.meta.json',
      ),
      isTrue,
    );

    final slotContract = File(
      'assets/personal_assistant/prompts/_standards/slot_fill_contract.json',
    );
