  ...
  group('runtime string governance', () {
    test('治理文档冻结 metadata 根路径与 generated-only 规则', () {
      final designDoc = _read(
        'personal_assistant/docs/PERSONAL_ASSISTANT_DESIGN_AND_CONSTRAINTS.md',
      );
      final ssotDoc = _read(
        'personal_assistant/docs/canonical_truth_sources.md',
      );
      final governance = _read(
        'lib/personal_assistant/engine/runtime_string_governance.dart',
      );
    ...
    test('narrative_engine 不再直接承载用户可见中文文案', () {
      final content = _read(
        'lib/personal_assistant/engine/default_processing/narrative_engine.dart',
      );
    ...
    test('tool_result_assessor 不再直接承载用户可见中文文案', () {
      final content = _read(
        'lib/personal_assistant/engine/tool_result_assessor.dart',
      );
    ...
    test('agent_loop 不再使用 realtimeTokens 关键词数组做实时判断', () {
      final content = _read('lib/personal_assistant/engine/agent_loop.dart');
    ...
    test('answer_composer 的兜底文案由 copy bank 提供', () {
      final content = _read(
        'lib/personal_assistant/engine/default_processing/answer_composer.dart',
      );
    ...
    test('skill executors 不再通过 skill.id 内建特判知识技能', () {
      final executor = _read(
        'lib/personal_assistant/skills/skill_executor.dart',
      );
      final simpleExecutor = _read(
        'lib/personal_assistant/skills/simple_skill_executor.dart',
      );
      final market = _read(
        'lib/personal_assistant/skills/market/skill_market_service.dart',
      );
    ...
    test('compatibility fallbacks 已从主链清理，不再保留旧注释入口', () {
      ...
      final agentLoop = _read('lib/personal_assistant/engine/agent_loop.dart');
