...
// readiness_case: filter_catalog_release_get_active_filter_catalog_app_api
...
void main() {
  test(
    ...
    () async {
      ...
      expect(telemetryEvents.single.succeeded, isTrue);
      expect(telemetryEvents.single.requestId, isNotEmpty);
      expect(telemetryEvents.single.traceId, isNotEmpty);
    },
  );
}
