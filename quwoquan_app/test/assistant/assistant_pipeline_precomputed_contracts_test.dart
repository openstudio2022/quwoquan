...
void main() {
  test('recoverPrecomputedBootstrap parses core fields', () {
    final bootstrap = recoverPrecomputedBootstrap(<String, dynamic>{
    ...
    expect(bootstrap.historySummary, ' 已有记录 ');
  ...
  test('recoverPrecomputedUnderstand parses mode decision', () {
    final understand = recoverPrecomputedUnderstand(<String, dynamic>{
