...
/// Gamma 示例：
///   patrol test --target \
///     test/user_acceptance/service/user_service/account/user_account/account_closure_remote__user_acceptance_test.dart \
///     -d `<device-id>` \
...
void main() {
  patrolTest(
    ...
    tags: ['user-acceptance', 'settings', 'account-closure', 'gamma-prod'],
