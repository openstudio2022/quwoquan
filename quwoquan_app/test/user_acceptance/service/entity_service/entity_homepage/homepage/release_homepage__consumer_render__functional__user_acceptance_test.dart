...
// readiness_case: homepage_release_consumer_render_app_uat
...
import 'package:quwoquan_app/runtime/di/app_providers_client_sync.dart'
    show homepageFacetSetProvider, homepageQueryActorContextProvider;
...
void main() {
  patrolTest(
    ...
    tags: ['user-acceptance', 'entity-homepage', 'release-consumer'],
