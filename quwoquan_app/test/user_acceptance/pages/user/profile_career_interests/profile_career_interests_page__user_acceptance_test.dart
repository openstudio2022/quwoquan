...
void main() {
  test('profileCareerInterests page coverage evidence is declared', () {
    const surfaceId = 'profileCareerInterests';
    const owner = 'user';
    const routeId = 'profileCareerInterests';
    const sourceEvidence = <String>[
    'quwoquan_app/test/local_contract/app/navigation/app_route_page_factory__local_contract_test.dart',
    ...
    'quwoquan_service/services/tag-service/tests/api_integration/tag_contract__api_integration_test.go',
  ];
    const requiredCaseIds = <String>[
    'user_acceptance.page.profileCareerInterests.load_success',
    'user_acceptance.page.profileCareerInterests.empty_permission_error',
    'user_acceptance.page.profileCareerInterests.primary_cta',
    'user_acceptance.page.profileCareerInterests.trace_context',
    'user_acceptance.page.profileCareerInterests.request_wait_recovery',
  ];
