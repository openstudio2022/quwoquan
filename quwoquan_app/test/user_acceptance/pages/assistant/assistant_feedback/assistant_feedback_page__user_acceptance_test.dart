...
void main() {
  test('assistantFeedback page coverage evidence is declared', () {
    const surfaceId = 'assistantFeedback';
    ...
    'quwoquan_app/test/local_contract/ui/assistant/assistant_turn_message_resolver_transcript_row__local_contract_test.dart',
  ];
    ...
    'user_acceptance.page.assistantFeedback.load_success',
    'user_acceptance.page.assistantFeedback.empty_permission_error',
    'user_acceptance.page.assistantFeedback.primary_cta',
    'user_acceptance.page.assistantFeedback.trace_context',
  ];
