...
void main() {
  test('locationPlaceLanding page coverage evidence is declared', () {
    const surfaceId = 'locationPlaceLanding';
    const owner = 'search';
    const routeId = 'locationPlaceLanding';
    const sourceEvidence = <String>[
      'quwoquan_app/test/local_contract/ui/search/pages/location_place_landing_page_widget__local_contract_test.dart',
      'quwoquan_app/test/user_acceptance/patrol/search/cross_domain_search_journey__user_acceptance_test.dart',
    ];
    ...
    const requiredCaseIds = <String>[
      'user_acceptance.page.locationPlaceLanding.load_success',
      'user_acceptance.page.locationPlaceLanding.empty_permission_error',
      'user_acceptance.page.locationPlaceLanding.primary_cta',
      'user_acceptance.page.locationPlaceLanding.trace_context',
      'user_acceptance.page.locationPlaceLanding.request_wait_recovery',
    ];
