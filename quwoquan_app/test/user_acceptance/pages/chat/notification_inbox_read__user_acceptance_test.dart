...
/// UA 旅程（interaction-notification-inbox GWT2 /
/// notification/notification/tests/e2e.yaml notification_center_reads_unread_count）：
  ...
  final List<AppMessage> _messages = <AppMessage>[
    AppMessage(
      ...
      target: const AppMessageTarget(
        targetType: 'post',
        targetId: 'post-ua-1',
        routePath: '/content/posts/post-ua-1',
      ),
      read: false,
...
void main() {
  ...
  testWidgets('user_acceptance.page.chatList.notification_inbox_read_journey', (
    ...
    final message = await facet.getAppMessage(
      const GetAppMessageQuery(messageId: 'ua-msg-1'),
    );
