...
void main() {
  test('chatAdmins page coverage evidence is declared', () {
    const surfaceId = 'chatAdmins';
    const owner = 'chat';
    const routeId = 'chatAdmins';
    const sourceEvidence = <String>[
      'quwoquan_app/test/local_contract/ui/chat/widgets/group_admins_page_widget__local_contract_test.dart',
    ...
    const requiredCaseIds = <String>[
      'user_acceptance.page.chatAdmins.load_success',
      'user_acceptance.page.chatAdmins.empty_permission_error',
      'user_acceptance.page.chatAdmins.primary_cta',
      'user_acceptance.page.chatAdmins.trace_context',
      'user_acceptance.page.chatAdmins.request_wait_recovery',
    ];
