...
void main() {
  test('myFootprint page coverage evidence is declared', () {
    const surfaceId = 'myFootprint';
    const owner = 'content';
    const routeId = 'myFootprint';
    const sourceEvidence = <String>[
    'quwoquan_app/test/local_contract/ui/user/pages/my_footprint_page__local_contract_test.dart',
    ...
    'quwoquan_service/services/user-service/tests/api_integration/homepage_bundle_contract__api_integration_test.go',
  ];
    const requiredCaseIds = <String>[
    'user_acceptance.page.myFootprint.load_success',
    'user_acceptance.page.myFootprint.empty_permission_error',
    'user_acceptance.page.myFootprint.primary_cta',
    'user_acceptance.page.myFootprint.trace_context',
    'user_acceptance.page.myFootprint.request_wait_recovery',
  ];
