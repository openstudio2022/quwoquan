...
void main() {
  test('homepageIntroduction page coverage evidence is declared', () {
    const surfaceId = 'homepageIntroduction';
    const owner = 'entity';
    const routeId = 'homepageIntroduction';
    const sourceEvidence = <String>[
      'quwoquan_app/test/local_contract/ui/entity/pages/homepage_introduction_page_widget__local_contract_test.dart',
    ...
    const requiredCaseIds = <String>[
      'user_acceptance.page.homepageIntroduction.load_success',
