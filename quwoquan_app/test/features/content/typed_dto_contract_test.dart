...
void main() {
  ...
  group('PhotoPostDto', () {
    ...
    test('aspectRatio is null when width/height missing', () {
      const raw = <String, dynamic>{
        'postId': 'p3',
        'contentType': 'image',
        'authorId': 'a',
    ...
    test('alias resolution: imageWidth/imageHeight alternate field names', () {
      const raw = <String, dynamic>{
        'postId': 'p4',
        'contentType': 'image',
        'authorId': 'a',
    ...
    test('toMap round-trip preserves width/height', () {
      const raw = <String, dynamic>{
        'postId': 'p5',
        'contentType': 'image',
        'authorId': 'a',
  ...
  group('VideoPostDto', () {
    ...
    test('alias resolution: videoWidth/videoHeight alternate field names', () {
      const raw = <String, dynamic>{
        'postId': 'v3',
        'contentType': 'video',
        'authorId': 'a',
  ...
  group('MomentPostDto', () {
    test('fromMap parses text-only moment', () {
      ...
      // MomentPostDto 保留原始 contentType，'micro' 不在 DTO 层标准化
      // 标准化由调用方（postBaseDtoFromMap dispatch 或 UI layer）负责
  ...
  // ──────────────────────────────────────────────────────────────────
  // PostBaseDto 多态 & postBaseDtoFromMap 分发
  // ──────────────────────────────────────────────────────────────────
  group('PostBaseDto polymorphism & postBaseDtoFromMap dispatch', () {
    ...
    test('dispatches photo contentType to PhotoPostDto', () {
