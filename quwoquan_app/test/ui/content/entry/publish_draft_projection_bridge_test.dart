...
void main() {
  group('publish_draft_projection_bridge', () {
    test('createEditorStateToArticlePreviewWire carries articleDocument + template keys', () {
      ...
      expect(wire['articleDocument'], isA<Map>());
      expect(wire['articleTemplate'], isNotNull);
      expect(wire['articleFontPreset'], isNotNull);
    });

    test('projectArticleDetailViewFromCreateEditorState returns view for initial draft', () {
      final state = CreateEditorState.initial();
    ...
    test('postReadPreviewBundleFromCreateEditorState uses draftPreview surface', () {
    ...
    test('postReadPreviewBundleFromPublishConfirmSummary work article branch', () {
    ...
    test('buildCreatePostPayloadMap article branch includes articleDocument', () {
      ...
      expect(payload['articleDocument'], isA<Map>());
    });
  });
}
