  ...
  testWidgets('点击分享动作会委托给 handler 并触发完成回调', (tester) async {
    ...
    final template = ContentShareTemplateBuilder.build(
      post: MomentPostDto(
        ...
        authorProfileSubjectId: 'user_action',
        displayName: '小悠',
        avatarUrl: '',
  ...
  testWidgets('默认复制链接动作会写入剪贴板', (tester) async {
    ...
    final template = ContentShareTemplateBuilder.build(
      post: MomentPostDto(
        ...
        authorProfileSubjectId: 'user_clipboard',
        displayName: '阿遥',
        avatarUrl: '',
        body: '复制链接测试',
        imageUrls: const <String>[],
