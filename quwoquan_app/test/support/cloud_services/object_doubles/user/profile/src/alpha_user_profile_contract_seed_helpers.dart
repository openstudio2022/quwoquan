...
List<Map<String, dynamic>> _contractProfileRows() {
  final seed = objectScenarioSeedReader.userSeedSet('user_profile_core');
...
List<Map<String, dynamic>> _contractRelationshipRows() {
  final seed = objectScenarioSeedReader.userSeedSet('relationship_core');
...
List<Map<String, dynamic>> _contractPersonaRows() {
  final seed = objectScenarioSeedReader.userSeedSet('persona_core');
