...
final class CircleFileTypedDouble
    implements CircleFileWriter, CircleFileReader {
  ...
  Future<CircleFileCommandResult> create(
    ...
    final fileId = 'circle_file_fixture_${++_sequence}';
  ...
  CircleFileSlice _required(String key, [int? expectedVersion]) {
    ...
    if (file == null) throw StateError('CircleFile fixture not found');
    if (expectedVersion != null && file.version != expectedVersion) {
      throw StateError('CircleFile fixture version conflict');
    }
    return file;
  }
