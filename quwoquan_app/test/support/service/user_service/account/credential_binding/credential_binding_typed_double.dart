...
final class InMemoryUserSettingsFacet
    implements UserSettingsCommandWriter, UserSettingsQueryReader {
  InMemoryUserSettingsFacet({
...
final class InMemoryCredentialBindingWriter
    implements CredentialBindingWriter, CredentialBindingReader {
  final Map<CredentialType, _InMemoryCredentialBindingState> _bindings =
      <CredentialType, _InMemoryCredentialBindingState>{};
  ...
  Future<CredentialBindingCommandResult> _bind(
    ...
    final binding = _InMemoryCredentialBindingState(
...
final class _InMemoryCredentialBindingState {
  const _InMemoryCredentialBindingState({
    required this.id,
...
final class InMemoryProfileCommandWriter implements ProfileCommandWriter {
  int _version = 1;
