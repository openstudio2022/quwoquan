...
/// Short-lived, runtime-only identity for an API contract run.
///
...
class ApiContractAnonymousSession {
  const ApiContractAnonymousSession({
  ...
  static Future<ApiContractAnonymousSession> login({
    ...
    return ApiContractAnonymousSession(
