...
///     return FooReceipt(accepted: true);
///   }
/// }
///
...
///   ProviderScope(overrides: _boundaryOverrides(), child: FooPage()),
/// );
/// ```
///
...
final class SealedCloudBoundaryError extends Error {
  ...
  String toString() =>
      ...
      '写法见 quwoquan_app/test/support/runtime/cloud_boundary_test_scope.dart '
