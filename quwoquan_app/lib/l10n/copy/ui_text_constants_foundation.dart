...
abstract final class FoundationText {
  ...
  static const String loginMethodPhone = '其他手机号登录';
  static const String loginPhoneTitle = '手机号登录';
  static const String loginPhoneSubtitle = '输入手机号获取验证码';
  static const String loginPhoneNumberPlaceholder = '请输入手机号';
  static const String loginOtpPlaceholder = '请输入验证码';
  static const String loginOtpTitle = '输入验证码';
  static const String loginSendOtp = '获取验证码';
  static const String loginSendOtpSubmitting = '正在发送验证码…';
  ...
  static const String loginOtpNotReceived = '未收到验证码？';
  static const String loginOtpResendCountdown = '%d 秒后可重新获取';
  static const String loginOtpMismatch = '验证码不正确，请重新输入';
  static const String loginOtpExpired = '验证码已过期，请重新获取';
  static const String loginOtpConsumed = '验证码已失效，请重新获取';
  static const String loginOtpAttemptsExceeded = '尝试次数过多，请重新获取验证码';
  static const String loginOtpRateLimited = '验证码获取太频繁，请稍后再试';
  static const String loginOtpSendFailed = '验证码发送失败，请重试';
  static const String loginOtpVerifying = '正在验证…';
  static const String loginOtpVerifyUnavailable = '网络连接失败，请重试';
  static const String loginOtpVerifyTimeout = '网络连接超时，请重试';
  static const String loginOtpVerifyRetry = '重新验证';
  static const String loginOtpRequestRetry = '重新获取';
  static const String loginNetworkUnavailable = '网络连接失败，请重试';
  static const String loginRequestTimeout = '网络连接超时，请重试';
  static const String loginOtpServiceUnavailable = '登录服务暂时不可用，请稍后重试';
  ...
  static const String syntheticLoginTitle = '独立本地演练';
  static const String syntheticLoginExplanation = '使用随机合成标识，不关联手机号，不创建真实账号。';
  static const String syntheticLoginIdentity = '合成标识';
  static const String syntheticLoginBegin = '开始本地确认';
  static const String syntheticLoginConfirmation = '输入演练确认文字';
  static const String syntheticLoginConfirm = '确认本地登录';
  static const String syntheticLoginRetry = '重试本次确认';
  static const String syntheticLoginInvalid = '请输入有效的合成标识或演练确认文字。';
  static const String syntheticLoginMismatch = '演练确认不匹配，请重新输入。';
  static const String syntheticLoginUnavailable = '本次演练已不可继续，请返回后重新进入。';
  static const String syntheticLoginStorageFailed = '本地保存未完成，可重试本次确认。';
  static const String loginRehearsalOtpHint = '本地演练验证码固定为 000000，不会发送真实短信。';
  static const String loginOtpDeliveryFailedCountdown = '验证码发送失败，请在 %d 秒后重新获取';
  static const String loginOtpRateLimitedCountdown = '验证码获取太频繁，请在 %d 秒后再试';
  ...
  static const String loginSocialAuthorizingWechat = '正在前往微信';
  static const String loginSocialAuthorizingQq = '正在前往QQ';
  ...
  static const String loginBindPhoneSubtitle = '验证手机号后即可完成登录';
  static const String loginPhoneCredentialConflict = '这个手机号已绑定其他账号';
  ...
  static const String loginAccountSuspensionTitle = '账号暂时无法登录';
  static const String loginAccountSuspensionSubtitle =
      '你仍可浏览公开内容；如需了解处理方式，请前往官方支持。';
  static const String loginAccountSuspensionSupport = '联系官方支持';
  static const String loginAccountSuspensionSupportUnavailable =
      '暂时无法打开官方支持，请稍后重试';
  static const String loginAccountSuspensionUseOtherAccount = '使用其他账号';
  ...
  static const String loginConsentSheetTitle = '请先阅读并同意相关协议';
  static const String loginConsentSheetSubtitle = '同意后即可继续登录';
  static const String loginConsentSheetConfirm = '同意并继续';
  static const String loginConsentSheetCancel = '暂不';
  ...
  static const String loginWechatUnavailable = '当前设备暂不支持微信登录';
  static const String loginQqUnavailable = '当前设备暂不支持QQ登录';
  static const String loginAlipayUnavailable = '当前设备暂不支持支付宝登录';
  static const String loginWechatCurrent = '当前正在使用微信登录';
  static const String loginQqCurrent = '当前正在使用QQ登录';
  static const String loginAlipayCurrent = '当前正在使用支付宝登录';
  ...
  static const String startupRecoveryUpdateAvailableTitle = '发现新版本';
  static const String startupRecoveryUpdateAvailableMessage =
      '可前往官方渠道更新，或继续使用当前版本';
