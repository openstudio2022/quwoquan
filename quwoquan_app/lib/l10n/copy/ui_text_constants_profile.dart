...
abstract final class ProfileText {
  ...
  static const String profileCirclesEmptyMineTitle = '还没加入圈子';
  static const String profileCirclesEmptyOtherTitle = 'Ta 还没加入圈子';
  ...
  static const String profilePersonaManagement = 'Persona管理';
  static const String profilePersonaDeleteTitle = '删除Persona';
  static const String profilePersonaDeleteConfirmTemplate =
      '确定要删除「%s」吗？此操作不可撤销。';
  static const String contentDeleteSuccess = '内容已删除';
  static const String profilePersonaCreateTitle = '创建Persona';
  static const String profilePersonaNamePlaceholder = '账号名称（如：职业号、匿名号）';
  static const String profilePersonaOpen = '公开';
  static const String profilePersonaSemi = '半隐';
  static const String profilePersonaStrict = '严格隔离';
  static const String profilePersonaSwitchFailed = '切换失败';
  static const String profilePersonaDeleteFailed = '删除失败';
  static const String profilePersonaCreateFailed = '创建失败';
  static const String profilePersonaMaxReachedTemplate = '最多创建 %s 个Persona';
  static const String profilePersonaEmpty = '暂无Persona';
  static const String profilePersonaStrictDescription = '严格隔离 · 不出现在通讯录发现';
  static const String profilePersonaSemiDescription = '半隐私 · 仅联系人可发现';
  static const String profilePersonaOpenDescription = '公开 · 可被通讯录发现';
}
