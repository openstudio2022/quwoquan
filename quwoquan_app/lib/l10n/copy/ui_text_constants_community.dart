...
abstract final class CommunityText {
  ...
  static const String circleGroupMembershipTitle = '默认讨论群';
  static const String circleGroupMembershipNotJoined = '尚未加入这个讨论群';
  static const String circleGroupMembershipInviteOnly = '这个讨论群仅接受邀请加入';
  static const String circleGroupMembershipPending = '加入申请正在等待审核';
  static const String circleGroupMembershipActive = '已加入这个讨论群';
  static const String circleGroupMembershipOwner = '你是这个讨论群的群主';
  static const String circleGroupMembershipRejected = '上次申请未通过，可以重新申请';
  static const String circleGroupMembershipLeft = '已退出这个讨论群，可以重新申请';
  static const String circleGroupMembershipRemoved = '已被移出这个讨论群，可以重新申请';
  static const String circleGroupMembershipApply = '申请加入讨论群';
  static const String circleGroupMembershipLeave = '退出讨论群';
