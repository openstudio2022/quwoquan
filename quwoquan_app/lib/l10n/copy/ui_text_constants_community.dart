...
abstract final class CommunityText {
  ...
  static const String authGatePromptStartGathering = '登录后即可发起活动';
  static const String authContinuationStartGathering = '登录后将继续发起活动';
  static const String gatheringCreateUnavailableTitle = '活动创建暂不可用';
  static const String gatheringCreateUnavailableMessage =
  ...
  static const String circleGroupMembershipNotJoined = '尚未加入这个群聊';
  static const String circleGroupMembershipInviteOnly = '这个群聊仅接受邀请加入';
  static const String circleGroupMembershipPending = '加入申请正在等待审核';
  static const String circleGroupMembershipActive = '已加入这个群聊';
  static const String circleGroupMembershipOwner = '你是这个群聊的群主';
  static const String circleGroupMembershipRejected = '上次申请未通过，可以重新申请';
  static const String circleGroupMembershipLeft = '已退出这个群聊，可以重新申请';
  static const String circleGroupMembershipRemoved = '已被移出这个群聊，可以重新申请';
  static const String circleGroupMembershipApply = '申请加入群聊';
  static const String circleGroupMembershipLeave = '退出群聊';
  static const String circleCategoryCampus = '校园';
  static const String circleCategoryTravel = '旅行';
  static const String circleCategoryPhotography = '摄影';
  static const String circleCategoryTechnology = '科技';
  static const String circleCategoryCar = '车之家';
  static const String circleCreateIncomplete = '创建圈子未完成';
  static const String circleSaveIncomplete = '保存圈子未完成';
  static const String circleAll = '全部';
  static const String circleGridViewTooltip = '网格视图';
  static const String circleListViewTooltip = '列表视图';
  ...
  static String circleArticleRecommendation(String labels) => '讨论推荐 · $labels';
  ...
  static String circleProfileStats({
    required String worksCount,
    required String fansCount,
    required String likesCount,
  }) => '$worksCount 作品 · $fansCount 粉丝 · $likesCount 获赞';

  static String circleMemberCount(String count) => '$count 人';

  static String circleLikeCount(int count) => '赞 $count';

  static String circleMemberContribution({
    required String worksCount,
    required String likesCount,
  }) => '$worksCount 创作 · $likesCount 获赞';
}
