...
class AssistantMemoryRepository {
  ...
  Future<List<double>> embedText(String input) async {
    ...
    // Try real LLM embedding if API is configured
    ...
    // TF-IDF inspired fallback: 64-dim term-frequency vector over char n-grams
  ...
  /// Synchronous fallback for callers that cannot await (legacy compatibility).
