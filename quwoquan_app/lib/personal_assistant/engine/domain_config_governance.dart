...
class DomainConfigGovernance {
  ...
  bool verifyEnvelopeSignature(Map<String, dynamic> envelope) {
    ...
    final expected = Hmac(sha256, utf8.encode(signSecret)).convert(
      utf8.encode('$keyId|$payload'),
    );
