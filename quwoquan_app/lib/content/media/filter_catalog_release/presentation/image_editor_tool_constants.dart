...
const List<ImageEditorToolEntry> kImageEditorToolEntries =
    <ImageEditorToolEntry>[
      ImageEditorToolEntry(
        ...
        label: MediaText.imageEditorFilter,
      ...
      ImageEditorToolEntry(
        ...
        type: 'crop',
        icon: Icons.crop,
        label: MediaText.imageEditorCrop,
      ),
      ImageEditorToolEntry(
        index: kImageEditorToolRotate,
        type: 'rotate',
        icon: Icons.rotate_right,
        label: MediaText.imageEditorRotate,
      ),
      ImageEditorToolEntry(
        index: kImageEditorToolPro,
        type: 'proTools',
        icon: Icons.auto_fix_high,
        label: MediaText.imageEditorProTools,
      ),
      ImageEditorToolEntry(
        index: kImageEditorToolText,
        type: 'text',
        icon: Icons.text_fields,
        label: MediaText.imageEditorText,
      ),
      ImageEditorToolEntry(
        index: kImageEditorToolMosaic,
        type: 'mosaic',
        icon: Icons.grid_on,
        label: MediaText.imageEditorMosaic,
      ),
    ];
