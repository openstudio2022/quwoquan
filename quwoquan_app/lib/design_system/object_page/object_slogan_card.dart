...
class ObjectSloganCard extends StatefulWidget {
  const ObjectSloganCard({
    ...
    this.cardKey = const ValueKey<String>('object-slogan-card'),
         ...
         !showEmptyPrompt || emptyPrompt != null,
         'ObjectSloganCard requires emptyPrompt when showEmptyPrompt is true.',
       );

  final bool isDark;
  final String? bio;

  /// 空简介时的占位提示文案；由业务 presentation 提供，不由设计系统猜测。
...
class _ObjectSloganCardState extends State<ObjectSloganCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final text = isPrompt ? widget.emptyPrompt! : rawText;
                  ...
                  child: GestureDetector(
                    ...
                    child: DecoratedBox(
                      ...
                      child: Padding(
                        ...
                        child: Text(
                          ObjectHomepageText.objectSloganExpandAll,
