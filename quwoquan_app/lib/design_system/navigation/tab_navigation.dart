...
class TabNavigationWidget extends ConsumerWidget {
  ...
  static const List<TabItem> discoveryTabs = [
    TabItem(id: 'recommended', label: DiscoveryText.homeTabRecommended),
    TabItem(id: 'images', label: DiscoveryText.discoveryWorksFilterImage),
    TabItem(id: 'video', label: DiscoveryText.discoveryTabVideo),
    TabItem(id: 'articles', label: DiscoveryText.workFormatFilterArticle),
  ];

  static const List<TabItem> defaultTabs = [
    TabItem(id: 'following', label: FoundationText.follow),
    TabItem(id: 'recommended', label: DiscoveryText.homeTabRecommended),
    TabItem(id: 'images', label: DiscoveryText.discoveryWorksFilterImage),
    TabItem(id: 'video', label: DiscoveryText.discoveryTabVideo),
    TabItem(id: 'articles', label: DiscoveryText.workFormatFilterArticle),
    TabItem(id: 'moments', label: DiscoveryText.discoveryTabActivity),
  ];

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final currentIsDark = (isDark ?? ref.watch(isDarkProvider))!;
