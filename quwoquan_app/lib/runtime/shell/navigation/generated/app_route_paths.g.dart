...
class AppRoutePaths {
  ...
  static const String gatheringCreate = '/gatherings/create';
  static const String gatheringCreateSegment = 'create';

  static const String gatheringDetailPathTemplate = '/gatherings/{id}';
  static String gatheringDetail({required String id}) {
    return _buildPath(gatheringDetailPathTemplate, <String, String>{
      'id': id,
    }, <String, String?>{
    });
  }
  static const String gatheringDetailSegment = '{id}';

  static const String gatheringBoardPathTemplate = '/chat/{id}/board';
  static String gatheringBoard({required String id}) {
    return _buildPath(gatheringBoardPathTemplate, <String, String>{
      'id': id,
    }, <String, String?>{
    });
  }
  static const String gatheringBoardSegment = 'board';
