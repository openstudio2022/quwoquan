...
abstract final class RuntimeLogCatalog {
  ...
  static const List<RuntimeLogFieldPrivacyPolicy> fieldPrivacyPolicies = <RuntimeLogFieldPrivacyPolicy>[
    ...
    RuntimeLogFieldPrivacyPolicy(objectId: 'user.authentication_challenge', field: 'accountId', classification: '', action: 'drop', maskStrategy: '', truncateChars: 0, explicit: false, visibility: <String>[]),
    RuntimeLogFieldPrivacyPolicy(objectId: 'user.authentication_challenge', field: 'attemptCount', classification: '', action: 'drop', maskStrategy: '', truncateChars: 0, explicit: false, visibility: <String>[]),
    RuntimeLogFieldPrivacyPolicy(objectId: 'user.authentication_challenge', field: 'channel', classification: '', action: 'drop', maskStrategy: '', truncateChars: 0, explicit: false, visibility: <String>[]),
    RuntimeLogFieldPrivacyPolicy(objectId: 'user.authentication_challenge', field: 'completedAt', classification: '', action: 'drop', maskStrategy: '', truncateChars: 0, explicit: false, visibility: <String>[]),
    RuntimeLogFieldPrivacyPolicy(objectId: 'user.authentication_challenge', field: 'createdAt', classification: '', action: 'drop', maskStrategy: '', truncateChars: 0, explicit: false, visibility: <String>[]),
    RuntimeLogFieldPrivacyPolicy(objectId: 'user.authentication_challenge', field: 'deliveryRequestId', classification: '', action: 'drop', maskStrategy: '', truncateChars: 0, explicit: false, visibility: <String>[]),
    RuntimeLogFieldPrivacyPolicy(objectId: 'user.authentication_challenge', field: 'deliveryStatus', classification: '', action: 'drop', maskStrategy: '', truncateChars: 0, explicit: false, visibility: <String>[]),
    RuntimeLogFieldPrivacyPolicy(objectId: 'user.authentication_challenge', field: 'deliveryUpdatedAt', classification: '', action: 'drop', maskStrategy: '', truncateChars: 0, explicit: false, visibility: <String>[]),
    RuntimeLogFieldPrivacyPolicy(objectId: 'user.authentication_challenge', field: 'destinationHash', classification: 'SENSITIVE', action: 'drop', maskStrategy: '', truncateChars: 0, explicit: true, visibility: <String>[]),
    RuntimeLogFieldPrivacyPolicy(objectId: 'user.authentication_challenge', field: 'expiresAt', classification: '', action: 'drop', maskStrategy: '', truncateChars: 0, explicit: false, visibility: <String>[]),
    RuntimeLogFieldPrivacyPolicy(objectId: 'user.authentication_challenge', field: 'id', classification: '', action: 'drop', maskStrategy: '', truncateChars: 0, explicit: false, visibility: <String>[]),
    RuntimeLogFieldPrivacyPolicy(objectId: 'user.authentication_challenge', field: 'lastDeliveryEventId', classification: '', action: 'drop', maskStrategy: '', truncateChars: 0, explicit: false, visibility: <String>[]),
    RuntimeLogFieldPrivacyPolicy(objectId: 'user.authentication_challenge', field: 'purpose', classification: '', action: 'drop', maskStrategy: '', truncateChars: 0, explicit: false, visibility: <String>[]),
    RuntimeLogFieldPrivacyPolicy(objectId: 'user.authentication_challenge', field: 'secretRef', classification: 'SECRET', action: 'drop', maskStrategy: '', truncateChars: 0, explicit: true, visibility: <String>[]),
    RuntimeLogFieldPrivacyPolicy(objectId: 'user.authentication_challenge', field: 'status', classification: '', action: 'drop', maskStrategy: '', truncateChars: 0, explicit: false, visibility: <String>[]),
