...
enum AssistantErrorCode {
  ...
  deviceActionUnavailable('ASSISTANT.SYSTEM.device_action_unavailable', '当前设备暂不支持此操作，请手动完成', 503),
  deviceActionPermissionDenied('ASSISTANT.USER.device_action_permission_denied', '请在系统设置中允许此设备操作后重试', 403),
  deviceActionFailed('ASSISTANT.SYSTEM.device_action_failed', '设备操作未完成，请重试', 500),
