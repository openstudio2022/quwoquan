...
import 'package:quwoquan_app/runtime/shell/navigation/app_page_access_navigator_observer.dart';
        ...
        pageBuilder: (context, state) {
          ...
          return appRoutePage<void>(
            ...
            child: LocationPlaceLandingPage(
              ...
              locationPlaceReadQuery: ref.read(locationPlaceReadQueryProvider),
        ...
        pageBuilder: (context, state) {
          ...
          return appRoutePage<void>(
            ...
            child: HomepageIntroductionPage(
              ...
              journeyTracker: ref.read(journeyEventTrackerProvider),
      ...
      GoRoute(
        ...
        pageBuilder: (context, state) {
          ...
          return appRoutePage<void>(
            ...
            kind: AppRoutePageKind.fullscreenDialog,
            fullscreenDialog: true,
            child: HomepageStatusReportPage(
              homepageId: id,
              writeTargetReader: ref.read(homepageWriteTargetReaderProvider),
      ...
      GoRoute(
        ...
        pageBuilder: (context, state) {
          ...
          final circleExtra = state.extra is CircleDetailPageRouteExtra
              ...
              : null;
          final hasAuthenticatedOwner = ref
              .read(resolvedOwnerUserIdProvider)
              .trim()
              .isNotEmpty;
          return appRoutePage<void>(
            state: state,
            child: CircleDetailPage(
              circleId: id,
              visitRecorderService: ref.read(visitRecorderServiceProvider),
              contentEngagementTracker: ref.read(
                contentEngagementTrackerProvider,
              ),
              hasAuthenticatedOwner: hasAuthenticatedOwner,
              behaviorFactAppender: hasAuthenticatedOwner
                  ? ref.read(circleDetailBehaviorFactWriterProvider)
                  : null,
              ...
              sourceAppearanceMode: circleExtra == null
                  ? uiErrorAppearanceModeFromRouteValue(
                      state.uri.queryParameters['sourceTheme'],
                    )
                  : uiErrorAppearanceModeFromCircleRoute(
        ...
        routes: [
          GoRoute(
            ...
            pageBuilder: (context, state) {
              ...
              return appRoutePage<void>(
                state: state,
                child: CircleStatsPage(
                  circleId: id,
                  type: type,
                  recordVisit: (circleId) => visitRecorder.recordVisit(
                    VisitTarget.entity(
                      kind: VisitEntityKind.circle,
                      id: circleId,
                    ),
                  ),
                  groupQueries: ref.read(circleStatsGroupQueryProvider),
                  membershipQueries: ref.read(
                    circleStatsMembershipQueryProvider,
                  ),
                ),
              );
      ...
      GoRoute(
        ...
        pageBuilder: (context, state) => appRoutePage<void>(
          ...
          child: ObjectIntersectionListPage(
            ...
            contentBehaviorTracker: ref.read(contentBehaviorTrackerProvider),
