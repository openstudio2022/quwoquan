...
/// Runtime-owned telemetry value emitted by the cross-object article reader.
...
/// Runtime-owned telemetry value emitted when a page curl is cancelled.
...
final class WorksViewerArticleComposition extends StatelessWidget {
  const WorksViewerArticleComposition({
    super.key,
    required this.post,
