...
abstract final class FoundationText {
  ...
  static const String loginOtpResendCountdown = '%d秒后可重新获取';
  static const String loginOtpMismatch = '验证码不正确';
  static const String loginOtpExpired = '验证码已失效';
  static const String loginOtpRateLimited = '尝试次数较多';
  static const String loginOtpSendFailed = '验证码发送失败';
  static const String loginOtpVerifying = '正在验证';
  static const String loginOtpVerifyUnavailable = '暂时无法验证验证码';
