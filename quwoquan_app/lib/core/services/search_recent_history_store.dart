...
final class SearchRecentHistoryStore {
  ...
  Future<SearchRecentHistoryCacheSnapshot> load() async {
    ...
    return SearchRecentHistoryCacheSnapshot(
      entries: rawEntries
  ...
  Future<void> save(SearchRecentHistoryCacheSnapshot snapshot) async {
    final preferences = await SharedPreferences.getInstance();
...
final class SearchRecentHistoryCacheSnapshot {
