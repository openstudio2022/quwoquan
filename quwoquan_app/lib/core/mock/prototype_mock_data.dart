...
class PrototypeMockData {
    ...
    return [
      {
        ...
        'quotedPost': {
          'user': '央视新闻',
          'content': '#浙FFJ3808救完人默默离开#【#男子急刹飞奔一把拉回轻生女子#】近日，浙江海盐，一女子欲跳桥轻生。',
          'media': [
            {
              'type': 'video',
              'url':
  ...
  /// 记录文章 mock（TSX 形状）；应用内文章详情 mock 请用 [ContentMockData.articleWireByPostId]。
  ...
  static Map<String, dynamic> get helperReadSummary {
    return {
      'oneLiner': '自上次阅读以来，3 位趣友发布了新作，2 个圈子有 5 条新动态，你的趣友在互动 2 个新圈子。',
      'dimensions': [
        {
  ...
  static final Map<String, List<Map<String, dynamic>>> _chatMessagesMap = {
    'conv_private_zhao': [
      {
        'id': 'msg_zhao_1',
        'conversationId': 'conv_private_zhao',
        'type': 'text',
        'content': '你好，周末有空吗？',
        'senderId': 'user_a',
        'senderName': '用户A',
    ...
    'conv_private_wang': [
      {
        'id': 'msg_wang_1',
        'conversationId': 'conv_private_wang',
        'type': 'text',
        'content': '你上次分享的那个摄影技巧太有用了！',
        'senderId': 'user_b',
        'senderName': '用户B',
        'senderAvatar':
            'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=400',
    ...
    'conv_private_li': [
      {
        'id': 'msg_li_1',
        'conversationId': 'conv_private_li',
        'type': 'text',
        'content': '嗨，在吗？',
        'senderId': 'user_c',
        'senderName': '用户C',
    ...
    'conv_encrypted_1': [
      {
        'id': 'enc1_1',
        'conversationId': 'conv_encrypted_1',
        'type': 'text',
        'content': '这是加密会话内容，仅验证身份后可查看。',
        'senderId': 'enc_user_1',
        'senderName': '私密项目组',
        'senderAvatar':
            'https://images.unsplash.com/photo-1614028674026-a65e31bfd27c?w=400',
    ...
    'conv_encrypted_2': [
      {
        'id': 'enc2_1',
        'conversationId': 'conv_encrypted_2',
        'type': 'text',
        'content': '文件已发送，请注意查收。',
        'senderId': 'enc_user_2',
        'senderName': '神秘人',
