...
abstract final class RuntimeLogCatalog {
  ...
  static const Map<String, RuntimeLogSignalMetadata> signalRegistry = <String, RuntimeLogSignalMetadata>{
    ...
    'app.performance.anr': RuntimeLogSignalMetadata(owner: 'runtime-client-foundation', producers: <String>['dart'], logKind: 'event', defaultSeverity: 'ERROR', environments: <String>['alpha', 'beta', 'gamma', 'prod'], attributeAllowlist: <String>['source', 'stallMs', 'anrThresholdMs', 'sampledFrames', 'jankyFrames', 'worstFrameMs'], correlationKeys: <String>['requestId', 'traceId', 'spanId', 'operationId', 'pageName', 'surfaceId', 'executionId', 'workPackageId', 'environmentRunId', 'actorHash'], backend: 'runtime-sls', retentionDays: 3, sampling: 'warn_error', alert: 'runtime_signal_rate', runbook: 'runtime-diagnostics', piiClassification: 'redacted'),
    'app.performance.frame': RuntimeLogSignalMetadata(owner: 'runtime-client-foundation', producers: <String>['dart'], logKind: 'event', defaultSeverity: 'WARN', environments: <String>['alpha', 'beta', 'gamma', 'prod'], attributeAllowlist: <String>['source', 'exceptionType', 'stackFrameCount', 'sampledFrames', 'jankyFrames', 'worstFrameMs', 'jankThresholdMs', 'ttffMs', 'targetPositionMs', 'settledPositionMs', 'settleMs', 'droppedFrames', 'processedFrames', 'rendererMode', 'decoderQueueMode', 'decoderFallbackEnabled', 'module', 'kind', 'reason', 'failurePoint', 'inputKv', 'outputKv', 'stage', 'outcome', 'gate', 'artifactCount'], correlationKeys: <String>['requestId', 'traceId', 'spanId', 'operationId', 'pageName', 'surfaceId', 'executionId', 'workPackageId', 'environmentRunId', 'actorHash'], backend: 'runtime-sls', retentionDays: 3, sampling: 'warn_error', alert: 'runtime_signal_rate', runbook: 'runtime-diagnostics', piiClassification: 'redacted'),
