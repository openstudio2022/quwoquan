...
abstract final class RuntimeLogCatalog {
  ...
  static const Map<String, RuntimeLogSignalMetadata> signalRegistry = <String, RuntimeLogSignalMetadata>{
    ...
    'app.performance.anr': RuntimeLogSignalMetadata(owner: 'runtime-client-foundation', producers: <String>['dart'], logKind: 'event', defaultSeverity: 'ERROR', environments: <String>['alpha', 'beta', 'gamma', 'prod'], attributeAllowlist: <String>['source', 'stallMs', 'anrThresholdMs', 'sampledFrames', 'jankyFrames', 'worstFrameMs', 'jankThresholdMs'], correlationKeys: <String>['requestId', 'traceId', 'spanId', 'operationId', 'pageName', 'surfaceId', 'executionId', 'workPackageId', 'environmentRunId', 'actorHash'], backend: 'runtime-sls', retentionDays: 3, sampling: 'warn_error', alert: 'runtime_signal_rate', runbook: 'runtime-diagnostics', piiClassification: 'redacted'),
