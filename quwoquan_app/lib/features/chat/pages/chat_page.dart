    ...
    return Column(
      children: [
        Container(
          ...
          child: Row(
            children: [
              Icon(Icons.shield, color: AppColors.primaryColor, size: 24),
              SizedBox(width: AppSpacing.sm),
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(UITextConstants.secretUnlockedBanner, style: TextStyle(fontSize: 14, fontWeight: FontWeight.w700, color: fgPrimary)),
                    Text('${encrypted.length} 个加密对话 · 安全保护中', style: TextStyle(fontSize: 12, color: fgSecondary)),
                  ],
                ),
              ),
              TextButton(
                ...
                child: Row(
                  ...
                  children: [
                    Icon(Icons.lock, size: 16, color: AppColors.primaryColor),
                    SizedBox(width: 4),
        ...
        Expanded(
          child: encrypted.isEmpty
              ? Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [Icon(Icons.shield_outlined, size: 48, color: fgSecondary), SizedBox(height: AppSpacing.md), Text(UITextConstants.noSecretConversations, style: TextStyle(fontSize: 14, color: fgSecondary))]))
              : ListView.builder(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            ...
            child: Icon(Icons.lock, size: 48, color: fgSecondary),
          ),
          SizedBox(height: 24),
          Text(UITextConstants.secretLockedTitle, style: TextStyle(fontSize: 22, fontWeight: FontWeight.w900, color: fgPrimary)),
          SizedBox(height: 32),
          SizedBox(
            width: 320,
            child: Column(
              children: [
                ...
                if (_secretAuthError.isNotEmpty) ...[
                  SizedBox(height: 12),
                  Text(_secretAuthError, style: TextStyle(fontSize: 12, color: AppColors.error)),
                ],
                SizedBox(height: 20),
                SizedBox(
                  ...
                  child: FilledButton(
                    ...
                    style: FilledButton.styleFrom(backgroundColor: fgPrimary, foregroundColor: bg, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(28))),
                    child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [Icon(Icons.lock_open), SizedBox(width: 8), Text(UITextConstants.secretUnlockButton)]),
                  ),
                ),
              ],
            ),
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: AppSpacing.md),
            Text('暂无$sub内容', style: TextStyle(fontSize: 16, color: fgSecondary)),
          ],
        ),
      );
    }
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(title, style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: fgPrimary)),
                        if (subtitle.isNotEmpty) Text(subtitle, maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 13, color: fgSecondary)),
                      ],
                    ),
                  ),
                ],
...
class _ContactsListWithIndexState extends State<_ContactsListWithIndex> {
  ...
  Widget build(BuildContext context) {
      ...
      if (isFirstStarred) {
        ...
        if (key != null) {
          listChildren.add(Container(
            ...
            child: Text(UITextConstants.starredFriends, style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: widget.fgSecondary)),
          ));
        }
      }
      if (!starred && isFirstOfInitial) {
        ...
        if (key != null) {
          listChildren.add(Container(
            ...
            padding: EdgeInsets.symmetric(horizontal: AppSpacing.md, vertical: 4),
            color: widget.borderColor.withValues(alpha: 0.15),
            child: Text(initial, style: TextStyle(fontSize: 12, fontWeight: FontWeight.w600, color: widget.fgSecondary)),
          ));
        }
      }
      lastInitial = initial;
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Row(
                          children: [
                            Text(title, style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: widget.fgPrimary)),
                            if (starred) ...[SizedBox(width: 4), Icon(Icons.star, size: 16, color: AppColors.warning)],
                          ],
                        ),
                        if (subtitle.isNotEmpty) Text(subtitle, maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(fontSize: 13, color: widget.fgSecondary)),
                      ],
                    ),
                  ),
                ],
    ...
    listChildren.add(SizedBox(height: 32));
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      children: [
                        ...
                        if (isSpecial) ...[
                          ...
                          Container(
                            ...
                            child: Text('AI', style: TextStyle(fontSize: 10, fontWeight: FontWeight.w800, color: AppColors.warning)),
                          ),
                        ],
                      ],
                    ),
                    ...
                    Row(
                      children: [
                        if (isEncrypted) ...[
                          Icon(Icons.lock, size: 12, color: fgSecondary),
                          SizedBox(width: 4),
                        ],
                        Expanded(
                          child: Text(
