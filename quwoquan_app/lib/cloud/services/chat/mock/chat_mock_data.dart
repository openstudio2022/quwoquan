...
class ChatMockData {
  ...
  /// 当前用户在消息中的 senderId — 与 ChatConversationPage / chatMessageProvider 保持一致
  ...
  static List<Map<String, dynamic>> _generateGridMessages(
    ...
    for (int i = 1; i <= memberCount && i <= 6; i++) {
      ...
      messages.add({
        ...
        'senderId': userId,
        'senderDisplayNameSnapshot': name,
        'senderAvatarUrlSnapshot': isFirst
  ...
  static final Map<String, List<Map<String, dynamic>>> _messagesByConversation =
      {
        'conv_001': [
          {
            ...
            'senderAvatarUrlSnapshot': avatarFor('user_002'),
            'type': 'text',
            'content': '好的，明天见',
            'status': 'sent',
          ...
          },
          {
            ...
            'senderDisplayNameSnapshot': '我',
            'senderAvatarUrlSnapshot': avatarFor(currentUserProfileId),
            'type': 'text',
            'content': '那我们明天下午三点见面？',
            'status': 'read',
        ...
        'conv_002': [
          // ── 当天下午 (2026-03-11 PM) ──
          {
            ...
            'senderId': 'user_003',
            'senderDisplayNameSnapshot': '张华',
            'senderAvatarUrlSnapshot': avatarFor('user_003'),
            'type': 'text',
          ...
          },
          {
            ...
            'senderId': 'user_004',
            'senderDisplayNameSnapshot': '王芳',
            'senderAvatarUrlSnapshot': avatarFor('user_004'),
            'type': 'text',
            'content': '我带水果和零食',
            'status': 'sent',
          ...
          },
          {
            ...
            'senderId': 'user_005',
            'senderDisplayNameSnapshot': '赵磊',
            'senderAvatarUrlSnapshot': avatarFor('user_005'),
            'type': 'text',
            'content': '装备清单谁整理一下？',
            'status': 'sent',
          ...
          },
          {
            ...
            'senderId': 'user_006',
            'senderDisplayNameSnapshot': '孙悦',
            'senderAvatarUrlSnapshot': avatarFor('user_006'),
            'type': 'text',
          ...
          // ── 本周 (2026-03-09) ──
          {
            ...
            'senderId': 'user_007',
            'senderDisplayNameSnapshot': '周杰',
            'senderAvatarUrlSnapshot': avatarFor('user_007'),
            'type': 'text',
          ...
          // ── 月内 (2026-03-03) ──
          {
            ...
            'senderId': 'user_008',
            'senderDisplayNameSnapshot': '吴涵',
            'senderAvatarUrlSnapshot': avatarFor('user_008'),
            'type': 'text',
          ...
          },
          {
            ...
            'senderId': 'user_009',
            'senderDisplayNameSnapshot': '郑敏',
            'senderAvatarUrlSnapshot': avatarFor('user_009'),
            'type': 'text',
          ...
          },
          {
            ...
            'senderId': 'user_010',
            'senderDisplayNameSnapshot': '陈博',
            'senderAvatarUrlSnapshot': avatarFor('user_010'),
            'type': 'text',
            'content': '新年快乐！明年见',
            'status': 'sent',
        ...
        'conv_003': [
          {
            ...
            'senderId': 'user_003',
            'senderDisplayNameSnapshot': nameFor('user_003'),
            'senderAvatarUrlSnapshot': avatarFor('user_003'),
            'type': 'text',
            'content': '分享一组新疆风景照',
            'status': 'sent',
          ...
          },
          {
            ...
            'senderId': 'user_002',
            'senderDisplayNameSnapshot': nameFor('user_002'),
            'senderAvatarUrlSnapshot': avatarFor('user_002'),
            'type': 'text',
            'content': '下次一起去拍',
            'status': 'sent',
