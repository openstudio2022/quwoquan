...
class ChatMockData {
  ...
  static List<ChatInboxDto> get inboxItems => <ChatInboxDto>[
    ChatInboxDto(
      id: 'conv_006',
      type: 'group',
      title: '产品共创群',
      ...
      lastMessageTime: DateTime.parse(
        _relativeIso(daysAgo: 0, hour: 20, minute: 18),
      ),
      lastSeq: 512,
      unreadCount: 4,
    ...
    ChatInboxDto(
      ...
      lastMessageType: 'text',
      lastMessageTime: DateTime.parse(
        _relativeIso(daysAgo: 0, hour: 8, minute: 32),
      ),
      lastSeq: 42,
      unreadCount: 0,
    ...
    ChatInboxDto(
      ...
      lastMessageTime: DateTime.parse(
        _relativeIso(daysAgo: 1, hour: 21, minute: 10),
      ),
      lastSeq: 256,
      unreadCount: 6,
    ...
    ChatInboxDto(
      ...
      lastMessageType: 'image',
      lastMessageTime: DateTime.parse(
        _relativeIso(daysAgo: 1, hour: 11, minute: 6),
      ),
      lastSeq: 1024,
      unreadCount: 2,
      mentionUnreadCount: 0,
    ...
    ChatInboxDto(
      ...
      lastMessageTime: DateTime.parse(
        _relativeIso(daysAgo: 2, hour: 18, minute: 40),
      ),
      lastSeq: 88,
      unreadCount: 1,
      mentionUnreadCount: 0,
