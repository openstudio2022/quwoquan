// Code generated by tools/codegen_app_metadata from rtc/rtc/call_session/errors.yaml. DO NOT EDIT.
...
enum RtcErrorCode {
  ...
  notMutual('RTC.USER.not_mutual', '互相关注后可发起 1 对 1 实时通话', 403),
  blocked('RTC.USER.blocked', '当前关系不允许发起通话', 403),
