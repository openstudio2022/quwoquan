...
class RtcApiMetadata {
  ...
  static const Map<String, String> operationToPathTemplate = <String, String>{
    ...
    'ListCalls': '/rtc/calls',
    'RecoverRtcAccountClosureDeadLetter': '/internal/rtc/account-closure/dead-letters:recover',
  ...
  static const Map<String, String> operationToMethod = <String, String>{
    ...
    'LeaveCall': 'POST',
    'ListCalls': 'GET',
    'RecoverRtcAccountClosureDeadLetter': 'POST',
    'RejectCall': 'POST',
  ...
  static const Map<String, String> operationToAuthMode = <String, String>{
    ...
    'LeaveCall': 'required',
    'ListCalls': 'required',
    'RecoverRtcAccountClosureDeadLetter': 'required',
    'RejectCall': 'required',
  ...
  static const String recoverRtcAccountClosureDeadLetterOperation = 'RecoverRtcAccountClosureDeadLetter';
  ...
  static const String recoverRtcAccountClosureDeadLetterPath = '/internal/rtc/account-closure/dead-letters:recover';
