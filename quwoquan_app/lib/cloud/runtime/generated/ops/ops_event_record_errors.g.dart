...
enum OpsEventRecordErrorCode {
  ...
  startupConfigurationInvalid('OPS.SYSTEM.startup_configuration_invalid', '启动配置不可用，请检查网络后重试', 500),
  startupInitializationFailed('OPS.SYSTEM.startup_initialization_failed', '应用启动遇到问题，请重试', 500),
  startupRouterUnavailable('OPS.SYSTEM.startup_router_unavailable', '页面暂时无法打开，请重试', 503),
  unclassifiedPageFailure('OPS.SYSTEM.unclassified_page_failure', '页面遇到未分类异常', 500),
  startupNativeFirstFrameTimeout('OPS.SYSTEM.startup_native_first_frame_timeout', '应用界面未能及时显示，请重试', 503),
...
class OpsEventRecordErrorMessages {
  ...
  static const Map<OpsEventRecordErrorCode, String> zh = <OpsEventRecordErrorCode, String>{
    ...
    OpsEventRecordErrorCode.unclassifiedPageFailure: '页面遇到未分类异常',
  ...
  static const Map<OpsEventRecordErrorCode, String> en = <OpsEventRecordErrorCode, String>{
    ...
    OpsEventRecordErrorCode.unclassifiedPageFailure: 'The page encountered an unclassified failure.',
