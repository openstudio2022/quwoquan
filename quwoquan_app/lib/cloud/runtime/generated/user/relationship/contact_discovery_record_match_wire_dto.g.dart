...
class ContactDiscoveryMatchWireDto {
  ...
  final String? region;
  final SocialRelationshipCapabilityWireDto? relationshipCapability;
  ...
  factory ContactDiscoveryMatchWireDto.fromMap(Map<String, dynamic> m) {
    return ContactDiscoveryMatchWireDto(
      ...
      relationshipCapability: m['relationshipCapability'] == null ? null : SocialRelationshipCapabilityWireDto.fromMap(_parseStringKeyMap(m['relationshipCapability'])!),
    );
  }
  ...
  ContactDiscoveryMatchWireDto copyWith({
    ...
    int? avatarVersion,
    String? region,
    SocialRelationshipCapabilityWireDto? relationshipCapability,
  }) {
    return ContactDiscoveryMatchWireDto(
