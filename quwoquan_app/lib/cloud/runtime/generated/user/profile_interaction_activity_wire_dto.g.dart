...
class ProfileInteractionActivityWireDto {
  ...
  factory ProfileInteractionActivityWireDto.fromMap(Map<String, dynamic> m) {
    return ProfileInteractionActivityWireDto(
      ...
      activityType: m['activityType']?.toString() ?? '',
      direction: m['direction']?.toString() ?? 'received',
      actorSubAccountId: m['actorSubAccountId']?.toString() ?? '',
      actorDisplayName: m['actorDisplayName']?.toString() ?? '',
      actorAvatarUrl: m['actorAvatarUrl']?.toString() ?? '',
      actorAvatarVersion: (m['actorAvatarVersion'] as num?)?.toInt() ?? 0,
      counterpartSubAccountId: m['counterpartSubAccountId']?.toString() ?? '',
      ...
      targetContentId: m['targetContentId']?.toString() ?? '',
      targetContentType: m['targetContentType']?.toString() ?? '',
      targetContentSummary: m['targetContentSummary']?.toString() ?? '',
      targetKind: m['targetKind']?.toString() ?? 'record',
      targetAvailability: m['targetAvailability']?.toString() ?? 'active',
      targetReplyCount: (m['targetReplyCount'] as num?)?.toInt() ?? 0,
      displaySubAccountId: m['displaySubAccountId']?.toString() ?? '',
      displayName: m['displayName']?.toString() ?? '',
      displayAvatarUrl: m['displayAvatarUrl']?.toString() ?? '',
      displayAvatarVersion: (m['displayAvatarVersion'] as num?)?.toInt() ?? 0,
      ...
      previewObjectId: m['previewObjectId']?.toString() ?? '',
      ...
      occurredAt: _parseDateTime(m['occurredAt']) ?? null,
