...
enum NotificationErrorCode {
  ...
  deliveryNotFound('NOTIFICATION.USER.delivery_not_found', '投递记录不存在或已不在死信状态', 404),
...
class NotificationErrorMessages {
  ...
  static const Map<NotificationErrorCode, String> zh = <NotificationErrorCode, String>{
    ...
    NotificationErrorCode.deliveryNotFound: '投递记录不存在或已不在死信状态',
  ...
  static const Map<NotificationErrorCode, String> en = <NotificationErrorCode, String>{
    ...
    NotificationErrorCode.deliveryNotFound: 'Notification delivery was not found in dead-letter state',
