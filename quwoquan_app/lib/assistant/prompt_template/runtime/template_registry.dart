...
import 'package:quwoquan_app/assistant/prompt_template/domain/prompt_template.dart';
import 'package:quwoquan_app/assistant/prompt_template/domain/template_validator.dart';

class TemplateRegistry {
  TemplateRegistry({
    this.manifestAssetPath = 'assets/assistant/prompts/manifest.json',
  ...
  factory TemplateRegistry.withSeeded({
    ...
    final registry = TemplateRegistry._internal(
      manifestAssetPath,
      seededTemplates,
    );
      ...
      for (final item in templatesRaw) {
        ...
        try {
          ...
          final template = PromptTemplate(
            ...
            content: contentRaw,
            requiredVariables:
                (meta['requiredVariables'] as List?)
                    ?.whereType<String>()
                    .map((item) => item.trim())
...
class TemplateSelector {
  ...
  TemplateSelection select({
    ...
    final targetVersion = (perTemplate['targetVersion'] as String?)?.trim() ?? '';
