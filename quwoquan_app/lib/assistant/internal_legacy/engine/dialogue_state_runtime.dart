...
import 'package:quwoquan_app/assistant/internal_legacy/engine/domain_routing_catalog_runtime.dart';
import 'package:quwoquan_app/assistant/internal_legacy/engine/event_detection_catalog_runtime.dart';
...
class DialogueStateRuntime {
  ...
  Future<_DomainDialogueAssets?> _ensureDomainAssets({
    ...
    final selectedRoutingCatalog = _routingCatalogRuntime
        .resolveCatalogForRequest(contextScopeHint);
    final fallbackPath = 'assets/assistant/skills/$domainId/dialogue';
