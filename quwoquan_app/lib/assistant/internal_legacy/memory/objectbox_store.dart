...
import 'package:quwoquan_app/assistant/internal_legacy/storage/personal_assistant_storage_path.dart';

/// NOTE:
/// This is an ObjectBox-compatible adapter surface kept lightweight for now.
/// It can be replaced with a generated ObjectBox entity store without
/// changing higher-level APIs.
  ...
  Future<void> _loadIfNeeded() async {
    ...
    for (final entry in decoded.entries) {
      ...
      final vector = (map['vector'] as List? ?? const <dynamic>[])
          ...
          .toList(growable: false);
      final metadata = (map['metadata'] as Map?)?.cast<String, dynamic>() ?? <String, dynamic>{};
