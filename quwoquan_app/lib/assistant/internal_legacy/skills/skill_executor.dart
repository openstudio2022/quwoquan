import 'package:quwoquan_app/assistant/internal_legacy/engine/device_capability.dart';
...
class PersonalAssistantSkillExecutor {
  PersonalAssistantSkillExecutor({
    ...
    KnowledgeQaEngine? knowledgeQaEngine,
       ...
       _capabilityRouter =
           capabilityRouter ?? const AssistantCapabilityRouter(),
       _knowledgeQaEngine =
  ...
  Future<AssistantToolResult> _executeToolChain({
    ...
    for (final step in steps) {
      ...
      final result = (remoteResult == null || !remoteResult.success)
          ? await _toolRegistry.execute(toolName, toolArgs)
          : remoteResult;
