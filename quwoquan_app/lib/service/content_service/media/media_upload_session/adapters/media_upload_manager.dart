...
import 'package:quwoquan_app/service/content_service/media/media_upload_session/application/upload_policy.dart';
import 'package:quwoquan_app/runtime/errors/cloud_exception.dart';
import 'package:quwoquan_runtime_errors/runtime_errors.dart';

/// Manages media upload queue with concurrency limits, retry, and offline support.
class MediaUploadManager implements MediaUploadQueue {
  MediaUploadManager({
  ...
  final ContentMediaUploadService coordinator;
