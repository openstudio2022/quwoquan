...
extension _CreateMediaPickerPageChrome on _CreateMediaPickerPageState {
  ...
  Future<Uint8List?> _cachedThumbnailFuture(MediaPickerAssetRef entity) {
    return _thumbnailFutures.putIfAbsent(
      entity.id,
      () => widget.mediaPickerPort.loadThumbnail(entity),
    );
  }

  Widget _buildAssetThumb(MediaPickerAssetRef entity, bool isDark) {
