...
const List<ImageEditorHslChannel> kImageEditorHslChannels = [
  ImageEditorHslChannel(
    key: 'red',
    label: MediaText.imageEditorProChannelRed,
  ...
  ImageEditorHslChannel(
    key: 'orange',
    label: MediaText.imageEditorProChannelOrange,
  ...
  ImageEditorHslChannel(
    key: 'yellow',
    label: MediaText.imageEditorProChannelYellow,
  ...
  ImageEditorHslChannel(
    key: 'green',
    label: MediaText.imageEditorProChannelGreen,
  ...
  ImageEditorHslChannel(
    key: 'cyan',
    label: MediaText.imageEditorProChannelCyan,
  ...
  ImageEditorHslChannel(
    key: 'blue',
    label: MediaText.imageEditorProChannelBlue,
  ...
  ImageEditorHslChannel(
    key: 'purple',
    label: MediaText.imageEditorProChannelPurple,
  ...
  ImageEditorHslChannel(
    key: 'magenta',
    label: MediaText.imageEditorProChannelMagenta,
