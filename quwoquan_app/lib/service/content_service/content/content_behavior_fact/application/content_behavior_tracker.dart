...
import 'package:quwoquan_app/service/content_service/content/content_behavior_fact/application/content_behavior_effective_playback_event.dart';
import 'package:quwoquan_app/service/content_service/content/content_behavior_fact/application/content_behavior_tracker_event_normalization.dart';
...
class ContentBehaviorTracker implements ContentBehaviorTrackerPort {
  ...
  void trackEffectivePlayback(
    ...
    final event = buildEffectivePlaybackBehaviorEvent(
      contentId,
  ...
  void _add(BehaviorEvent event) {
    final normalized = normalizeContentBehaviorEvent(event);
    final dedupKey = contentBehaviorEventDedupKey(normalized);
  ...
  void _restoreFailedBatch(List<BehaviorEvent> failed) {
    ...
    for (final event in pending) {
      ...
      final dedupKey = contentBehaviorEventDedupKey(event);
