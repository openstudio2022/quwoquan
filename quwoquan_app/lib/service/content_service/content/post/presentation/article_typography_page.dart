...
import 'package:quwoquan_app/service/content_service/content/post/presentation/article_reader/hosts/article_editor_reader_adapter.dart';
...
import 'package:quwoquan_app/service/content_service/content/post/adapters/publish_draft_projection_bridge.dart';
import 'package:quwoquan_app/service/content_service/content/post/application/create_editor_provider.dart';
import 'package:quwoquan_app/service/content_service/content/post/presentation/article_typography_thumbnail_raster.dart';
...
/// 导航标题优先 [postReadPreviewFromCreateEditorState] 的 canonical read view 标题。
...
class _ArticleTypographyPageState extends ConsumerState<ArticleTypographyPage> {
  ...
  Widget _buildTopBar(CreateEditorState state) {
    ...
    final draftRead = postReadPreviewFromCreateEditorState(state);
    final barTitle = draftRead.normalizedTitle.isNotEmpty
        ? draftRead.normalizedTitle
        : '长文排版';
