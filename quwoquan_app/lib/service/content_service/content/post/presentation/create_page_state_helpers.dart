...
extension _CreatePageStateHelpers on _CreatePageState {
  ...
  Future<CreateMediaPickerResult?> _openMediaPicker({
    ...
    if (shouldUseDesktopImagePicker(
      hasMediaLibrary: caps.mediaLibrary,
      hasLocalFileSystem: caps.hasLocalFileSystem,
      mode: mode,
    )) {
      return Navigator.of(context).push<CreateMediaPickerResult>(
        MaterialPageRoute<CreateMediaPickerResult>(
          ...
          builder: (_) => ContentMediaCreationComposition.desktopPicker(
            maxSelection: maxSelection,
          ),
        ),
      );
    }
    final mediaPickerPort = widget.mediaPickerPort;
    if (mediaPickerPort == null) {
      throw StateError('CreatePage media picker composition is missing');
    }
    return Navigator.of(context).push<CreateMediaPickerResult>(
      MaterialPageRoute<CreateMediaPickerResult>(
        settings: const RouteSettings(
        ...
        fullscreenDialog: true,
        builder: (_) => ContentMediaCreationComposition.mediaPicker(
          mode: mode,
          maxSelection: maxSelection,
    ...
    final result = launcher != null
        ...
        : await Navigator.of(context).push<VideoEditorResult>(
            MaterialPageRoute<VideoEditorResult>(
              ...
              fullscreenDialog: true,
              builder: (_) => ContentMediaCreationComposition.videoEditor(
  ...
  Future<CreateVideoPreparationResult> _prepareVideoForMediaEditor(
    ...
    await ref.read(localVideoPlayabilityProvider).waitUntilPlayable(path);
