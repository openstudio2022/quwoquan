...
typedef ProfileFootprintPostClickTracker = void Function(String postId);
...
class ProfileFootprintTab extends ConsumerStatefulWidget {
  const ProfileFootprintTab({
    ...
    required this.trackPostClick,
    this.onSecondaryHorizontalDragEnd,
  });

  final bool isDark;
  final ProfileFootprintPostClickTracker trackPostClick;
