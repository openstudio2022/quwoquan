...
class _CreatePageState extends ConsumerState<CreatePage>
  ...
  Widget _buildCameraPageForCurrentEditor(
    ...
    return ContentMediaCreationComposition.camera(
      initialMode: initialMode,
  ...
  Future<_VideoMetadataProbe> _loadVideoMetadata(String path) async {
    ...
    final controller = AppVideoPlayerControllerFactory.localFileReadinessProbe(
      path,
    );
    try {
      ...
      if (firstImagePath.isNotEmpty &&
        ...
        try {
          final bytes = Uint8List.fromList(
            await ref
                .read(fileStorageGatewayProvider)
                .readAsBytes(firstImagePath),
          );
