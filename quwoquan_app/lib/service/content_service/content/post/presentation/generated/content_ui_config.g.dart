...
class OnboardingInterestDimensionConfig {
  final String id;
  final String tagRef;
  ...
  const OnboardingInterestDimensionConfig({
    required this.id,
...
class ContentUIConfig {
  ...
  static const List<HomeChannelConfig> homeChannels = <HomeChannelConfig>[
    ...
    HomeChannelConfig(id: "featured", labelKey: "home_tab_featured", template: "premium_immersive", layoutTemplate: "immersivePremiumStream", phoneColumns: 1, supportsFullSpanModules: true, intersectionModulePolicy: "inlineOnly", contentCardPolicy: "premiumImmersive", feedQuery: <String, String>{"channel": "premium"}, moodCopyKey: "home_mood_recommend", order: 2),
    ...
    HomeChannelConfig(id: "tech", labelKey: "home_tab_tech", template: "single_column_multiform", layoutTemplate: "singleColumnMultiForm", phoneColumns: 1, supportsFullSpanModules: false, intersectionModulePolicy: "inlineOnly", contentCardPolicy: "richMultiForm", feedQuery: <String, String>{"channel": "tech"}, moodCopyKey: "home_mood_tech", order: 6),
    HomeChannelConfig(id: "car", labelKey: "home_tab_car", template: "single_column_multiform", layoutTemplate: "singleColumnMultiForm", phoneColumns: 1, supportsFullSpanModules: false, intersectionModulePolicy: "inlineOnly", contentCardPolicy: "richMultiForm", feedQuery: <String, String>{"channel": "car"}, moodCopyKey: "home_mood_car", order: 7),
  ];
