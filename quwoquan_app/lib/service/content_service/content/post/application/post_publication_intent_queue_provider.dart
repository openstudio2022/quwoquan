...
part 'post_publication_intent_queue_models.dart';
...
final class PostPublicationIntentQueueNotifier
  ...
  Future<void> _continueMediaCancellation(
    ...
    final uploadService = ref.read(createContentMediaUploadServiceProvider);
    ...
    for (var index = 0; index < current.preparedMediaAssets.length; index++) {
      ...
      final resolved = await uploadService.cancelPreparedCheckpoint(
        checkpoint,
