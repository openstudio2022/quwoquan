...
final class DefaultPostArticleDetailProjector
    implements PostArticleDetailProjector {
  const DefaultPostArticleDetailProjector();

  @override
  ContentArticleRender project(
    Map<String, dynamic> raw, {
    required String fallbackArticleId,
  }) => projectArticleDetailView(raw, fallbackArticleId: fallbackArticleId);
}

/// 自 [ContentPostDetailReader.getPost] 返回的 [ContentPostDetailPayload] 投射出文章富渲染载荷。
