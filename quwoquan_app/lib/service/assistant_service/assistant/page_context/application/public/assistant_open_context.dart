...
/// Assistant-owned projection of the runtime visit frequency hint.
enum AssistantExperienceLevel { firstTime, returning, frequent }
...
class AssistantOpenContext {
  ...
  final AssistantExperienceLevel experienceLevel;
  ...
  AssistantOpenContext copyWith({
    ...
    AssistantExperienceLevel? experienceLevel,
