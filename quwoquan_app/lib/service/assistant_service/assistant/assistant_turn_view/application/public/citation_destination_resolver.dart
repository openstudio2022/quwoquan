...
///
/// 站内仅接受 canonical object type 与非空标识，站外仅接受绝对 HTTPS URL；
...
abstract final class CitationDestinationResolver {
  ...
  static const Set<String> _canonicalInternalObjectTypeRefs = <String>{
    'chat.conversation',
    'circle.circle',
    'content.post',
    'entity.homepage',
  ...
  static InternalCitationDestination? _resolveInternal(
    ...
    if (!_canonicalInternalObjectTypeRefs.contains(objectTypeRef) ||
        objectId.isEmpty) {
      return null;
    }
