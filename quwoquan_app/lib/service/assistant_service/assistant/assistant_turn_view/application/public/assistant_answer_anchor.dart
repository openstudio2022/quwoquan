import 'package:quwoquan_app/service/assistant_service/assistant/assistant_turn_view/domain/assistant_quality_metrics_read_view.dart';

/// 助手回答的跨对象公开运行锚点（C3）。不等于完整持久化 turn。
