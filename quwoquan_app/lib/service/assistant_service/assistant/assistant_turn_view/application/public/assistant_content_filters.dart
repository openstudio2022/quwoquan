import 'package:quwoquan_app/service/assistant_service/assistant/assistant_turn_view/application/public/display_text_classifier.dart';
...
abstract final class AssistantContentFilters {
  static DisplayTextClassifier _classifier = const DisplayTextClassifier(
    ProgressTextPolicy.defaults,
  );

  static void installProgressTextPolicy(ProgressTextPolicy policy) {
    _classifier = DisplayTextClassifier(policy);
  }
