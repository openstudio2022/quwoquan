...
class AssistantPromptConfig {
  ...
  static String _levelKey(AssistantExperienceLevel l) {
    switch (l) {
      case AssistantExperienceLevel.firstTime:
        return 'firstTime';
      case AssistantExperienceLevel.returning:
        return 'returning';
      case AssistantExperienceLevel.frequent:
        return 'frequent';
    }
  }
  ...
  static List<String> getSuggestionLines(AssistantOpenContext context) {
    ...
    if (context.source == AssistantSource.discovery && tab.isNotEmpty) {
      if (level == AssistantExperienceLevel.returning ||
          level == AssistantExperienceLevel.frequent) {
