...
class HomeIntersectionSpotlightRail extends ConsumerStatefulWidget {
  static const Map<String, String> _titleByChannelId = <String, String>{
    'travel': DiscoveryFeedText.intersectionTravelSpotlightTitle,
    'campus': DiscoveryFeedText.intersectionCampusSpotlightTitle,
  };
  ...
  static String titleFor(String channelId) =>
      _titleByChannelId[channelId.trim()] ??
