...
import 'package:quwoquan_app/service/recommendation_service/recommendation/recommendation_feature_profile_view/presentation/generated/impact_help_type_metadata.g.dart';
...
class IntersectionIconResolver {
  static const Map<String, IconData> _iconByKey = <String, IconData>{
    'place': CupertinoIcons.location_solid,
    'placeHere': CupertinoIcons.map_pin_ellipse,
    'circle': CupertinoIcons.person_3_fill,
    'people': CupertinoIcons.person_2_fill,
    'contact': CupertinoIcons.person_crop_circle_badge_checkmark,
    'followHere': CupertinoIcons.person_2_square_stack_fill,
    'viewing': CupertinoIcons.eye_fill,
    'alumni': CupertinoIcons.book_solid,
    'work': CupertinoIcons.briefcase_fill,
    'discussion': CupertinoIcons.chat_bubble_2_fill,
    'share': CupertinoIcons.arrowshape_turn_up_right_fill,
    'like': CupertinoIcons.heart_fill,
    'interest': CupertinoIcons.sparkles,
    'attention': CupertinoIcons.star_fill,
    'connect': CupertinoIcons.link,
    'communityJoin': CupertinoIcons.person_3_fill,
    'decisionCompass': CupertinoIcons.location_north_fill,
    'knowledgeRead': CupertinoIcons.book_fill,
    'spreadShare': CupertinoIcons.arrowshape_turn_up_right_fill,
    'audienceReach': CupertinoIcons.eye_fill,
    'cascadePath': CupertinoIcons.link,
  };
  ...
  ///
  /// 闭集为 registry 的 presentation 映射；影响 helpType 覆盖由
  /// `verify_impact_help_type_registry.py` 守护。
  static IconData? _iconForKey(String iconKey) => _iconByKey[iconKey.trim()];

  static String _iconKeyForSourceRef(String sourceRef) =>
      IntersectionKindDisplayMetadata.of(sourceRef.trim())?.iconKey ?? '';

  /// dimension（5 维闭集）→ iconKey 末级回退：codegen [intersectionFallbackIconKeyByDimension]
  ...
  static String _iconKeyForDimension(String dimension) {
    final parsed = switch (dimension.trim()) {
    ...
    return intersectionFallbackIconKeyByDimension[parsed] ?? '';
  }
