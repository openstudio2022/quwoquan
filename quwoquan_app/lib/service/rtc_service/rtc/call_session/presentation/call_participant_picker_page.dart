...
import 'package:quwoquan_app/service/rtc_service/rtc/call_session/domain/call_picker_participant_row.dart';
...
import 'package:quwoquan_app/runtime/di/app_providers_chat_search.dart'
    show
        ...
        chatInboxRepositoryProvider,
        chatMemberRepositoryProvider;
...
class _CallParticipantPickerPageState
  ...
  Future<List<ChatInboxViewData>> _loadAvailableGroups() async {
    ...
    final inbox = await ref
        .read(chatInboxRepositoryProvider)
        .listInbox(limit: 100);
