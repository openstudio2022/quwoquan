...
import 'package:quwoquan_app/runtime/di/app_providers_app_state.dart'
    show currentUserIdProvider, resolvedOwnerUserIdProvider;
import 'package:quwoquan_app/runtime/di/app_providers_chat_search.dart'
    show conversationCacheProvider, searchRepositoryProvider;
...
import 'package:quwoquan_app/runtime/di/app_providers_client_sync.dart'
    show cacheTelemetrySinkProvider, homepageQueryProvider;
import 'package:quwoquan_app/runtime/di/app_providers_operations.dart'
    show
        recentSearchCommandWriterProvider,
        recentSearchHistoryStoreProvider,
        recentSearchQueryProvider,
        searchHotQueryReaderProvider;
...
class SearchCoordinator extends Notifier<SearchSessionState> {
  ...
  SearchSessionState build() {
    ...
    _localStore = ref.watch(recentSearchHistoryStoreProvider(actorNamespace));
  ...
  late RecentSearchHistoryStore _localStore;
  ...
  Future<void> hydrateRecentSearches() async {
    ...
    var localSnapshot = const RecentSearchHistorySnapshot();
    try {
  ...
  Future<void> _saveRecentHistory(
    ...
    RecentSearchHistoryStore? store,
  }) {
