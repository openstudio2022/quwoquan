...
extension _CircleShellBuilders on _CircleShellState {
  ...
  Widget _buildIntersectionCard(bool isDark) {
    ...
    return widget.participantSlots.buildObjectIntersection(
  ...
  Widget _buildCircleImpactCard(bool isDark) {
    return widget.participantSlots.buildObjectImpact(
                      ...
                      children: [
                        ...
                        ObjectChromeActions(
                          ...
                          onSearch: () => GlobalSearchLauncher.open(
                            context,
                            initialScopeWire:
                                GlobalSearchScope.circles.scopeWireValue,
                          ),
                          onAssistant: (ref) =>
      ...
      'creations' =>
        contentLocked
            ...
            : SectionCreations(
                ...
                isDark: isDark,
                role: state.role,
                participantSlots: widget.participantSlots.creations,
                inlineScroll: true,
              ),
      'discussion' =>
        memberLocked
      ...
      'members' =>
        memberLocked
            ...
            : Padding(
                ...
                child: widget.participantSlots.buildMembersSection(
                  circleId: widget.circleId,
                  isDark: isDark,
                ),
              ),
  ...
  Widget _buildDiscussionBody(
    ...
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.stretch,
        children: [
          if (state.defaultPublicGroup case final group?
              when widget.groupMembershipAccess != null) ...[
            widget.participantSlots.buildGroupMembershipPanel(
              circleId: widget.circleId,
              group: group,
              access: widget.groupMembershipAccess!,
              isDark: isDark,
            ),
            SizedBox(height: AppSpacing.containerSm),
          ],
