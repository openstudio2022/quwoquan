...
import 'package:quwoquan_app/runtime/di/app_providers_operations.dart'
    show circleDetailContentReportCommandWriterProvider;
...
class _CircleShellState extends ConsumerState<CircleShell> {
  ...
  Future<void> _startCircleCall(
    ...
    return widget.participantSlots.startCall(
      context: context,
      ref: ref,
      ...
      case _CircleMoreAction.approval:
        await Navigator.of(context).push(
          CupertinoPageRoute<void>(
            ...
            builder: (_) => widget.participantSlots.buildMembershipApprovalPage(
              widget.circleId,
            ),
          ),
        );
        ...
        body: AppPageErrorState(
          ...
          onRecovery: (action) async {
            if (action.type == UiErrorActionType.retry ||
              ...
              return ref.read(circleStateProvider(widget.circleId)).loadError ==
                      null
