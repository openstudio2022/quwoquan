/// Codec Map view for legacy `task_card` / `image` / `audio` transcript rows (S-UI).
class AssistantLegacyBubbleEnvelope {
  const AssistantLegacyBubbleEnvelope._(this.raw);

  final Map<String, dynamic> raw;

  factory AssistantLegacyBubbleEnvelope.fromCodecMap(
    Map<String, dynamic> encoded,
  ) {
    return AssistantLegacyBubbleEnvelope._(Map<String, dynamic>.from(encoded));
  }
