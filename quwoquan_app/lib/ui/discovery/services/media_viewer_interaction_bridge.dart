...
void primeMediaViewerInteractionSnapshot(
  ...
  core_bridge.primeMediaViewerInteractionSnapshot(ref, snapshot);
  ref
...
void applyConfirmedInteractionPost(WidgetRef ref, PostBaseDto post) {
  core_bridge.applyConfirmedInteractionPost(ref, post);
  ref
      .read(discoveryStateProvider.notifier)
...
void applyConfirmedInteractionPosts(
  ...
  core_bridge.applyConfirmedInteractionPosts(ref, posts);
...
void applyMediaViewerResultToInteractionState(
  ...
  core_bridge.applyMediaViewerResultToInteractionState(ref, result);
...
int effectivePostCommentCount(
  ...
  return core_bridge.effectivePostCommentCount(ref, postId, fallback: fallback);
}
...
void syncPostLikeIntent(
  ...
  core_bridge.syncPostLikeIntent(
    ref,
    postId: postId,
...
void syncPostCommentCount(
  ...
  core_bridge.syncPostCommentCount(
    ref,
    postId: postId,
