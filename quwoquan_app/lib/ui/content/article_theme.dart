...
ArticleTemplatePalette resolveArticleTemplatePalette(
  ...
  switch (template) {
    ...
    case ArticleTemplatePreset.tech:
      return const ArticleTemplatePalette(
...
ArticleTypographySpec resolveArticleTypography(
  ...
  return _resolveTypographySpec(palette, fontPreset);
}
...
ArticleTypographySpec _resolveTypographySpec(
  ArticleTemplatePalette palette,
  ArticleFontPreset fontPreset,
) {
  TextStyle base({
