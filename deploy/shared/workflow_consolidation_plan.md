...
| 07 | Merge dev1.0 To Main | Main Branch | 定时 6:00 或 workflow_dispatch：merge dev1.0 → main；push 触发 pre-release-gate |
...
- **触发**：v*-rc* tag、push to main（日节奏 merge 后）、workflow_dispatch
- **调整**：
...
| 8 | `merge-dev1.0-to-main.yml` | 07. Merge dev1.0 To Main；branch_strategy.md | ✅ |
