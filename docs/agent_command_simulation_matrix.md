...
| `/design` | “给出架构设计并冻结方案” | 在 AppRoot/L1/L2 层设计，不给 Story 新增 design | 对齐 metadata、回滚、观测、三层测试 | `.cursor/commands/design.md`、相关 `design.md` | Story 层建 design、绕过 metadata、缺回滚 | 设计边界、依赖、数据流、观测、回滚、测试矩阵 | `bash agent_ops/scaffold/verify_specs_l1_hierarchy.sh` |
