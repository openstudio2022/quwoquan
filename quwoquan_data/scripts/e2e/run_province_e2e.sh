...
python3 quwoquan_data/scripts/verify/verify_geo_catalog_quality.py --catalog "$FULL_CATALOG" --report "$SLICE_REPORT"
python3 quwoquan_data/scripts/verify/verify_catalog_entity_consistency.py --catalog "$FULL_CATALOG"
