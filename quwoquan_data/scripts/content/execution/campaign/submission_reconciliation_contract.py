...
def load_submission_reconciliation_receipt(
    ...
    *,
    ...
    if (
        ...
        == "quwoquan_data.campaign_failed_execution_reconciliation_receipt"
    ):
        from content.execution.campaign.failed_execution_reconciliation import (
            validate_failed_campaign_reconciliation_receipt,
        )

        return validate_failed_campaign_reconciliation_receipt(
            receipt_path,
            output_root=resolved_output,
        )
    from content.execution.campaign.submission_reconciliation_verify import (
        validate_receipt_document,
        verify_frozen_receipt_evidence,
    )
