...
def _sha256(payload: dict[str, Any]) -> str:
    from content.execution.campaign.submission_identity import _sha256 as implementation
...
def _git_branch(repo_root: Path) -> str:
    from content.execution.campaign.submission_identity import (
        _git_branch as implementation,
    )

    return implementation(repo_root)


def _require_stable_source_inputs(*args: Any, **kwargs: Any) -> None:
    from content.execution.campaign.submission_identity import (
        _require_stable_source_inputs as implementation,
    )
...
def _assert_no_cross_campaign_collision(*args: Any, **kwargs: Any) -> None:
    from content.execution.campaign.submission_identity import (
        _assert_no_cross_campaign_collision as implementation,
    )
...
def write_submission(
    *,
    ...
    if (
        ...
        and campaign_envelope.get("m100AlphaAcceptance") is not None
    ):
