    ...
    def _write(self, **changes: object) -> dict[str, Any]:
        with self._mutex:
            ...
            payload = {
                ...
                "sliceCount": previous.get("sliceCount"),
                "resumeCount": previous.get("resumeCount"),
                "elapsedSeconds": previous.get("elapsedSeconds"),
                "maxRssBytes": previous.get("maxRssBytes"),
                "lastExecutionHeartbeatAt": previous.get(
                    "lastExecutionHeartbeatAt"
                ),
                "heartbeatAgeSeconds": previous.get("heartbeatAgeSeconds"),
                "terminationOwner": previous.get("terminationOwner"),
                "terminationSignal": previous.get("terminationSignal"),
    ...
    def lane_checkpoint(
        ...
        *,
        ...
        if return_code is not None:
            changes["returnCode"] = return_code
        changes.update(process_evidence or {})
        self._write(
            **changes,
        )
        return self.path
