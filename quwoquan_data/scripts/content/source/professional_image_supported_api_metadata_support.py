"""Storage and provider-response projection for supported image metadata."""
...
from content.source.professional_image_openverse_contract import openverse_metadata
