            ...
            row: dict[str, Any] = (
                {
                    ...
                    "publishMediaMode": src.get("publishMediaMode") or "",
                    ...
                    "articleCommercialAdmission": src.get("articleCommercialAdmission") or "",
                    "articleSiteId": src.get("articleSiteId") or "",
                    "sourceDiscoveryProfileDigest": src.get("sourceDiscoveryProfileDigest") or "",
                    "researchLane": lane,
