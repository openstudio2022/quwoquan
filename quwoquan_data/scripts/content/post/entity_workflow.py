...
from content.post.evidence_bundle import gate_route_evidence_bundle, public_byline_label
...
from content.post.writing_pack import build_writing_pack, render_prompt_md
from content.post.route_analysis import analyze_route_ref
from content.post.route_assets import _build_route_assets
from content.post.route_compose import _attach_base_draft_text
from content.post.route_core import (
...
from content.post.route_review import (
    _load_source_texts,
    _persisted_review_payload,
)
from content.post.route_review_checks import (
...
def review_entity_draft(
    ...
    if carrier != "image" and base_source_ref:
        from content.post.base_draft import sibling_source_texts
