...
from content.post.route_core import _article_without_assets_allowed
...
def _build_route_assets(
    ...
    execution_sequence = int(brief.get("executionSequence") or manifest.get("executionSequence") or 0)
