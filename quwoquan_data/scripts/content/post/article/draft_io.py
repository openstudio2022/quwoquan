...
def draft_package_dir(execution_id: str, ref: str) -> Path:
    ...
    if obj is None:
        raise KeyError(f"draft package not registered for ref={ref!r} (execution={execution_id})")
    return obj
...
def brief_package_dir(execution_id: str, ref: str) -> Path:
    ...
    if obj is None:
        raise KeyError(f"brief package not registered for ref={ref!r} (execution={execution_id})")
    return obj
