...
from content.post.base_draft import ARTICLE_MIN_BASE_DRAFT_CHARS, base_draft_readiness, load_base_draft_text
...
def validate_content_plan(execution_id: str, spec: Mapping[str, Any]) -> list[str]:
    ...
    if want_entity or want_route or want_images:
    ...
    for target, buckets in per_entity.items():
        ...
        if per_target_articles:
            if len(articles) > per_target_articles:
                ...
                len(articles) < per_target_articles
