...
from _common.creator_assignment import creator_assignment_issues
...
def enqueue_ref_job(
    ...
    *,
    ...
    显式重跑必须走 requeue_refs / spillover 等带审计语义的路径。
    """
    ...
    if stage == "author" and content_type_for_creator in {"article", "image", "video", "gallery"}:
        creator_issues = creator_assignment_issues(
            raw_meta,
            carrier="image" if content_type_for_creator == "gallery" else content_type_for_creator,
