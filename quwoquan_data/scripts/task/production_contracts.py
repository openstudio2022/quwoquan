...
def validate_agent_result_envelope(
    ...
    *,
    ...
    for key in ("jobId", "taskId", "batchId", "ref", "stage"):
...
def build_agent_result_envelope(
    *,
    ...
    payload = {
        ...
        "ref": job.get("ref"),
        "stage": job.get("stage"),
        "agent": {"agentId": agent_id, "runId": run_id},
...
def validate_token_ledger_entry(entry: Mapping[str, Any]) -> list[str]:
    ...
    for key in ("supplyTaskId", "batchId", "jobId", "creatorProfileId", "contentType"):
