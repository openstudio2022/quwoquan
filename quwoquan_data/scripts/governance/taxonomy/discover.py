...
输出: .qwq_output/data/local/workspace/taxonomy/candidates.ndjson

用法:
  python3 quwoquan_data/scripts/cli.py governance taxonomy discover
  python3 quwoquan_data/scripts/cli.py governance taxonomy discover --dry-run
"""
