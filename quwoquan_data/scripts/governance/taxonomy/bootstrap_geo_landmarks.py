...
用法:
  python3 quwoquan_data/scripts/cli.py governance taxonomy bootstrap-geo-landmarks
  python3 quwoquan_data/scripts/cli.py governance taxonomy bootstrap-geo-landmarks --dry-run
"""
...
TAGS_ROOT = CONTROL_PLANE_TAXONOMY_ROOT / "Topic" / "地理" / "地形地貌"
