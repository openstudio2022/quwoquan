...
用法:
  python3 quwoquan_data/scripts/cli.py governance taxonomy bootstrap-event-topics
  python3 quwoquan_data/scripts/cli.py governance taxonomy bootstrap-event-topics --dry-run
"""
...
EVENT_CANONICAL_ROOT = CONTROL_PLANE_TAXONOMY_ROOT / "Topic" / "事件"
TOPIC_CANONICAL_ROOT = CONTROL_PLANE_TAXONOMY_ROOT / "Topic" / "话题"
