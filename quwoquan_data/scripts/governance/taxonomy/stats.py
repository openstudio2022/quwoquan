...
用法:
  python3 quwoquan_data/scripts/cli.py governance taxonomy stats
  python3 quwoquan_data/scripts/cli.py governance taxonomy stats --json
  python3 quwoquan_data/scripts/cli.py governance taxonomy stats --group Topic
"""
