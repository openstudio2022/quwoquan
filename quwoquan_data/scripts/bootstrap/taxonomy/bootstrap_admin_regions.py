...
用法:
  python3 scripts/bootstrap/taxonomy/bootstrap_admin_regions.py                      # 全量生成
  python3 scripts/bootstrap/taxonomy/bootstrap_admin_regions.py --country 中国        # 只生成中国
  python3 scripts/bootstrap/taxonomy/bootstrap_admin_regions.py --province 四川省     # 只补全四川省
  python3 scripts/bootstrap/taxonomy/bootstrap_admin_regions.py --dry-run             # 仅统计
  python3 scripts/bootstrap/taxonomy/bootstrap_admin_regions.py --stats               # 只打印数据源统计
