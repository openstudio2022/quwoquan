...
用法:
  python3 scripts/bootstrap/taxonomy/bootstrap_tags.py              # 全量生成
  python3 scripts/bootstrap/taxonomy/bootstrap_tags.py --dry-run    # 仅统计不写盘
  python3 scripts/bootstrap/taxonomy/bootstrap_tags.py --group Topic  # 只生成某个分组
"""
...
from bootstrap_tags_topic import configure_writers as _configure_topic_writers, gen_topic
from bootstrap_tags_audience import configure_writers as _configure_audience_writers, gen_audience
from bootstrap_tags_format import configure_writers as _configure_format_writers, gen_format
from bootstrap_tags_entity import configure_writers as _configure_entity_writers, gen_entity
