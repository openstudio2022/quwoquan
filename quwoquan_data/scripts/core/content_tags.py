...
def resolved_content_tag_refs(brief: Mapping[str, Any], carrier: str) -> list[str]:
    ...
    defaults_by_carrier = {
        "article": ["Topic/旅行/玩法/观光游览", "Format/内容角度/攻略"],
        "image": ["Topic/旅行/玩法/摄影旅拍", "Format/内容载体/图文/图集"],
        "video": ["Topic/旅行/玩法/摄影旅拍", "Format/内容载体/视频/短视频"],
    }
    defaults = defaults_by_carrier[carrier]
