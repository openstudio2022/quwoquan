...
REQUIRED_PATHS = [
    ...
    DATA_ROOT / "tests/local_contract/creator_pool/test_creator_commercial_readiness.py",
    DATA_ROOT / "tests/local_contract/creator_pool/test_creator_content_workflow_smoke.py",
    ...
    DATA_ROOT / "tests/local_contract/creator_pool/test_creator_bundle_schema.py",
    DATA_ROOT / "tests/local_contract/creator_pool/test_creator_pool_workflow_contract.py",
    DATA_ROOT / "tests/local_contract/creator_pool/test_creator_scale10_fixtures.py",
    DATA_ROOT / "tests/local_contract/creator_pool/test_creator_readiness_gate.py",
    DATA_ROOT / "tests/local_contract/creator_pool/test_creator_content_bind_smoke.py",
    DATA_ROOT / "tests/local_contract/creator_pool/test_creator_registry_bridge.py",
    DATA_ROOT / "tests/local_contract/creator_pool/test_creator_persona_content_match.py",
    DATA_ROOT / "tests/local_contract/creator_pool/test_creator_relations_consumer.py",
    DATA_ROOT / "tests/local_contract/creator_pool/test_creator_content_bind.py",
    ...
    REPO_ROOT / "specs/feature-tree/runtime/runtime-data-engineering/system-creator-pool/design.md",
