...
REQUIRED_PATHS = [
    ...
    DATA_ROOT / "scripts/_common/creator_pool/source_registry.py",
    DATA_ROOT / "verticals/creator_pool/sources/source_registry.yaml",
    ...
    DATA_ROOT / "tests/local_contract/creator_pool/test_creator_source_registry__local_contract_test.py",
    DATA_ROOT / "tests/local_contract/creator_pool/test_creator_live_travel_photography_pool__local_contract_test.py",
    DATA_ROOT / "tests/local_contract/creator_pool/test_creator_profile_import_1k__local_contract_test.py",
    ...
    DATA_ROOT / "tests/local_contract/publish/test_publish_creators_1k__local_contract_test.py",
    ...
    DATA_ROOT / "scripts/governance/creator_pool/publish_creators.py",
    DATA_ROOT / "scripts/governance/user_pool/handler.py",
    DATA_ROOT / "scripts/governance/user_pool/media_presets.py",
    DATA_ROOT / "scripts/governance/user_pool/rebuild_prefab_users.py",
    SERVICE_ROOT / "contracts/metadata/_shared/test_fixtures/creator_pool/creator_content.travel_photo_1k_v1.seed.json",
