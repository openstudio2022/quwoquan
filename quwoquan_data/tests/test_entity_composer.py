...
可直接运行：python3 quwoquan_data/tests/test_entity_composer.py
"""
...
from _common.draft_io import drafts_dir, read_writing_pack, write_agent_draft  # noqa: E402
...
from agent_draft_kit import entity_article  # noqa: E402
...
def _seed_sources() -> None:
    ...
    (src_dir / "source.md").write_text(SOURCE_TEXT, encoding="utf-8")
    write_json(
    ...
    for k in range(3):
        _clean_image(images_dir / f"{ENTITY}_{k}.jpg", seed=k + 1)
