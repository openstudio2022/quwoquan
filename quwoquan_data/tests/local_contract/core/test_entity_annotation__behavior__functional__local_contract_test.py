...
可直接运行：python3 quwoquan_data/tests/local_contract/core/test_entity_annotation__behavior__functional__local_contract_test.py
"""
...
from content.review.annotation.entity_annotation import (  # noqa: E402
    annotate_inline,
...
def _seed_homepage(name: str, domain: str = "地点", etype: str = "景区") -> None:
    ...
    page = execution_entity_object_dir(TASK, domain, etype, name) / "page.md"
