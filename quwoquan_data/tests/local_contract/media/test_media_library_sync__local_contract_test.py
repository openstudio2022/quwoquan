...
from _common.media_asset_url import resolve_media_cdn_bases  # noqa: E402
from _common.media_library_sync import sync_media_library  # noqa: E402
...
class TestResolveMediaCdnBases:
    ...
    def test_resolves_gamma_bases_from_manifest(self, tmp_path: Path) -> None:
        ...
        assert image == "https://gamma-image.quwoquan-env.test:19100"
        assert video == "https://gamma-video.quwoquan-env.test:19100"
