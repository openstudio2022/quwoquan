...
可直接运行：python3 quwoquan_data/tests/local_contract/task/test_task_cli__local_contract_test.py
"""
...
def _retarget_roots() -> None:
    ...
    os.environ["QWQ_RUNTIME_ROOT"] = str(_TMP / "runtime")
    os.environ["QWQ_PUBLISH_ROOT"] = str(_TMP / "publish")
    _paths_mod.COMMITTED_TASKS_ROOT = _TMP / "tasks"
    ...
    PUBLISH_ROOT = _paths_mod.PUBLISH_ROOT
