...
可直接运行：python3 quwoquan_data/tests/local_contract/post/test_mixed_layout_gate__behavior__functional__local_contract_test.py
"""
...
from content.post.article.route_review_checks import _check_mixed_layout  # noqa: E402
