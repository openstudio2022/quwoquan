...
def test_governance_schemas_are_valid_json_and_freeze_status_vocabulary() -> None:
    expected = {
        ...
        "canonical_gc_apply.schema.json",
        "canonical_gc_execution_tombstone.schema.json",
        "canonical_gc_plan.schema.json",
        "canonical_gc_reference_graph.schema.json",
        "canonical_gc_tombstone_backfill.schema.json",
        ...
        "data_workstream_baseline.schema.json",
        "discovery_checkpoint.schema.json",
        "master_list.schema.json",
        "protected_quarantine_evidence.schema.json",
        "review.schema.json",
