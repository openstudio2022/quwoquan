"""主页商用质量硬门合同（P2 重建 + M1 污染样本回归夹具）。

夹具取自 M1 实测 P0 逃逸样本的特征片段：
...
# ---------------------------------------------------------------------------
# 夹具：M1 污染样本特征片段（罗泉古镇 360 百科壳 + infobox 键值堆）
# ---------------------------------------------------------------------------
_LUOQUAN_POLLUTED = """---
...
罗泉镇，位于资中城北约50公里，地处资中、仁寿、威远三县交界地区，1992年已被批准为四川省首批历史文化名镇。
...
示例景区位于浙江省杭州市西湖区，是集山水风光与人文历史于一体的国家级风景名胜区，全年适宜游览，尤以春秋两季景色最佳，是杭州周边周末出行的热门选择。
