...
from core.image_safety import STATUS_UNSAFE, assess_image  # noqa: E402
from content.homepage.assets.repair import repair_homepage, scan_homepages  # noqa: E402


def _retarget_roots() -> None:
    os.environ["QWQ_DATA_ROOT"] = str(_TMP)
    os.environ["QWQ_OUTPUT_ROOT"] = str(_TMP)
    os.environ["QWQ_PUBLISH_ROOT"] = str(_TMP / "publish")
    _paths_mod.DATA_ROOT = _TMP
    _paths_mod.DATA_EXECUTIONS_ROOT = _TMP / "data/tasks"
