...
from local_contract.release.test_release_header__typed_identity__contract__local_contract_test import _header
...
class ReleaseConsistencyFileEntryContractTest(unittest.TestCase):
    def test_payload_located_desired_state_derives_release_root_from_payload_parent(
        ...
        with TemporaryDirectory() as temporary:
            ...
            artifacts = {
                "release.json": _header(release_id="release-consistency-entry-fixture"),
                "media_manifest.json": {
