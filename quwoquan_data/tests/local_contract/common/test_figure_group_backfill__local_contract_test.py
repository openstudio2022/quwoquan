...
唯一真相源 `_common/figure_groups.py`。覆盖：
...
可直接运行：python3 quwoquan_data/tests/local_contract/common/test_figure_group_backfill__local_contract_test.py
"""
...
from _common.figure_groups import (  # noqa: E402
...
def test_clean_source_markdown_preserves_figure_fences():
    ...
    from _common.content_evidence import clean_source_markdown
