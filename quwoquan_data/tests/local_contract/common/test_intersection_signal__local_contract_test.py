...
可直接运行：python3 quwoquan_data/tests/local_contract/common/test_intersection_signal__local_contract_test.py
"""
...
def _seed_and_materialize() -> Path:
    ...
    register_content_object(task, batch, ref, content_type="article", angle="攻略", title="九寨沟看水攻略")
