...
可直接运行：python3 quwoquan_data/tests/local_contract/common/test_soft_gate_unification__local_contract_test.py
"""
...
os.environ.setdefault("QWQ_RUNTIME_ROOT", tempfile.mkdtemp(prefix="soft_gate_rt_"))

from _common import quality_gates as qg  # noqa: E402
from _common import base_draft  # noqa: E402
from produce import route_core  # noqa: E402
