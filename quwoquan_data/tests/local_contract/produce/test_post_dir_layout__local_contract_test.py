...
可直接运行：python3 quwoquan_data/tests/local_contract/produce/test_post_dir_layout__local_contract_test.py
"""
...
_RUNTIME_ROOT = Path(tempfile.mkdtemp(prefix="post_dir_layout_rt_"))
_PUBLISH_ROOT = Path(tempfile.mkdtemp(prefix="post_dir_layout_publish_"))
...
os.environ["QWQ_PUBLISH_ROOT"] = str(_PUBLISH_ROOT)
...
def _retarget_roots() -> None:
    ...
    _paths_mod.PUBLISH_ROOT = _PUBLISH_ROOT
