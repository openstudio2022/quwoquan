...
from core.qunar_template import (  # noqa: E402
...
from content.source.research import wiki_media as wiki_media_mod  # noqa: E402
...
def test_verified_homepage_reuse_filters_bad_or_thin_source_units():
    ...
    write_source_unit(
        obj,
        ordinal=2,
        source_id="home_baidu_thin",
        source_md="沙湖旅游景区位于宁夏，是一个景区简介页面。",
        quality={"sourceId": "home_baidu_thin", "quality": "B-fact", "score": 6, "url": "https://baike.baidu.com/item/沙湖旅游景区"},
        platform="百度百科",
        source_category="encyclopedia",
    ...
    write_source_unit(
        ...
        quality={"sourceId": "home_toutiao", "quality": "B-fact", "score": 6, "url": "https://www.baike.com/wiki/沙湖旅游景区"},
        platform="今日头条百科",
        source_category="encyclopedia",
    ...
    assert [source["source_id"] for source in sources] == ["home_toutiao"]
...
def test_verified_homepage_reuse_hydrates_mediawiki_same_source_images():
    ...
    original = wiki_media_mod._mediawiki_page_images
    wiki_media_mod._mediawiki_page_images = (
    ...
    try:
        ...
        wiki_media_mod._mediawiki_page_images = original
