...
def test_travel_lanes_record_bad_image_license_without_blocking_acquisition():
    assert license_allows_commercial_distribution(
        "CC0",
        "http://creativecommons.org/publicdomain/zero/1.0/deed.en",
    )
    assert not license_allows_commercial_distribution(
        "CC BY-SA 1.0",
