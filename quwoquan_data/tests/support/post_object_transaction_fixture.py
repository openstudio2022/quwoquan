...
def _fixture(
        ...
        "targets": [
            {
                "name": "西湖",
                "entityType": "地点/景区",
                "entityRef": "/entity/travel/test/entity-bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb",
    ...
    _write_json(
        post / "manifest.json",
        {
            ...
            "entityRefs": ["/entity/travel/test/entity-bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb"],
