...
def test_post_publishability_discard_image_not_blocking():
    ledger = ReviewLedger(
        executionId="20260711--travel-article-review--cn-sichuan--canary-001", ref="稻城亚丁_体验",
...
def test_post_publishability_blocked_by_fix_image():
    ledger = ReviewLedger(
        executionId="20260711--travel-article-review--cn-sichuan--canary-002", ref="r",
        article=ReviewItem(kind=KIND_ARTICLE, target="article", agentJudgment=JUDGE_CREDIBLE, agentScore=4),
...
def test_roundtrip_serialization():
    led = ReviewLedger(
        executionId="20260711--travel-article-review--cn-sichuan--canary-003", ref="r",
