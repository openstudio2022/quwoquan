...
可直接运行：python3 quwoquan_data/tests/user_acceptance/integration/test_verify_pilot_gwt__user_acceptance_test.py
"""
...
def test_pilot_e2e_verify_green():
    ...
    write_batch_manifest(TASK, BATCH, command="produce", content_type="article")
