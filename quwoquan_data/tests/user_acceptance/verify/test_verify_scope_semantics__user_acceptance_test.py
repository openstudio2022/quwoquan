...
- data/local/runtime/tasks/**/batches/** 中间产物不进批量审计（由 produce review 门禁把关）；
- 但显式 --task/--batch 仍精确校验该中间批次，门禁不放水。

可直接运行：python3 quwoquan_data/tests/user_acceptance/verify/test_verify_scope_semantics__user_acceptance_test.py
"""
