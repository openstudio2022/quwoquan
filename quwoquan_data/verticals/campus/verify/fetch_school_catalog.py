...
.qwq_output/data/local/workspace/seed/school_catalog/。
...
用法:
  python3 verticals/campus/verify/fetch_school_catalog.py                    # 全量采集
  python3 verticals/campus/verify/fetch_school_catalog.py --source moe       # 只采集教育部高校
  python3 verticals/campus/verify/fetch_school_catalog.py --source beijing    # 只采集北京
  python3 verticals/campus/verify/fetch_school_catalog.py --source shanghai   # 只采集上海
  python3 verticals/campus/verify/fetch_school_catalog.py --verify-only       # 仅验证现有文件
"""
...
def main():
    ...
    print("如需更新，请替换 .qwq_output/data/local/workspace/seed/school_catalog/*.ndjson 并重新生成 source_manifest.json")
