...
检查项：
  ...
  E5 - 所有 tagRefs 在 control-plane taxonomy 中可解析
  E6 - page.md >= 300 字
  E7 - page.md 无旧式 /tag/主题/ 路径
  E8 - 无目录名冲突

用法:
  python3 verticals/campus/verify/verify_school_entities.py
"""
...
from core.paths import CONTROL_PLANE_TAXONOMY_ROOT, PUBLISH_ROOT, RUNTIME_ROOT
