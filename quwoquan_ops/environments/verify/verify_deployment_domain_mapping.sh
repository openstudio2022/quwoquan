...
ruby -ryaml -e '
  root = Dir.pwd
  file = File.join(root, "quwoquan_ops/environments/process_domain_mapping.yaml")
  abort("[verify] FAIL: missing quwoquan_ops/environments/process_domain_mapping.yaml") unless File.exist?(file)
...
ruby -ryaml -e '
  root = Dir.pwd
  file = File.join(root, "quwoquan_ops/environments/process_domain_plane_mapping.yaml")
  abort("[verify] FAIL: missing quwoquan_ops/environments/process_domain_plane_mapping.yaml") unless File.exist?(file)
