...
真相源：
  - quwoquan_ops/environments/environment_topology_manifest.yaml  (环境/target 暴露面与平面)
  - quwoquan_service/services/seed-box/deploy/kustomize/base/deployment.yaml      (数据面 DSN 变量经 secret 注入)
  - quwoquan_service/services/seed-box/deploy/kustomize/overlays/prod/kustomization.yaml (prod overlay 仅改环境无关参数)
...
ETM = ROOT / "quwoquan_ops/environments/environment_topology_manifest.yaml"
SEED_DEPLOY = ROOT / "quwoquan_service/services/seed-box/deploy/kustomize/base/deployment.yaml"
SEED_PROD = ROOT / "quwoquan_service/services/seed-box/deploy/kustomize/overlays/prod/kustomization.yaml"
