...
def prune_seed_payload(relative_path: str, payload: dict[str, Any]) -> dict[str, Any]:
    ...
    if relative_path == "quwoquan_service/services/content-service/tests/support/contract_fixtures/scenarios/content_scenarios.json":
    ...
    if relative_path == "quwoquan_service/services/user-service/tests/support/contract_fixtures/scenarios/user_scenarios.json":
    ...
    if relative_path == "quwoquan_service/services/circle-service/tests/support/contract_fixtures/scenarios/circle_scenarios.json":
        ...
        profile_seed["impacts"] = {
            key: value
            for key, value in (profile_seed.get("impacts") or {}).items()
            if key in LITE_CIRCLE_IDS
        }

    if relative_path == "quwoquan_service/services/chat-service/tests/support/contract_fixtures/scenarios/chat_scenarios.json":
