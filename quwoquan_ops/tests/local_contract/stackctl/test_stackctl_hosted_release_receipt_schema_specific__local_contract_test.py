...
def _receipt() -> dict[str, object]:
    request: dict[str, object] = {
        ...
        "stage": "100",
        "triggerStage": "100",
        "fromServiceFactoryOciDigest": _digest("a"),
        "toServiceFactoryOciDigest": _digest("b"),
        ...
        "candidateMaterialId": _digest("5"),
        "prodActivationAdmissionRef": "ghcr.io/owner/prod-activation-admission@" + _digest("6"),
        "prodActivationAdmissionOciDigest": _digest("6"),
        "prodActivationAdmissionPayloadDigest": _digest("6"),
        "prodActivationAdmissionId": _digest("6"),
        "candidateMaterialManifestRef": "ghcr.io/owner/candidate-material@" + _digest("7"),
        "candidateMaterialManifestOciDigest": _digest("7"),
        "candidateMaterialManifestPayloadDigest": _digest("7"),
        "previousReleasedRef": "ghcr.io/owner/released-prod@" + _digest("e"),
        "previousReleasedOciDigest": _digest("e"),
        "previousReleasedPayloadDigest": _digest("e"),
        "previousReleasedId": _digest("f"),
