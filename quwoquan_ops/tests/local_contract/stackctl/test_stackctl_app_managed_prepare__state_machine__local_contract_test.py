"""stackctl app-managed-prepare lease and preparation state-machine contracts.

Mechanically split from test_stackctl_app_managed_prepare__local_contract_test.py.
"""
