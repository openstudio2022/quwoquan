...
MAX_RUNNER_JOB_TIMEOUT_MINUTES = 60
    ...
    def test_every_runner_job_has_a_bounded_hard_timeout(self) -> None:
        for relative in WORKFLOWS:
            ...
            for job_name, job in jobs.items():
                ...
                # App/Service integration jobs intentionally have 20-60 minute
                # hard guards; the former blanket 10 minute assertion directly
                # contradicted their reviewed, job-level timeout contracts. The
                # global ceiling remains finite and does not relax any job timeout.
