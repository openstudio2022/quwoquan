...
"""Execute the local-recorder PushDeliveryPort native contract suite."""
...
TARGET = "push-local-recorder-local-contract"
COMMAND = (
    "go",
    "-C",
    "quwoquan_service",
