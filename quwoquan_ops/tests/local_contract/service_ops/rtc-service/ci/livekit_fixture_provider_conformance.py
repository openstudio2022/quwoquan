# provider_conformance: {"adapterId":"infra.livekit_protocol_fixture","capabilityId":"rtc.room.transport","testLayer":"local_contract","typedPort":"MediaTransportPort","contractRef":"quwoquan_service/services/rtc-service/contracts/rtc/call_session/operations.yaml","assertionIds":["provider.success","provider.validation","provider.auth","provider.network_dns","provider.timeout","provider.throttle","provider.retry","provider.idempotency","provider.callback_ordering","provider.redaction","provider.observability","provider.rtc_transport"],"command":["python3","quwoquan_ops/tests/local_contract/service_ops/rtc-service/ci/livekit_fixture_provider_conformance.py"],"target":"livekit-fixture-local-contract","networkBoundary":"offline_harness"}
...
"""Execute the LiveKit protocol-fixture MediaTransportPort contracts."""
...
TARGET = "livekit-fixture-local-contract"
COMMAND = (
    "go",
    "-C",
    "quwoquan_service",
