# provider_conformance: {"adapterId":"ext.search.duckduckgo_html","capabilityId":"assistant.public.search","testLayer":"local_contract","typedPort":"PublicSearchPort","contractRef":"quwoquan_service/services/assistant-service/contracts/assistant/assistant_session/operations.yaml","assertionIds":["provider.auth","provider.callback_ordering","provider.idempotency","provider.network_dns","provider.observability","provider.redaction","provider.retry","provider.success","provider.throttle","provider.timeout","provider.validation","provider.public_search"],"command":["python3","quwoquan_ops/tests/local_contract/service_ops/assistant-service/ci/ext_search_duckduckgo_html_provider_conformance.py"],"target":"ext-search-duckduckgo_html-local-contract","networkBoundary":"offline_harness"}
