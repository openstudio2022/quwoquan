# provider_conformance: {"adapterId":"ext.llm.protocol_fixture","capabilityId":"assistant.model.generation","testLayer":"local_contract","typedPort":"ModelCompletionPort","contractRef":"quwoquan_service/services/assistant-service/contracts/assistant/assistant_conversation/operations.yaml","assertionIds":["provider.auth","provider.callback_ordering","provider.idempotency","provider.network_dns","provider.observability","provider.redaction","provider.retry","provider.success","provider.throttle","provider.timeout","provider.validation","provider.model_generation"],"command":["python3","quwoquan_ops/tests/local_contract/service_ops/assistant-service/ci/ext_llm_protocol_fixture_provider_conformance.py"],"target":"ext-llm-protocol_fixture-local-contract","networkBoundary":"offline_harness"}
