...
def main() -> int:
    if not os.environ.get(RESULT_PATH_ENV):
        return 1
    return run_prod_remote_uat.run("rtc.room.transport", "infra.livekit_sfu")
