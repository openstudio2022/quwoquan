# provider_conformance: {"adapterId":"ext.obs.elasticsearch","capabilityId":"runtime.log.sink","testLayer":"user_acceptance","typedPort":"ObservabilityLogSinkPort","contractRef":"quwoquan_service/services/product-ops-service/contracts/product_ops/event_record/operations.yaml","assertionIds":["provider.auth","provider.callback_ordering","provider.idempotency","provider.network_dns","provider.observability","provider.redaction","provider.retry","provider.success","provider.throttle","provider.timeout","provider.validation","provider.observability_log_sink"],"command":["python3","quwoquan_ops/tests/acceptance/user_acceptance/service_ops/product-ops-service/ci/ext_obs_elasticsearch_provider_conformance.py"],"target":"ext-obs-elasticsearch-user-acceptance","networkBoundary":"user_journey"}
# spec_ref: specs/feature-tree/runtime/runtime-external-integration/provider-adapter-conformance-suite/spec.md#gwt-001
"""Execute the ext.obs.elasticsearch user_acceptance Provider suite."""
...
TARGET = "ext-obs-elasticsearch-user-acceptance"
COMMAND = (
    "python3",
