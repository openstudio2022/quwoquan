...
COMMAND = ('python3', 'quwoquan_ops/ci/provider_conformance/run_provider_patrol_uat.py', '--target', 'test/user_acceptance/service/user_service/account/authentication_challenge/sms_otp_provider__user_acceptance_test.dart', '--platform', 'all', '--unauthenticated', '--local-capture-otp-broker', '--define-key', 'QWQ_PROVIDER_UAT_SMS_PHONE')
