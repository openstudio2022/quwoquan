# provider_conformance: {"adapterId":"ext.finance.protocol_fixture","capabilityId":"assistant.finance.quote","testLayer":"user_acceptance","typedPort":"FinanceQuotePort","contractRef":"quwoquan_service/services/assistant-service/contracts/assistant/assistant_conversation/operations.yaml","assertionIds":["provider.auth","provider.callback_ordering","provider.idempotency","provider.network_dns","provider.observability","provider.redaction","provider.retry","provider.success","provider.throttle","provider.timeout","provider.validation","provider.finance_quote"],"command":["python3","quwoquan_ops/tests/acceptance/user_acceptance/service_ops/assistant-service/ci/ext_finance_protocol_fixture_provider_conformance.py"],"target":"ext-finance-protocol_fixture-user-acceptance","networkBoundary":"user_journey"}
# spec_ref: specs/feature-tree/runtime/runtime-external-integration/provider-adapter-conformance-suite/spec.md#gwt-002
"""Execute the ext.finance.protocol_fixture production-Remote user journey."""
