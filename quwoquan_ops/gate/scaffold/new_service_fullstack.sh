...
usage() {
  cat <<'EOF'
Usage:
  quwoquan_ops/gate/scaffold/new_service_fullstack.sh --name <service-name> [--port <port>]

Examples:
  quwoquan_ops/gate/scaffold/new_service_fullstack.sh --name user-service --port 18081
  quwoquan_ops/gate/scaffold/new_service_fullstack.sh --name chat-service
