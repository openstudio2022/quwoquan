...
BEHAVIORS_PATH = ROOT / "quwoquan_service/contracts/metadata/content/post/behaviors.yaml"
DART_PATH = (
    ROOT
...
GO_PATH = (
    ROOT
    / "quwoquan_service/services/circle-service/internal/domain/circle/"
    "circle_behavior_fact/model/circle_behavior_fact.go"
)
