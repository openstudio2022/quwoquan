...
void main() {
  ...
  final failures = <String>[
    ...
    ..._reject(
      repoRoot,
      relativePath: 'quwoquan_ops/portal/src/shared/api',
      pattern: RegExp(r'throw new Error|throw Error\('),
      message: 'ops api throws raw Error instead of RuntimeError',
    ),
    ..._reject(
      repoRoot,
      relativePath: 'quwoquan_ops/portal/src/shared/runtime/errors',
      pattern: RegExp(
        r'from\s+["'
        "'"
        r']\./[^"'
    ...
    ..._rejectUnregisteredRuntimeCodes(
      repoRoot,
      relativePath: 'quwoquan_ops/portal/src',
      codePrefix: 'OPS',
    ),
    ..._reject(
      repoRoot,
      relativePath: 'quwoquan_service/contracts/runtime_errors/errors',
    ...
    ..._rejectExistingFiles(
      repoRoot,
      relativePath: 'quwoquan_ops/portal/.test-dist',
...
List<String> _rejectOpsExtensionlessRelativeImports(Directory repoRoot) {
  final root = Directory('${repoRoot.path}/quwoquan_ops/portal/src');
  if (!root.existsSync()) return const <String>[];
  final failures = <String>[];
