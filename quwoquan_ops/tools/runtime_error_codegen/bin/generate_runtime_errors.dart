...
List<String> _validateLanguagePackages(Directory repoRoot) {
  ...
  final dartFailure = File(
    '${repoRoot.path}/quwoquan_service/contracts/runtime_errors/packages/dart/quwoquan_runtime_errors/lib/src/runtime_failure.dart',
  );
  final goFailure = File(
    '${repoRoot.path}/quwoquan_service/runtime/failures/failure.go',
  );
  final tsFailure = File(
    '${repoRoot.path}/quwoquan_ops/portal/src/shared/runtime/errors/runtimeFailure.ts',
  );
  final pythonFailure = File(
    '${repoRoot.path}/quwoquan_service/contracts/runtime_errors/packages/python/quwoquan_runtime_errors/quwoquan_runtime_errors/runtime_failure.py',
  );
