...
def commit(root: Path, request: object) -> dict[str, Any]:
    ...
    with _ledger_lock(root):
        ...
        receipt = {
            ...
            "environmentAcceptanceRef": payload["environmentAcceptanceRef"],
            "environmentAcceptanceDigest": payload["environmentAcceptanceDigest"],
            "environmentAcceptanceFactId": payload["environmentAcceptanceFactId"],
            "gammaPredecessorFactId": payload["gammaPredecessorFactId"],
            "gammaPredecessorDigest": payload["gammaPredecessorDigest"],
            "engineeringEligibilityRef": payload["engineeringEligibilityRef"],
            "engineeringEligibilityDigest": payload["engineeringEligibilityDigest"],
            "durableApprovalRef": payload["durableApprovalRef"],
            "durableApprovalDigest": payload["durableApprovalDigest"],
        ...
        state = {
            ...
            "environment_acceptance_ref": payload["environmentAcceptanceRef"],
            "environment_acceptance_digest": payload["environmentAcceptanceDigest"],
            "environment_acceptance_fact_id": payload["environmentAcceptanceFactId"],
            "gamma_predecessor_fact_id": payload["gammaPredecessorFactId"],
            "gamma_predecessor_digest": payload["gammaPredecessorDigest"],
            "engineering_eligibility_ref": payload["engineeringEligibilityRef"],
            "engineering_eligibility_digest": payload["engineeringEligibilityDigest"],
            "durable_approval_ref": payload["durableApprovalRef"],
            "durable_approval_digest": payload["durableApprovalDigest"],
