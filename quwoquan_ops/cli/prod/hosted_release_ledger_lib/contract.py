...
STATE_FIELDS = frozenset(
    {
        ...
        "environment_acceptance_digest",
        "environment_acceptance_fact_id",
        "gamma_predecessor_fact_id",
        "gamma_predecessor_digest",
        "engineering_eligibility_ref",
        "engineering_eligibility_digest",
        "durable_approval_ref",
        "durable_approval_digest",
        "image_digest",
        "config_digest",
