...
from quwoquan_ops.cli.lib.content_release_materialization import (
    materialize_content_release as _materialize_content_release,
)
from quwoquan_ops.cli.lib.content_release_environment._ship_operations import (
...
from quwoquan_ops.cli.lib.content_release_environment.ship_dispatch import dispatch_ship
...
def _operation_dependencies() -> ShipOperationDependencies:
    return ShipOperationDependencies(
        ...
        assert_environment_release_target_unchanged=assert_environment_release_target_unchanged,
        materialize_content_release=_materialize_content_release,
