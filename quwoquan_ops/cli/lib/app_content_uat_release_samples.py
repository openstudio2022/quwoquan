...
def resolve_release_sample_requests(
    *,
    ...
    if any(readiness.get(field) != "production" for field in ("releaseClass", "productLifecycleState")):
        raise ValueError("App content UAT requires production release readiness")
