...
def persistent_lane_admitted_from_policy_bytes(raw: bytes) -> bool:
    ...
    return (
        ...
        and policy.persistent_lane_admission is not None
    )
...
def inspect_admission() -> dict[str, Any]:
    ...
    try:
        ...
        admitted = persistent_lane_admitted_from_policy_bytes(raw)
