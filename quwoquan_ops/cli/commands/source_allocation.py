...
def prepare_gamma_local_redis_acl(target=""):
    ...
    if not source_path.exists():
        if acl.exists() and _required(acl).decode() != previous_layout_acl:
    ...
    elif existing_acl in {previous_layout_acl, runtime_key_acl} or managed_source_acl.fullmatch(existing_acl):
