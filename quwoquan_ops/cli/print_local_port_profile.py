...
ENV_EXPORTS = {
    "alpha-local": {
        ...
        "USER_PORT": "user-service",
        "ENTITY_PORT": "entity-service",
        "SMS_SUBSTITUTE_PORT": "sms-provider-substitute",
        "REC_MODEL_PORT": "recommendation-service",
        "POSTGRES_PORT": "postgres",
        "MONGO_PORT": "mongodb",
        "REDIS_PORT": "redis",
        "OBJECT_STORAGE_EDGE_PORT": "object-storage-edge",
    },
    "beta-local": {
        ...
        "BETA_SMS_SUBSTITUTE_PORT": "sms-provider-substitute",
    ...
    "gamma-local": {
        ...
        "LOCAL_GAMMA_REC_MODEL_PORT": "recommendation-service",
        ...
        "LOCAL_GAMMA_SMS_SUBSTITUTE_PORT": "sms-provider-substitute",
