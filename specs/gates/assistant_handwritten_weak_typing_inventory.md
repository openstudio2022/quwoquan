...
**口径**：与 [`verify_assistant_search_weak_typing_ratchet.py`](../../quwoquan_ops/tests/acceptance/user_acceptance/service_ops/assistant-service/gate/verify_assistant_search_weak_typing_ratchet.py) 一致——`quwoquan_app/lib/assistant/**/*.dart`，排除 `**/assistant/generated/**` 与 `*.g.dart`。
