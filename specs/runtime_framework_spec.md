...
| **助手交互** | AssistantRun、InteractionEvent（满意度/常问类型/偏好风格） | 历史 run 评估 + scorecard | 用户期望模型 + 风格偏好 |
...
│                                                                      │
│ ⑤ 向量检索（RAG）                                                    │
│    历史交互 embedding + 内容 embedding + 知识库                      │
│    → 检索相关记忆和知识增强回答                                      │
│                                                                      │
