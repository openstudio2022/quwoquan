...
| 大众点评 | 围绕地点形成稳定主页与口碑心智、下线后仍保留历史 | 只做本地生活目录 | 适合酒店/餐厅/景点等主页生命周期设计 |
...
- 页面进入 `已下线`
- 保留 URL、历史内容、历史口碑、相关群组
- 搜索和推荐降级

**优点**：能建立长期口碑与历史可信度，不破坏内容和关系。  
**缺点**：需要额外处理下线标识与排序策略。  
...
**优点**：实现简单。  
**缺点**：破坏内容历史和用户信任，不符合点评/主页产品心智。  
**适用条件**：不适合本项目。

**选型决策**：**方案 A**。baseline 不做合并，只做软下线与历史保留。
