...
| 入口 | 位置 | 行为 | Phase |
|------|------|------|-------|
| ① 1v1 聊天详情 AppBar | ChatDetailPage 右上角 📞🎥 | 直接发起 1v1 通话 | P1 |
| ② 群聊详情 AppBar | ChatDetailPage(group) 右上角 📞 | 弹出类型选择+成员勾选 | P2 |
| ③ 联系人/用户资料 | 用户资料页操作栏 | 语音/视频通话按钮 | P1 |
| ④ 圈子详情 | CircleDetailPage 操作栏 | 发起圈子通话，选择成员 | P2 |
| ⑤ 来电推送（被叫） | 系统级 | iOS CallKit / Android FullScreen Intent | P1 |
