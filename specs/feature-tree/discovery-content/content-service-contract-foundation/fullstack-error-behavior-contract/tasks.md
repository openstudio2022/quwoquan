...
- [x] T2.6: Generate `content_behaviors.g.dart` (ContentBehaviorTracker with batch queue)
- [x] T2.7: Generate Python Pydantic ML feature schemas (`content_features.py`, `training_sample.py`)
