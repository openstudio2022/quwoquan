...
- 尚缺验收证据：M1000（`1000/1000/1000/100`）按累计唯一对象形成独立 cohort/release/handoff 的证据；截至 M100 baseline 累计仅 104/103/104/11，视频来源（Commons 可研究用途中文景区视频）是主要缺口。局部 schema/local_contract/静态 gate PASS 不替代此证据。
