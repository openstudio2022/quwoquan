...
- 约束与影响：四复制会话以 plan-frozen campaign run/fence 为共同身份，但各自只持有 carrier-scoped 文件锁与 claim；共享 canonical publish 继续由对象事务锁串行，review/author/download 和 execution evidence 不共享可写根。
