...
### DEC-045 核心诊断是 ship verify 的不可提升用途
...
- 关联要求与验收：[`multi-carrier-release REQ-022`](./multi-carrier-release/spec.md#req-022)、[`GWT-045`](./multi-carrier-release/spec.md#gwt-045)。
