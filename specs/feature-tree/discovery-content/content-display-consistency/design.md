...
<a id="dec-004"></a>
### DEC-004 复用同 actor 分区内核，领域意图与可信确认各归其主
...
<a id="dec-005"></a>
### DEC-005 公共内容、本人互动、命令与统计四条读语义分离
...
<a id="dec-006"></a>
### DEC-006 所有入口由 metadata surface 接入协调器，以 epoch 保护精确刷新
...
- 单轨迁移与回滚遵循 DEC-004/006；source/合同先 verify/codegen，缺新字段客户端走明确升级/拒绝，不保留长期旧 decoder、双写或旧快照反向覆盖。
