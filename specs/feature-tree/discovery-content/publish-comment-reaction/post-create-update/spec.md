...
- 底部缩略条仅在有选中图片时出现，按添加顺序展示；每张缩略图可点叉删除，也可拖动调整顺序。
...
- 视频选择器为全屏深色态：顶部左侧取消、右侧相机入口，上半区提供“现在开拍”预览入口，下半区为“全部视频”圆角面板与三列视频缩略图。
...
- A10：图片创作从相册/拍摄/编辑/完成/发布/展示回读形成无断点链路，且图片路径不再暴露视频成片语义。
