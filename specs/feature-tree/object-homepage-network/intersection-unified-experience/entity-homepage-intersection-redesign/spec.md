...
（当前无开放事项：GWT-001 已由实体主页想去/续接与生成 Remote 读面的真实测试子句级绑定；实体主页「近期行动」区块随一级行动发现入口退役而删除，成行/经历社会证明只以计数形式保留——见 L2 REQ-009 与 `circle-community/gathering-coordination` OPEN-002。）
