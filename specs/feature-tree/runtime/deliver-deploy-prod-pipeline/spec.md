...
- GitHub 只验证不可变证据并承担 RC build/sign/attest、资格归约、正式 tag admission 和 Prod approval/transaction。普通 source push、promotion PR 不得触发 packaging、coverage 全量、设备矩阵、Provider live 或 environment workflow。
