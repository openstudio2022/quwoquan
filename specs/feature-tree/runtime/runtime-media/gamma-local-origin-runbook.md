...
quwoquan_ops/cli/gamma/deploy_gamma_ecs.sh
```
...
- `quwoquan_ops/cli/gamma/deploy_gamma_ecs.sh` 不再上传 `test_fixtures/media` 与 `original_media` 整库。
...
3. 重新执行 `quwoquan_ops/cli/gamma/deploy_gamma_ecs.sh`
