...
- 约束与影响：post 只依赖 canonical entity identity，同一 campaign 的 carrier execution 共享 commit/source/entity-catalog digest 并独立恢复，同一 release 保持环境无关且四环境仅产生独立 activation/import/rollback receipt。
- 关联要求：`REQ-001`
