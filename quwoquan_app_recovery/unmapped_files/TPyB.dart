...
class AppSpacing {
  ...
  static const double fullBorderRadius = 9999.0; // 完全圆角
  
  // 布局高度语义标签
  static const double tabNavigationHeight = 48.0;
  static const double subTabNavigationHeight = 40.0; // 二级导航高度
  static const double bottomNavHeight = 49.0; // Instagram 标准高度（不包括安全区域，SafeArea会自动处理）
  ...
  // 文本显示宽度语义标签
  static const double usernameMinWidth = 90.0; // 用户名最小显示宽度（至少5个字符）
  static const double followButtonWidth = 58.0; // 关注按钮固定宽度（确保"关注"和"已关注"都完整显示）
}
