  ...
  Widget build(BuildContext context) {
    return Consumer(
      builder: (context, ref, child) {
        final globalIsDark = ref.watch(isDarkProvider);
        
        // 检查当前页面是否是HomePage且activeTab是video
        // 这里我们需要从HomePage获取activeTab状态，暂时使用全局主题
        final isDark = globalIsDark;
        ...
        return Scaffold(
          ...
          body: Stack(
            children: [
              ...
              // 我的页面
              MyProfilePage(initialTab: 'all'),
            ],
          ),
          // 状态栏覆盖层，使用次要前景色的半透明覆盖来柔化图标
          Positioned(
            top: 0,
            left: 0,
            right: 0,
              ...
              child: Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    ...
                    colors: [
                      AppColorsFunctional.getColor(isDark, ColorType.foregroundSecondary).withValues(alpha: 0.15), // 使用次要前景色的半透明覆盖
                      Colors.transparent,
                    ],
                  ),
                ),
