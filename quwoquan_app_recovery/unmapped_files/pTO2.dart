        ...
        children: [
          ...
          Positioned(
            ...
            child: Transform.translate(
              offset: Offset(0, -45.h), // 🔑 向上偏移45.h，侵入背景
              child: Container(
                decoration: BoxDecoration(
                ...
                child: CircleAvatar(
                  ...
                  child: CircleAvatar(
                    radius: 42.r,
                    backgroundImage: NetworkImage(_userData!.avatar ?? 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300&h=300&fit=crop&crop=face'),
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            ...
            left: 0,
            right: 0,
            height: _getBackgroundImageHeight(),
            child: Transform.scale(
              scale: _pullOffset > 0 ? 1.0 + (_pullOffset / (_getBackgroundImageHeight() * 2)) : 1.0, // 🔑 拉伸时图像缩放
