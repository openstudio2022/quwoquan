      ...
      builder: (context, ref, child) {
        ...
        return Scaffold(
          ...
          Positioned(
            ...
            child: Container(
              color: isDark 
                ? AppColorsFunctional.getColor(isDark, ColorType.foregroundSecondary).withValues(alpha: 0.3) // 黑夜模式使用次要前景色的半透明覆盖
                : AppColorsFunctional.getColor(isDark, ColorType.foregroundSecondary).withValues(alpha: 0.2), // 白天模式使用次要前景色的半透明覆盖
