        ...
        return AnnotatedRegion<SystemUiOverlayStyle>(
          value: SystemUiOverlayStyle(
            statusBarColor: isDark 
              ? AppColorsFunctional.getColor(isDark, ColorType.backgroundSecondary).withValues(alpha: 0.95) // 在黑夜模式下使用更接近tab字体颜色的背景
              : AppColorsFunctional.getColor(isDark, ColorType.backgroundPrimary).withValues(alpha: 0.1), // 在白天模式下使用轻微透明背景
            statusBarIconBrightness: isDark ? Brightness.light : Brightness.dark,
            statusBarBrightness: isDark ? Brightness.dark : Brightness.light,
            systemNavigationBarColor: Colors.transparent,
            systemNavigationBarIconBrightness: Brightness.dark,
