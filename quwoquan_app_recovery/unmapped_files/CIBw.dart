                ...
                child: Center(
                  child: Row(
                    ...
                    children: [
                      ...
                      SizedBox(width: context.safeGetIntraGroupSpacing(SpacingSize.sm)), // 增加间距
                      ...
                      if (widget.onFollowClick != null) ...[
                        ...
                        GestureDetector(
                          ...
                          child: Container(
                            padding: EdgeInsets.symmetric(
                              horizontal: context.safeGetContainerSpacing(SpacingSize.sm), // 增加水平padding，确保文字完整显示
                              vertical: context.safeGetIntraGroupSpacing(SpacingSize.sm), // 增加垂直padding，使上下间距对称
                            ),
                            decoration: BoxDecoration(
                              color: _isFollowing 
                            ...
                            child: Text(
                              ...
                              style: TextStyle(
                                color: _isFollowing 
                                    ...
                                    : Colors.white,
                                fontSize: AppTypography.sm, // 增大字体，确保文字清晰
