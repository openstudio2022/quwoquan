    ...
    return Positioned(
      ...
      child: NotificationListener<ScrollNotification>(
        ...
        child: CustomScrollView(
          ...
          // 第二个SliverToBoxAdapter：用户信息 + 头像（使用Transform.translate）
          SliverToBoxAdapter(
            child: Container(
              decoration: BoxDecoration(
                color: AppColorsFunctional.getColor(isDark, ColorType.backgroundPrimary),
              ...
              child: Stack(
                ...
                children: [
                  ...
                  // 头像（使用Transform.translate向上偏移，侵入背景图）
                  Positioned(
                    top: 0,
                    left: AppSpacing.md.w,
                    child: Transform.translate(
                      offset: Offset(0, -30.h), // 🔑 向上偏移30.h
                      child: Container(
                        decoration: BoxDecoration(
                          shape: BoxShape.circle,
                          border: Border.all(
          ...
          // 第三个SliverToBoxAdapter：Tab导航 + 网格内容
          SliverToBoxAdapter(
            child: Container(
              color: AppColorsFunctional.getColor(isDark, ColorType.backgroundPrimary),
              child: Column(
