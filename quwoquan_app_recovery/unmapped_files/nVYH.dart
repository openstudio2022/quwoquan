...
import 'package:quwoquan_app/core/design_system/icons/custom_icons.dart';
                ...
                child: Center(
                  child: Row(
                    ...
                    children: [
                      ...
                      Flexible(
                        child: Text(
                          currentPost['displayName'] ?? currentPost['username'] ?? '用户',
                          style: TextStyle(
                            color: Colors.white,
      ...
      children: [
        ...
        Row(
          children: [
            ...
            _buildActionButton(
              context: context,
              icon: _isSaved ? Icons.bookmark : Icons.bookmark_border, // 临时使用，稍后替换为自定义图标
            ...
            _buildActionButton(
              context: context,
              icon: Icons.share, // 临时使用，稍后替换为自定义图标
              customIcon: RepostIcon(
                size: AppSpacing.iconMedium,
