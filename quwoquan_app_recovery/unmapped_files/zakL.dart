      ...
      children: [
        ...
        Row(
          children: [
            ...
            _buildActionButton(
              context: context,
              icon: Icons.chat_bubble_outline_rounded, // 使用圆润的评论图标
            ...
            _buildActionButton(
              context: context,
              icon: _isSaved ? Icons.star_rounded : Icons.star_border_rounded, // 使用星星图标
              count: _savesCount,
              isActive: _isSaved,
              activeColor: Colors.amber,
              onTap: _handleSaveClick,
              iconSize: AppSpacing.iconMedium + 2, // 略微放大平衡视觉
            ),
            ...
            _buildActionButton(
              context: context,
              icon: Icons.reply_outlined, // 翻转后作为转发图标
              count: _sharesCount,
              onTap: _handleShareClick,
              showCount: false, // 分享按钮不显示数字
              isFlipped: true, // 新增翻转参数
            ),
          ],
        ),
      ],
      ...
      children: [
        ...
        Row(
          children: [
            ...
            _buildActionButton(
              context: context,
              icon: Icons.chat_bubble_outline_rounded, // 圆润评论图标
              count: _commentsCount,
              onTap: _handleCommentsClick,
            ),
            ...
            _buildActionButton(
              context: context,
              icon: _isSaved ? Icons.star_rounded : Icons.star_border_rounded, // 星星图标
              count: _savesCount,
              isActive: _isSaved,
              activeColor: Colors.amber,
              onTap: _handleSaveClick,
              iconSize: AppSpacing.iconMedium + 2,
            ),
          ],
        ),
            ...
            child: isFlipped 
              ? Transform.flip(
                  ...
                  child: Icon(
                    ...
                    size: iconSize ?? AppSpacing.iconMedium,
                  ),
                )
              : Icon(
                  icon,
