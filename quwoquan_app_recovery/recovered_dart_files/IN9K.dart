...
class BottomNavigationWidget extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Container(
      height: AppSpacing.bottomNavHeight.h, // 使用响应式高度（Instagram 标准：49pt）
      decoration: BoxDecoration(
        ...
        border: Border(
          top: BorderSide(
            ...
            width: context.safeGetIntraGroupSpacing(SpacingSize.xs) / 4, // 使用语义化边框宽度
          ),
        ),
      ),
      child: Row(
  ...
  Widget _buildChatIcon(bool isSelected, bool isDark) {
    ...
    return SizedBox(
      width: AppSpacing.iconMedium.sp,
      height: AppSpacing.iconMedium.sp,
      child: Stack(
        children: [
          // 第一个聊天气泡（背景）
          Positioned(
            left: 0,
            top: AppSpacing.smallBorderRadius.h,
            child: Icon(
              Icons.chat_bubble_outline,
              size: AppSpacing.iconSmall.sp,
          ...
          Positioned(
            ...
            child: Icon(
              Icons.chat_bubble_outline,
              size: (AppSpacing.iconSmall + 2).sp,
              color: color,
            ),
          ),
        ],
