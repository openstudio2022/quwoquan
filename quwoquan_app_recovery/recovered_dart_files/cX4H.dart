          ...
          return GestureDetector(
            ...
            child: Container(
              padding: EdgeInsets.symmetric(
                ...
                vertical: 2.h, // 保持垂直padding，让文字有适当间距
              ),
              ...
              child: Stack(
                ...
                children: [
                  ...
                  // 使用业界推荐间距（Material Design标准：距离文字底部约4-6px，下划线高度3px）
                  if (isActive)
                    Positioned(
                      bottom: 0, // 下划线紧贴Stack底部（即Container底部减去vertical padding）
                      left: 0,
                      right: 0,
                      child: Padding(
                        padding: EdgeInsets.only(bottom: 2.h), // 距离Stack底部2px，加上Container的vertical padding 2.h，总间距约4px
                        child: Center(
                          child: Container(
