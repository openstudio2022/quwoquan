...
class _ImageCategoryTabsState extends ConsumerState<ImageCategoryTabs> {
  ...
  Widget build(BuildContext context) {
    ...
    final backgroundColor = AppColorsFunctional.getColor(isDark, ColorType.backgroundPrimary);
    // 使用中性色作为选中状态，不使用主色调
    final selectedBackgroundColor = AppColorsFunctional.getColor(isDark, ColorType.backgroundSecondary);
    final selectedTextColor = AppColorsFunctional.getColor(isDark, ColorType.foregroundPrimary);
    final unselectedTextColor = AppColorsFunctional.getColor(isDark, ColorType.foregroundTertiary);
