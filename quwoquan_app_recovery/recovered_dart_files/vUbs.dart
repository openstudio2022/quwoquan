            ...
            child: Container(
              ...
              child: Stack(
                ...
                children: [
                  ...
                  // bottom值越小，下划线越靠近Container底部，与文字的间距越大
                  if (isActive)
                    Positioned(
                      bottom: 0, // 下划线在Stack底部（距离Container底部2px，因为Container有vertical padding 2.h）
                      left: 0,
                      right: 0,
                      child: Padding(
                        padding: EdgeInsets.only(bottom: 1.h), // 额外增加1px间距，让下划线距离Container底部3px，与文字有更大间距
                        child: Center(
                          child: Container(
