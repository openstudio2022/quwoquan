...
class _FeedSectionState extends ConsumerState<FeedSection> {
    ...
    return RefreshIndicator(
      ...
      child: Container(
        ...
        itemBuilder: (context, index) {
          ...
          // 第一个Post与Stories/Tab之间无间距，第二个Post与第一个Post有正常间距，第三个之后的Post间距更小
          ...
          final isSecondPost = (widget.category == 'following' || widget.category == 'recommended') 
              ? index == 2  // 有Stories的Tab，第二个Post索引是2
              : index == 1; // 没有Stories的Tab，第二个Post索引是1
          return _buildPostCard(context, post, isDark, responsive, ref, isFirstPost: isFirstPost, isSecondPost: isSecondPost);
        },
        ),
      ),
    );
  ...
  Widget _buildPostCard(BuildContext context, dynamic post, bool isDark, dynamic responsive, WidgetRef ref, {bool isFirstPost = false, bool isSecondPost = false}) {
    // 根据帖子类型和分类选择合适的卡片组件
    ...
    if (category == 'video') {
      return VideoPostCard(
        ...
        isSecondPost: isSecondPost, // 传递isSecondPost参数
