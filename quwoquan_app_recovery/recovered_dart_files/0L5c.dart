      ...
      builder: (context, ref, child) {
        ...
        return Container(
          margin: EdgeInsets.symmetric(
            ...
            vertical: widget.isFirstPost ? 0 : (widget.isSecondPost ? AppSpacing.postSpacingXs.h : AppSpacing.postSpacingXs.h * 0.5),
            // 占据整个屏幕宽度，移除水平边距
            horizontal: 0,
          ),
      ...
      child: Row(
        children: [
          ...
          _buildInteractionButton(
            ...
            isDark: isDark,
            // 移除iconSize参数，使用默认的AppSpacing.iconMedium
          ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Icon(
          ...
          size: AppSpacing.iconMedium, // 使用语义化图标尺寸
          color: isDark
              ? AppColors.dark.foregroundPrimary
              : AppColors.light.foregroundPrimary,
        ),
