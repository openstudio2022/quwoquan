...
class _MediaPostCardState extends ConsumerState<MediaPostCard> {
  ...
  Widget _buildInteractionToolbar(BuildContext context, bool isDark) {
    ...
    return Padding(
      ...
      child: Row(
        children: [
          // 点赞按钮 - 使用Ionicons的心形图标
          _buildInteractionButton(
            icon: _isLiked ? Ionicons.heart : Ionicons.heart_outline,
            count: _likesCount,
            isActive: _isLiked,
          ...
          // 收藏按钮 - 使用Ionicons的星星图标（圆润饱满）
          _buildInteractionButton(
            icon: _isBookmarked ? Ionicons.star : Ionicons.star_outline,
            count: _savesCount,
  ...
  Widget _buildShareButton(bool isDark) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Icon(
          Ionicons.arrow_redo_outline, // Ionicons的转发箭头，完美对应附件效果
