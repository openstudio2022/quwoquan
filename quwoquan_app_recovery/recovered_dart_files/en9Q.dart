                        ...
                        children: [
                          TextSpan(
                            text: isExpanded ? content : () {
                              ...
                              final fullTextWidth = fullTextPainter.width;
                              ...
                              // 为"全文"和省略号留出空间，少显示一些字符
                              final availableWidth = constraints.maxWidth - fullTextWidth - ellipsisWidth;
                              final truncatedText = content.substring(0, textPainter.getPositionForOffset(
                                Offset(availableWidth, textPainter.height * 2)
                              ).offset);
