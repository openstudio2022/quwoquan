    ...
    return Positioned(
      ...
      child: NotificationListener<ScrollNotification>(
        ...
        child: CustomScrollView(
          ...
          slivers: [
          // 方案B：使用单个Sliver包含整个布局，Tab区域集成在内容区中
          SliverToBoxAdapter(
            child: Builder(
              builder: (context) {
                final double screenQuarter = MediaQuery.of(context).size.height * 0.25;
                ...
                final double backgroundHeight = bgHeight + paddingTop + _pullOffset;
                
                // 计算内容区高度（用户内容 + Tab内容）
                final double userContentHeight = 200.0; // 根据实际内容调整
                final double tabContentHeight = 400.0; // 根据实际Tab内容调整
                final double totalContentHeight = userContentHeight + tabContentHeight;
                final double totalContainerHeight = backgroundHeight + totalContentHeight;
                
                print('=== 方案B布局调试信息 ===');
                print('背景图高度: $backgroundHeight');
                print('用户内容高度: $userContentHeight');
                print('Tab内容高度: $tabContentHeight');
                print('总内容区高度: $totalContentHeight');
                print('总容器高度: $totalContainerHeight');
                print('========================');
                ...
                return Container(
                  ...
                  child: Stack(
                    ...
                    children: [
                      ...
                      // 2. 内容区容器（中层，包含用户内容和Tab）
                      Positioned(
                        top: screenQuarter + _pullOffset,
                        left: 0,
                        right: 0,
                        child: Column(
                          children: [
