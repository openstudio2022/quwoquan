  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Container(
      decoration: BoxDecoration(
        color: isDark
            ? config.style.backgroundColorDark ?? AppColors.dark.backgroundPrimary
            : config.style.backgroundColorLight ?? AppColors.light.backgroundSecondary,
    ...
    return Padding(
      ...
      child: Text(
        ...
        style: TextStyle(
          ...
          color: isDark
              ? config.style.titleColorDark ?? AppColors.dark.foregroundSecondary
              : config.style.titleColorLight ?? AppColors.light.foregroundPrimary,
        ),
      ),
    );
  }
