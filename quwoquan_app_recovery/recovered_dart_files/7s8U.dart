...
/// 用户数据Provider
final userDataProvider = NotifierProvider<UserDataNotifier, AsyncValue<User?>>(() {
  return UserDataNotifier();
});

/// 用户数据Notifier
class UserDataNotifier extends Notifier<AsyncValue<User?>> {
  @override
  AsyncValue<User?> build() {
    return const AsyncValue.loading();
  }

  UserApiService get _userService => ref.read(userServiceProvider);
