...
/// 媒体查看器状态管理器
class MediaViewerNotifier extends Notifier<MediaViewerState> {
  @override
  MediaViewerState build() {
    return const MediaViewerState();
  }
...
/// 媒体查看器状态提供者
final mediaViewerProvider = NotifierProvider<MediaViewerNotifier, MediaViewerState>(() {
