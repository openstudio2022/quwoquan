      ...
      builder: (context, ref, child) {
        ...
        return Scaffold(
          ...
          Positioned(
            ...
            child: Container(
              color: AppColorsFunctional.getColor(isDark, ColorType.backgroundPrimary), // 与主背景色保持一致
              child: AnnotatedRegion<SystemUiOverlayStyle>(
                ...
                child: Container(
                  // 添加半透明覆盖层，让状态栏图标看起来更柔和
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      begin: Alignment.topCenter,
                      end: Alignment.bottomCenter,
                      colors: [
                        AppColorsFunctional.getColor(isDark, ColorType.foregroundSecondary).withValues(alpha: 0.1),
                        Colors.transparent,
                      ],
                    ),
                  ),
