          ...
          children: categories.map((category) {
            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                padding: EdgeInsets.symmetric(
                  horizontal: AppSpacing.md.w, // 从lg改为md，调小水平间距
                  vertical: AppSpacing.xxs.h, // 从xs改为xxs，调小垂直间距
                ),
                       decoration: BoxDecoration(
                         color: isActive
                             ? AppColorsFunctional.getColor(currentIsDark, ColorType.selectionBackground)
                             : Colors.transparent,
                         borderRadius: BorderRadius.circular(AppSpacing.fullBorderRadius.r), // 使用完全圆角，与Figma原型保持一致
                  border: isActive 
                      ? Border.all(
