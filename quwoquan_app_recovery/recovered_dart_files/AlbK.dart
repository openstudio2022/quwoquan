                      ...
                      if (widget.onFollowClick != null) ...[
                        ...
                        Material(
                          ...
                          child: InkWell(
                            ...
                            child: Container(
                              constraints: const BoxConstraints(minWidth: 0), // 允许收缩，避免溢出
                              padding: EdgeInsets.symmetric(
                                horizontal: context.safeGetContainerSpacing(SpacingSize.xs), // 使用较小的padding，更紧凑美观
                                vertical: 4.h, // 使用固定的垂直padding，确保美观对称
                              ),
                              decoration: BoxDecoration(
                                color: _isFollowing 
                                    ? AppColors.overlayDark // 使用半透明黑色背景，更美观
                                    : AppColors.primaryColor,
                                borderRadius: BorderRadius.circular(AppSpacing.borderRadius.r), // 使用语义化圆角
                                border: _isFollowing ? Border.all(
                                  color: Colors.white.withValues(alpha: 0.3), // 已关注状态添加边框，更美观
                                  width: 1,
                                ) : null,
                              ),
                              child: Text(
                                ...
                                style: TextStyle(
                                  color: _isFollowing 
                                      ? Colors.white // 已关注状态使用白色文字，更清晰
                                      : Colors.white,
                                  fontSize: AppTypography.xs, // 使用较小字体，确保不溢出
      ...
      children: [
        ...
        Row(
          children: [
            ...
            _buildActionButton(
              context: context,
              icon: _isSaved ? Icons.star : Icons.star_border, // 使用星星图标，与图片瀑布流保持一致
              count: _savesCount,
              isActive: _isSaved,
