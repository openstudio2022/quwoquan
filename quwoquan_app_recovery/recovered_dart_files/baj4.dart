      ...
      children: [
        ...
        Row(
          children: [
            ...
            _buildActionButton(
              context: context,
              icon: _isSaved ? Icons.grade_rounded : Icons.grade_outlined, // 更圆润饱满的星星
              count: _savesCount,
              isActive: _isSaved,
            ...
            _buildActionButton(
              context: context,
              icon: Icons.shortcut_outlined, // 空心转发箭头
              count: _sharesCount,
      ...
      children: [
        ...
        Row(
          children: [
            ...
            _buildActionButton(
              context: context,
              icon: _isSaved ? Icons.grade_rounded : Icons.grade_outlined, // 圆润星星
              count: _savesCount,
              isActive: _isSaved,
              activeColor: Colors.amber,
              onTap: _handleSaveClick,
