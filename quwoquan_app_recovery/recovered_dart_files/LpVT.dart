...
class ImagePostCard extends MediaPostCard {
  ...
  Widget buildMediaContent(BuildContext context, bool isDark) {
    ...
    return Column(
      ...
      children: [
        // 标题和配文（在图片上方显示）
        _buildImageCaption(context, isDark),
          ...
          if (title.isNotEmpty)
            Padding(
              ...
              child: Text(
                title,
                style: TextStyle(
                  fontSize: AppTypography.lg, // 大一号字号
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return GestureDetector(
          onTap: isOverflow ? () => _showFullContent(context, isDark, content) : null,
          child: Text.rich(
            TextSpan(
              children: [
                TextSpan(
  ...
  /// 显示完整内容
  void _showFullContent(BuildContext context, bool isDark, String content) {
    showDialog(
      context: context,
